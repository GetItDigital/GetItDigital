\begin{table}[ht]
    ...
    \begin{tabular}{|m{0.24\textwidth}|m{0.405\textwidth}|m{0.31\textwidth}|}
        \hline
        ...
        \]
                                                            &
        \textbf{Nicht-invertierender Verstär\-ker}
        \index{Operationsverstärker>Nicht-invertierender Verstärker}
        \begin{itemize}[leftmargin=0.4cm, parsep=0.0cm, itemsep=2pt, topsep=2pt]
            \item Phasengleiches Ausgangs\-signal
            \item Sehr hochohmiger Eingangs\-wider\-stand
            \item Niederohmiger Ausgangs\-wider\-stand
        ...
        \]
                                                            &
        \textbf{Summierer}\newline
        \index{Operationsverstärker>Summierer}
...
\begin{table}[ht]
    \begin{tabular}{|m{0.24\textwidth}|m{0.405\textwidth}|m{0.31\textwidth}|}
        ...
        \index{Operationsverstärker>Integrierer}
        \begin{itemize}[leftmargin=0.4cm, parsep=0.0cm, itemsep=2pt, topsep=2pt]
        ...
        \index{Operationsverstärker>Differenzierer}
        \begin{itemize}[leftmargin=0.4cm, parsep=0.0cm, itemsep=2pt, topsep=2pt]
...
\begin{table}[ht]
    \begin{tabular}{|m{0.24\textwidth}|m{0.405\textwidth}|m{0.31\textwidth}|}
        ...
        \index{Operationsverstärker>Logarithmierer}
        ...
        \end{center}
                  &
        \textbf{Potenzierer}\newline
        \index{Operationsverstärker>Potenzierer}
        ...
        \index{Operationsverstärker>Instrumentenverstärker}
