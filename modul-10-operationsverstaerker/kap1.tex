...
\begin{frame}
    ...
    \begin{minipage}{\textwidth}        
        ...
        \fu{
            ...
            \alttext{Die Abbildung zeigt den inneren Aufbau eines Operationsverstärkers in Transistorschaltung. Die Schaltung ist in drei farblich markierte Bereiche unterteilt, die unterschiedliche Funktionsstufen darstellen.
...
\begin{frame}
    ...
    \begin{figure}[ht]
            \centering
            \fu{\resizebox{0.6\textwidth}{!}{\input{Tikz/src/Funktionsweise_OPV_2.tex}
            \alttext{Die Abbildung zeigt den inneren Aufbau eines Operationsverstärkers in diskreter Transistorschaltung.
