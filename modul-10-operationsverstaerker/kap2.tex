...
\begin{frame}
    \s{
        ...
        \begin{tabular}{|L{3cm}|L{3cm}|L{3cm}|L{5cm}|}
            ...
            \hline
            Eingangsimpedanz                                                   & $Z_{\textnormal{i}} = \infty\,\Omega$    & $Z_i$ = $10^{13}\,\Omega$                     & Der von der Quelle aus betrachtet Lastwiderstand des OPVs.                                          \\
            \hline
            Ausgangsimpedanz                                                   & $Z_{\textnormal{a}} = 0\,\Omega$         & $Z_{\textnormal{a}} = 50$ bis $100\,\Omega$   & Der von einer Last aus betrachtete Widerstand am Ausgang des OPVs.                                  \\
            \hline
            Bandbreite                                                         & $B = \infty\,\mathrm{MHz}$               & $B > 2\,\mathrm{MHz}$                         & Frequenzbereich in dem das Verstärkerverhalten den im Datenblatt angegebenen Verhalten entspricht.  \\
            \hline
            Phasenverschiebung                                                 & $\varphi=0^{\circ}$                      & $\varphi >0^{\circ}$                          & Verzögerung des Ausgangs- gegenüber des Eingangssignals.                                            \\
            \hline
            Slew Rate                                                          & $\infty$                                 & $2\,\mathrm{mV}$ bis $1000\,\mathrm{V}/\mu s$ & Maximaler Spannungsanstieg pro Zeiteinheit.                                                         \\
            \hline
            Ausgangs-Aussteuerbarkeit                                          & $\infty$                                 & auf max. $U_{\textnormal{B}}$ begrenzt        & Maximaler Ausgangsspannungswert.                                                                    \\
            \hline
            Eingangsruhestrom                                                  & $I_{\textnormal{Ruhe}} = 0\,\mathrm{pA}$ & $I_{\textnormal{Ruhe}} < 5\,\mathrm{pA} $     & Eingangsseitige Stromaufnahme bei Differenzspannnung $\Delta U_{\textnormal{Diff}}$~=~0.            \\
            \hline
            Eingangsoffsetstrom                                                & $I_{\textnormal{Off}} = 0\,\mathrm{pA}$  & $I_{\textnormal{Off}} < I_+-I_-$              & Differenz der beiden Eingangsruheströme                                                             \\
            \hline
            Eingangs-Offsetspannung                                            & $U_{\textnormal{Off}} = 0\,\mathrm{mV}$  & $U_{\textnormal{Off}} < 2\,\mathrm{mV}$       & Ausgegebene Gleichspannung bei $\Delta U_{\textnormal{Diff}}$~=~0                                   \\
            \hline
            Gleichtakt-\linebreak unterdrückung (engl.: Common Mode Rejection) & $CMR = \infty\,\mathrm{dB}$              & $CMR=86\,\mathrm{dB}$                         & Gibt an, wie gut der Verstärker Signale unterdrückt, die an beiden Eingängen gleichermaßen anliegen \\
            \hline
        \end{tabular}
    }
