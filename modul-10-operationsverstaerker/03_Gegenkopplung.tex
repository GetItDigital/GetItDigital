...
\begin{frame}
    \s{
        ...
        \begin{bsp}{ Teil 1: Entwicklung einer Verstärkerschaltung für Musiksignale}{ Beispiel Verstaerkung }
            ...
            \fu{\resizebox{0.6\textwidth}{!}{\input{Tikz/src/OPVBeispielproblem.tex}\alttext{Die Abbildung zeigt eine elektrische Schaltung zur Ansteuerung eines Lautsprechers.
    ...
    \b{
        ...
        \begin{center}
            \begin{tabular}{ |>{\centering\arraybackslash}m{0.25\linewidth}|}
                \hline
                \large \textbf{A}                                 \\
                \scalebox{0.8}{\input{Tikz/src/OPV_Prinzip_Cir1}} \\
                \hline
                \scalebox{1}{\input{Tikz/src/OPV_Prinzip_Fig1}}   \\
                \hline
            \end{tabular}
        \end{center}
    }
    ...
    \b{
        ...
        \begin{center}
            \begin{tabular}{ |>{\centering\arraybackslash}m{0.25\linewidth}|>{\centering\arraybackslash}m{0.25\linewidth} >{\centering\arraybackslash}m{0.25\linewidth}| }
                ...
                \scalebox{0.8}{\input{Tikz/src/OPV_Prinzip_Cir3}}   \\
                \hline
                \scalebox{1}{\input{Tikz/src/OPV_Prinzip_Fig1}}   &
                Slew rate: $\frac{\Delta U_A}{\Delta t}$          &
                \scalebox{1}{\input{Tikz/src/OPV_Prinzip_Fig2}}     \\
                \hline
            \end{tabular}
        \end{center}
    }
...
\begin{frame}
    \s{
        ...
        Die Slew-Rate \index{Slew-Rate} (zu deutsch: Anstiegsrate) gibt an, wie schnell dieser Anstieg geschehen kann. Wird die Ausgangsspannung nicht auf den Eingang zurückgeführt, steigt die Ausgangspannung, bis das Niveau der Versorgungsspannung erreicht wird. Eine solche Beschaltung des Verstärkers wird als Komparatorschaltung bezeichnet.
        ...
        Stattdessen werden Operationsverstärker meistens in der sogenannten Gegenkopplung (B) \index{Gegenkopplung} betrieben, bei der der Ausgang auf den invertierenden Eingang zurückgeführt wird.
    ...
    \begin{figure}[H]
        ...
        \begin{tabular}{ |>{\centering\arraybackslash}m{0.195\linewidth}|>{\centering\arraybackslash}m{0.195\linewidth} >{\centering\arraybackslash}m{0.195\linewidth}|>{\centering\arraybackslash}m{0.275\linewidth}| }
            ...
            \scalebox{0.65}{\input{Tikz/src/OPV_Prinzip_Cir1}} &
            \scalebox{0.65}{\input{Tikz/src/OPV_Prinzip_Cir2}} &
            \scalebox{0.65}{\input{Tikz/src/OPV_Prinzip_Cir3}} &
            \scalebox{0.65}{\input{Tikz/src/OPV_Prinzip_Cir4}}   \\
            \hline
            \scalebox{0.8}{\input{Tikz/src/OPV_Prinzip_Fig1}}  &
            Slew rate: $\frac{\Delta U_A}{\Delta t}$           &
            \scalebox{0.8}{\input{Tikz/src/OPV_Prinzip_Fig2}}  &
            \scalebox{0.8}{\input{Tikz/src/OPV_Prinzip_Fig3}}    \\
            \hline
        \end{tabular}
...
\begin{frame}
    ...
    \b{
        ...
        \begin{columns}
            ...
            \begin{center}
                \scalebox{0.8}{\input{Tikz/src/OPV_Prinzip_Cir4.tex}}
