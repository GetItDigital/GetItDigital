...
\Aufgabe{
   ...
   \begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \alttext{Das Bild zeigt eine elektrische Schaltung mit einem Operationsverstärker, welcher an eine Versorgungsspannung von Plus und Minus 15 V angeschlossen ist.
