...
\alttext{Die Abbildung zeigt eine Schaltung mit einem Operationsverstärker, der mit einem Widerstandsnetzwerk am invertierenden und am nichtinvertierenden Eingang beschaltet ist. Der Operationsverstärker besitzt einen invertierenden Eingang (−), einen nichtinvertierenden Eingang (+) sowie einen Ausgang.
Der Ausgang des Operationsverstärkers befindet sich auf der rechten Seite. Die Ausgangsspannung \(U_\mathrm{a}\) wird gegen Masse gemessen.
Am invertierenden Eingang liegt das Eingangssignal \(U_{\mathrm{e1}}\) an. Dieses wird über den Widerstand \(R_1\) dem invertierenden Eingang zugeführt. Zusätzlich ist der invertierende Eingang über den Widerstand \(R_3\) mit dem Ausgang verbunden. Dadurch entsteht eine Gegenkopplung vom Ausgang zum invertierenden Eingang.
