...
\Loesung{
    \begin{figure}[H]
        \centering
            ...
            \alttext{Die Abbildung zeigt eine Schaltung mit einem Operationsverstärker, der über ein Widerstandsnetzwerk beschaltet ist. Der Operationsverstärker besitzt einen nichtinvertierenden Eingang (+), einen invertierenden Eingang (-) sowie einen Ausgang.
            ...
            Zusätzlich ist am Ausgang ein Lastwiderstand \(R_mathrm{L}\) angeschlossen. Dieser ist zwischen dem Ausgangsknoten und dem unteren Masseknoten geschaltet.}
