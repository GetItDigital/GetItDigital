...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        ...
        \alttext{Rechts neben der Schaltung ist ein Diagramm dargestellt, das das gewünschte Ausgangsverhalten zeigt. Auf der x-Achse ist die Zeit \(t\) in Sekunden dargestellt, auf der y-Achse die Spannung \(U\) in Volt.   
