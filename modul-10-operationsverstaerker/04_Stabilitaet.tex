...
\begin{frame}
    ...
    \begin{center}
        ...
        \f{width=\textwidth}{width=0.9\textwidth, alt={Die Abbildung zeigt die Bestimmung der Phasenreserve anhand eines Bode-Diagramms.
        Im oberen Diagramm ist der Amplitudengang des offenen Regelkreises dargestellt. Auf der horizontalen Achse ist die Frequenz aufgetragen, auf der vertikalen Achse die Amplitude. Die blaue Kurve fällt mit zunehmender Frequenz ab. Der Schnittpunkt der Kurve mit der 0-dB-Linie markiert die Durchtrittsfrequenz.
        Im unteren Diagramm ist der zugehörige Phasengang des offenen Regelkreises dargestellt. Auch hier ist auf der horizontalen Achse die Frequenz aufgetragen, auf der vertikalen Achse die Phasenverschiebung. Die rote Kurve zeigt eine mit steigender Frequenz zunehmende negative Phasenverschiebung.
        Bei der Durchtrittsfrequenz wird die zugehörige Phase im unteren Diagramm abgelesen. Der Abstand dieser Phase zur Grenze von -180° wird als Phasenreserve bezeichnet. Die Abbildung verdeutlicht somit, wie aus dem Amplituden- und Phasengang die Stabilitätsreserve eines Regelkreises bestimmt wird.}}{Bilder/kap4/Amplitudengang Regelkreis und Phasengang.pdf}{Bestimmung der Phasenreserve auf Grundlage des Bodediagramms}
...
\begin{frame}
    ...
    \s{
        ...
        \begin{center}
            ...
            \f{width=0.8\textwidth, alt={Die Abbildung zeigt Systemantworten in Abhängigkeit von der Lage der Polstellen in der komplexen Ebene.
            In der Mitte ist ein Koordinatensystem mit der reellen Achse (Re) horizontal und der imaginären Achse (Im) vertikal dargestellt. Verschiedene Polstellen sind durch farbige Kreuze markiert. Zu jeder Pollage ist jeweils eine typische Zeitantwort des Systems eingezeichnet.
            Liegt ein Pol auf der linken reellen Achse, zeigt das System ein exponentiell abklingendes Verhalten. Befindet sich der Pol weiter links, klingt die Antwort schneller ab. Liegt ein Pol auf der rechten reellen Achse, wächst die Antwort exponentiell an, was ein instabiles Verhalten bedeutet.
            Komplex konjugierte Pole mit negativem Realteil führen zu gedämpften Schwingungen. Je näher die Pole an der imaginären Achse liegen, desto geringer ist die Dämpfung und desto stärker schwingt das System. Liegen die Pole genau auf der imaginären Achse, entsteht eine ungedämpfte Dauerschwingung. Befinden sich komplexe Pole mit positivem Realteil, wächst die Schwingung mit der Zeit an, was ebenfalls instabil ist.
            Die Abbildung verdeutlicht somit den Zusammenhang zwischen der Polstellenlage in der komplexen Ebene und dem zeitlichen Verhalten eines linearen Systems.}}{width=0.8\textwidth}{Bilder/kap4/Polstellenneu.pdf}{Systemantworten bei verschiedenen Polstellen-Lagen }
...
\begin{frame}
    ...
    \begin{center}
        %\input{Bilder/kap4/Filter.png}
        \f{width=0.8\textwidth, alt={Die Abbildung zeigt das stabile und das instabile Einschwingverhalten eines Systems.
        Im linken Diagramm ist das stabile Verhalten dargestellt. Auf der horizontalen Achse ist die Zeit, auf der vertikalen Achse die Ausgangsspannung \(U_\mathrm{A}\).Nach einer Anregung steigt die Kurve zunächst an, überschwingt leicht und nähert sich anschließend einer konstanten Endlage an. Die Schwingungen klingen mit der Zeit ab, bis ein stabiler Gleichgewichtszustand erreicht ist.
        Im rechten Diagramm ist das instabile Verhalten dargestellt. Auch hier ist \(U_\mathrm{A}\) über der Zeit aufgetragen. Die Kurve zeigt Schwingungen, deren Amplitude mit der Zeit zunimmt. Statt sich einer festen Endlage anzunähern, wächst das Signal weiter an. Das System ist daher instabil.}}{width=0.8\textwidth}{Bilder/kap4/ubertragunsverhalten-Einschwingverhalten.pdf}{Stabiles und instabiles Einschwingverhalten} %https://link.springer.com/chapter/10.1007/978-3-662-64375-4_52  
