\begin{tikzpicture}
    ...
    \draw (E.-) to[short, -*] (-2,0.5) to[short, -*] (-3,0.5) to[short, -] (-3,1.5);
    \draw (-2,0.5) to[short] (-2,2.5) to[R, name=R, l=$R_\mathrm{F}$] (2,2.5) -- (2,0);
    \draw (-3,1.5) to[R, l_=$R_\mathrm{1}$] (-5,1.5) to[short, -o] (-6,1.5);
    \draw (-3,0.5) to[R,l_=$R_\mathrm{2}$, -o] (-5,0.5);
    ...
    \draw (-6,1.5) to[open, v, name=ue1] (-6,-2);
