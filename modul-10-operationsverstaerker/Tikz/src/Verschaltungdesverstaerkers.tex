\begin{tabular}{|m{0.25\textwidth}|m{0.45\textwidth}|m{0.3\textwidth}|}
    ...
    \begin{circuitikz}[scale=0.8, transform shape]
        ...
        \draw (E.-) -- ++(0, -1.6) to[R, l_=$R_1$] ++(0, -1.1) node[ground]{};
        ...
        \draw[-{Triangle[width=3pt,length=4pt]}, color=spannung] ($(E.out) + (0.26, -0.1)$) -- ($(E.out) + (0.26, -3.17)$) node[midway, xshift=10] {$U_A$};
        \draw ($(E.out) + (0.26, -3.2)$) node[ground]{};
