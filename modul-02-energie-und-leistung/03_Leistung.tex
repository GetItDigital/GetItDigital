...
\speech{03_Leistung1}{1}{Ein weiterer wichtiger Begriff in der Technik ist die Leistung. Wir wissen bereits, dass der Zusammenhang zwischen Arbeit und Leistung über das Integral der Leistung über der Zeit gegeben ist. Dieses Integral ergibt die verrichtete Arbeit bzw. Energie.
...
\s{
	...
	\item Elektrische Arbeit ist die über die Zeit verrichtete Leistung.
	\item Leistung ist die Arbeit pro Zeit.
	\end{itemize}
	\end{Merksatz}}
...
Mechanisch: Kraft mal Geschwindigkeit. Rotatorisch: Drehmoment mal Winkelgeschwindigkeit. Thermisch: Temperaturdifferenz ΔT mal Wärmedurchgangskoeffizient K mal Fläche A. Fluidisch: Druck mal Volumenstrom.}
\speech{03_Leistung2}{2}{Mekre also, Energie beschreibt das Potenzial, Arbeit zu verrichten. Energie kann gespeichert werden, Arbeit nicht. Elektrische Arbeit ist die über die Zeit verrichtete Leistung, und Leistung ist Arbeit pro Zeit.}
