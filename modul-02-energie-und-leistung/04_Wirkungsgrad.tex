...
\b{
	\begin{itemize}
		\item Der Wirkungsgrad beschreibt das Verhältnis von abgegebener zu zugeführter Leistung in einem System und ist ein Maß für die Effizienz
	\end{itemize}
    \begin{figure}[H]
		\centering
	\scalebox{1}{
...
\b{
	\vspace*{-1.2cm}\only<2->{\begin{Merksatz}{Wirkungsgrad}
		\begin{itemize}
