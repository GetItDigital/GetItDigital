...
%}
%\end{frame}
%; TODO "sonder dem System als Nutzenergie zur Vergügung steht" ? macht kein Sinn?
\s{
...
\hspace{1cm} % Um es in der Mitte zu haben
	...
	\s{\caption{\textbf{Beispiel Schaltung Wirkungsgrad.} Das Bild zeigt die Abgabe von Wärme und Licht am Verbraucher. Das Verhältnis von Licht z uWärme entspricht dem Wirkungsgrad.}}
