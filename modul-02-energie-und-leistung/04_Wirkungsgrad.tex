...
\s{
	...
	\begin{Merksatz}{Wirkungsgrad}
		\begin{itemize}
			\item Der Wirkungsgrad ist das Verhältnis von abgegebener zu zugeführter Leistung und beschreibt die Effizienz eines Systems.
		\end{itemize}
	\end{Merksatz}
}
...
\hspace{1cm} % Um es in der Mitte zu haben
	...
	\s{\caption{\textbf{Beispielschaltung zum Wirkungsgrad.} Das Bild zeigt die Abgabe von Wärme und Licht am Verbraucher. Das Verhältnis von Licht zu Wärme entspricht dem Wirkungsgrad.}
