...
\hspace{1cm} % Um es in der Mitte zu haben
	...
	\s{\caption{\textbf{Beispiel Schaltung Wirkungsgrad.} Das Bild zeigt die Abgabe von Wärme und Licht am Verbraucher. Das Verhältnis von Licht zu Wärme entspricht dem Wirkungsgrad.}}
...
\begin{itemize}
	...
	\item $\eta=5\%$
	\item $P_\mathrm{v}=P_\mathrm{zu}\cdot \eta$
