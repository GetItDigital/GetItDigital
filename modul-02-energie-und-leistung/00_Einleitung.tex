...
\begin{frame} \ftx{Lernziele: Unterschied von Energie, Arbeit, Leistung}
...
\begin{frame} \ftx{Pumpspeicherkraftwerk}
			...
			\begin{figure}[H]
				...
				\s{\includesvg[width=0.8\textwidth]{Wasserkraftwerk_V5}
					\caption{\textbf{Pumpspeicherkraftwerk.} Aufbau mit Ober- und Unterbecken, Turbinen und elektrischer Maschine zur Energiespeicherung und Rückgewinnung.}
						\alttext{Die Abbildung zeigt ein Pumpspeicherkraftwerk mit einem höher gelegenen Oberbecken und einem tiefer gelegenen Unterbecken. Beide Becken sind über eine Druckrohrleitung verbunden, in der sich Turbinen und eine elektrische Maschine befinden. Im Pumpbetrieb wird Wasser über die Maschine nach oben in das Oberbecken befördert, um Energie zu speichern. Im Turbinenbetrieb strömt das Wasser wieder nach unten, treibt die Turbinen an und erzeugt elektrische Energie. Die Grafik stellt die Funktionsweise und den Energiefluss des Systems schematisch dar.}}
	...
	\speech{00_Einleitung2}{1}{ % hier titel einfügen
		...
		Abends, wenn die Versorgung durch Photovoltaik Anlagen abnimmt, kann das Wasser dann durch eine Turbine zurück ins Unterbecken fließen.
