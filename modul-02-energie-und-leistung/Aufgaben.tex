...
\Loesung{
	\begin{itemize}
		...
		\item[\bf b)]
		\begin{equation*}
		    Wirkungsgrad = \frac{\text{genutzte Energie}}{\text{aufgewendete Energie}} = \eta
		\end{equation*}
		\begin{equation*}
		    E_\mathrm{zu}=\frac{W}{\eta}=\mathrm{\frac{490,5\,J}{0{,}8}}= 613,125\,\text{J}
		\end{equation*}
	\end{itemize}
}
...
\Loesung{
    \begin{itemize}
        ...
        \end{equation*}
        \begin{equation*}
            m = \rho \cdot V = 1000\,\mathrm{kg/m^3} \cdot 2\,000\,000\,\mathrm{m^3} = 2\,000\,000\,000\,\mathrm{kg}
        \end{equation*}
        \begin{equation*}
            E_{\text{pot}} = 2\,000\,000\,000\,\mathrm{kg} \cdot 9{,}81\,\mathrm{m/s^2} \cdot 100\,\mathrm{m}
        \end{equation*}
        \begin{equation*}
...
\Loesung{
    \begin{itemize}
        ...
        \end{equation*}
        \begin{equation*}
            v = 72\,\mathrm{km/h} = 72 \cdot \frac{1000\,\mathrm{m}}{3600\,\mathrm{s}} = 20\,\mathrm{m/s}
        \end{equation*}
        \begin{equation*}
            E_{\text{kin}} = \frac{1}{2} \cdot 1200\,\mathrm{kg} \cdot (20\,\mathrm{m/s})^2
        \end{equation*}
        \begin{equation*}
