...
\speech{01_Energie1}{1}{ % ToDo: dieser Teil soll bei only 1 kommen %;TODO sehr lansame sprache aber gute dynamic in der stimme
%; TODO bild flackert ?
...
\end{frame}
\begin{frame}%;TODO schöner sportieren
