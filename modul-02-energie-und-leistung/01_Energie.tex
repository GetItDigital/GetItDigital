...
\only<3->{
% TODO VOn JW hinzugefügt ist das die richtige Formel?
\centering \huge $E= F \cdot s $
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% erste Makros für TTS %%%%%%%%%%%%%%%%%%%%%%%% test

\speech{01_Energie1}{1}{ % ToDo: dieser Teil soll bei only 1 kommen %;TODO weitere graphen mit kinetischer, potentieller und (Temperatur?)
...
\begin{itemize}
	...
	\item Kernenergie \\
	\item Strahlungsenergie %; TODO: Strahlunsenergie muss auch bei den anderen Aufzählungen mit aufgenommen wreden.
\end{itemize}
...
\end{frame}
\begin{frame}%;TODO schöner sortieren
	...
	%\begin{itemize}
	%	\item ... %; TODO doppelpunkte, mittn in folie, gehören da nicht nicht hin
	%\end{itemize}
