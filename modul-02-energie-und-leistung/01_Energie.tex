...
\speech{01_Energie4}{1}{ %ToDo: Die Klammern sind hier lila und oben gelb. Muss irgendwo ein Fehler sein. (Vielleicht auch nicht. Farbe Ändert sich, sobald {{}})
...
\speech{01_Energie5}{1}{ % ToDo: auch hier muss ein Fehler vorliegen, da die Klammern lila sind.
%ToDo: F_el wir fel ausgesprochen
