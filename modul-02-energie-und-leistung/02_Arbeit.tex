...
\only<2->{
	...
	\begin{itemize} \item Das Vorzeichen der Arbeit ist kontextabhängig: % und beschreibt, ob die Arbeit ein Energieniveau anhebt oder absenkt.
	Die Arbeit ist positiv, wenn Energie einem System hinzugefügt wird
	und negativ, wenn Energie einem System entnommen wird. \end{itemize}
...
\begin{Merksatz}{Ringintegral}  
	...
	\begin{itemize}
		\item Das Ringintegral einer Ladung in einem statischen elektrischen Feld ist unabhängig von der Ladungsmenge immer gleich Null.
	\end{itemize}
...
% TODO Merksatz elektrische Arbeit fehlt (???? von FS)
	...
	\begin{itemize} \item Das Ringintegral einer Ladung in einem statischen elektrischen Feld ist unabhängig von der Ladungsmenge immer gleich Null. \end{itemize}
