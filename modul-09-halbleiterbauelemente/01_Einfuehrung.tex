\s{
    ...
    Eigenschaften von Materialien, die weder gute Leiter noch gute Isolatoren sind, sondern dazwischen liegen -- den sogenannten
    Halbleiter. Im Folgenden wird auf ihre Funktionsweise eingegangen, beginnend mit dem Bändermodell, welches die Energiezustände
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth, alt={Die Abbildung zeigt vier verschiedene Halbleiterbauelemente in einer Reihe von links nach rechts.
                    ...
                    Diese Bauelemente werden in der Elektronik für verschiedene Anwendungen genutzt, wie Schalten, Verstärken oder Gleichrichten von elektrischen Signalen.}]{Bilder/kap1/AufnahmenHalbleiterWiki.png}
...
\s{
    ...
    Das Bändermodell \index{Bändermodell} ist ein grundlegendes Konzept in der Festkörperphysik, das die physikalischen Eigenschaften von Festkörpern
    ...
    Im Bohrschen Atommodell werden die Energieniveaus \index{Energieniveau} von Elektronen in einem Atom als diskrete Werte angenommen. Nach diesem Modell befinden
    ...
    Energieniveau. Diese Energieniveaus sind quantisiert und hängen vom Abstand zum Atomkern ab. Dabei weisen Elektronen in den inneren
    Schalen niedrigere Energieniveaus auf als Elektronen in den äußeren Schalen. Der Zusammenhang zwischen dem Bohrschen Atommodell
...
\s{
    \begin{figure}[H]
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \centering
                \includesvg[width=0.4\textwidth]{Bilder/kap1/ZusammenhangBohrscheAtommodellundBaendermodell/ZusammenhangBohrscheAtommodellundBaendermodell_1}\alttext{Die Abbildung zeigt zwei Darstellungen zum Vergleich des Bohrschen Atommodells mit dem Bändermodell eines Siliziumatoms. Links ist das Bohrsche Atommodell eines Siliziumatoms dargestellt. In der Mitte befindet sich der Atomkern, bestehend aus Protonen und Neutronen. Um den Kern herum sind mehrere konzentrische Bahnen zu sehen, auf denen sich Elektronen bewegen. Diese Bahnen repräsentieren diskrete Energieniveaus, die Elektronen besetzen können.  Rechts ist das Bändermodell eines Siliziumatoms dargestellt. Auf der vertikalen Achse ist die Energie \(E\) aufgetragen. Unterschiedliche horizontale Linien repräsentieren die möglichen Energieniveaus für Elektronen. Der unterste Bereich symbolisiert das Valenzband, während die darüber liegenden Linien mögliche Energieniveaus für Elektronen im Leitungsband kennzeichnen. Die Abbildung verdeutlicht den Zusammenhang zwischen den diskreten Energieniveaus einzelner Elektronenbahnen im Bohrschen Modell und den Energiebandstrukturen im Bändermodell, die für Festkörper wie Silizium relevant sind.}
            \end{figure}
        \end{minipage}
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \centering
                \includesvg[width=0.5\textwidth]{Bilder/kap1/ZusammenhangBohrscheAtommodellundBaendermodell/ZusammenhangBohrscheAtommodellundBaendermodell_2}\alttext{Die Abbildung zeigt zwei Darstellungen zum Vergleich des Bohrschen Atommodells mit dem Bändermodell eines Siliziumatoms. Links ist das Bohrsche Atommodell eines Siliziumatoms dargestellt. In der Mitte befindet sich der Atomkern, bestehend aus Protonen und Neutronen. Um den Kern herum sind mehrere konzentrische Bahnen zu sehen, auf denen sich Elektronen bewegen. Diese Bahnen repräsentieren diskrete Energieniveaus, die Elektronen besetzen können.  Rechts ist das Bändermodell eines Siliziumatoms dargestellt. Auf der vertikalen Achse ist die Energie \(E\) aufgetragen. Unterschiedliche horizontale Linien repräsentieren die möglichen Energieniveaus für Elektronen. Der unterste Bereich symbolisiert das Valenzband, während die darüber liegenden Linien mögliche Energieniveaus für Elektronen im Leitungsband kennzeichnen. Die Abbildung verdeutlicht den Zusammenhang zwischen den diskreten Energieniveaus einzelner Elektronenbahnen im Bohrschen Modell und den Energiebandstrukturen im Bändermodell, die für Festkörper wie Silizium relevant sind.}
            \end{figure}
        \end{minipage}
...
\s{
    ...
    miteinander wechselwirken, überlappen sich deren Energiezustände. Aufgrund des Pauli-Prinzips \index{Pauli-Prinzip}, welches auch Ausschlussprinzip genannt wird, können zwei
...
\s{
    \begin{figure}[H]
        \centering
        \includesvg[scale=1]{Bilder/kap1/UebergangVonEnergieniveausZuBaendern}\alttext{Die Abbildung zeigt den Übergang von diskreten Energieniveaus zu Energiebändern in Abhängigkeit von der Anzahl der Atome. Sie besteht aus drei Diagrammen, die von links nach rechts den Energiezustand eines einzelnen Atoms, eines Moleküls aus zwei Atomen und eines Festkörpers veranschaulichen.
...
\s{
    ...
    Diese Lücken werden als „verbotener Bereich“ oder Bandlücke \index{Bandlücke} bezeichnet. Die Größe dieser Lücken bestimmt die elektrischen Eigenschaften des Materials.
...
\s{
    \ftc{Einteilung von Materialien}
    Zwei Bänder sind besonders relevant für den Ladungstransport und somit für die elektrischen Eigenschaften: das Valenzband (VB) \index{Valenzband} und das Leitungsband (LB) \index{Leitungsband}.
    ...
    \begin{figure}[H]
        \centering
        \includesvg[width=0.6\textwidth]{Bilder/kap1/BaendermodelleinesMaterialsbei0K}\alttext{Die Abbildung zeigt das Bändermodell eines Materials bei null Kelvin. Sie stellt die relevanten Energiebänder grafisch dar und enthält Beschriftungen für die verschiedenen Energieniveaus.
    ...
    Die Besetzung der Bänder mit Elektronen hängt neben der Temperatur von weiteren Faktoren ab. Vor allem durch gezielte Verunreinigung mit Fremdatomen, sogenannter Dotierung \index{Dotierung},
    ...
    zum Beispiel leichter Ladungsträger das Band wechseln können (siehe Abschnitt~\ref{sec:Ladungsträgertransport}). Neben den bisher gezeigten Energieniveaus ist das Ferminiveau \index{Ferminiveau} eine weitere wichtige Größe.
    Dieses gibt den Energiewert an, bei dem Elektronen eine Aufenthaltswahrscheinlichkeit von $\nicefrac{1}{2}$ aufweisen. Bei einem undotierten Halbleiter liegt das Niveau mittig zwischen
    Valenz- und Leitungsband, bei dotierten Halbleitern verschiebt sich das Niveau in Richtung des jeweiligen Dotierbands.
}

\s{
    \textbf{Leiter} sind Materialien, deren Valenz- und Leitungsbänder aneinandergrenzen oder überlappen, was bedeutet, dass Elektronen leicht zwischen den Bändern wechseln können.
    Diese Nähe ermöglicht eine hohe Leitfähigkeit, da Elektronen sich frei durch das Material bewegen können. Metalle wie Kupfer und Aluminium sind typische Beispiele für Leiter.\par

    \textbf{Halbleiter} haben eine kleine Bandlücke, die zwischen der des Leiters und der des Isolators liegt. Diese Bandlücke ist so groß, dass in dem Material bei niedrigen Temperaturen
    ...
    kann die Leitfähigkeit jedoch deutlich erhöht werden. Halbleiter wie Silizium und Germanium sind häufig eingesetzte Materialien in der Elektronikindustrie.\par

    \textbf{Isolatoren} haben eine große Bandlücke, die dazu führt, dass das Valenzband vollständig besetzt ist und das Leitungsband leer ist. Dadurch können Elektronen nur schwer ins
...
\s{
    ...
    \begin{figure}[H]
        \centering
        \includesvg[scale=1]{Bilder/kap1/BaendermodellverschiedenerMaterialien}\alttext{Die Abbildung zeigt das Bändermodell für verschiedene Arten von Halbleitermaterialien. Sie besteht aus vier Diagrammen, die von links nach rechts die Energiebandstrukturen eines Leiters ohne Bandlücke, eines Leiters mit Bandüberlappung, eines Halbleiters und eines Isolators darstellen.
...
\s{
    \begin{Merksatz}{}
        \begin{itemize}
            ...
            \item Bei $T=\mathrm{0\,K}$ ist das Valenzband das höchste besetzte Energieniveau, das darüberliegende Leitungsband beinhaltet keine freien Ladungsträger.
            \item Materialien können über die Bandlücke, in Leiter, Halbleiter und Isolatoren kategorisiert werden.
        \end{itemize}
    \end{Merksatz}
}

\s{
    \ftb{Halbleitermaterialien}
    Die Gitterstrukturen \index{Gitterstruktur} von Halbleitermaterialien spielen eine entscheidende Rolle in Bezug auf deren elektronischen und mechanischen Eigenschaften.
    ...
    aus Elementen der III. und V. Hauptgruppe des Periodensystems, entsprechend wird ein solcher Halbleiter auch als III/V-Verbindungshalbleiter
...
\s{
    \begin{figure}[H]
        \centering
        \includesvg[scale=.25]{Bilder/kap1/Gitterstrukturen/GitterSi}\alttext{Die Abbildung zeigt die Diamantgitterstruktur von Silizium.
...
\s{
    ...
    was zu einer geringen Anregungsenergie führt, die notwendig ist, um Elektronen zwischen Valenz- und Leitungsband zu verschieben.

    \begin{figure}[H]
        \begin{minipage}[c]{0.49\textwidth}
            \centering
            \includesvg[scale=.25]{Bilder/kap1/Gitterstrukturen/GitterGaAs_1}\alttext{Der Würfel zeigt zwei ineinander verschobene kubisch flächenzentrierte Gitter aus zwei verschiedenen Materialien.
        ...
        \begin{minipage}[c]{0.49\textwidth}
            \centering
            \includesvg[scale=.25]{Bilder/kap1/Gitterstrukturen/GitterGaAs_2}\alttext{Der rechte Würfel zeigt die resultierende Zinkblende-Gitterstruktur.
...
\s{
    ...
    jedes Materials. Die Beweglichkeit beschreibt die Geschwindigkeit, mit der sich Ladungsträger unter Einfluss eines elektrischen Feldes durch das Material bewegen. Bei Löchern handelt es sich um quasi-partielle Zustände, die als positive Ladungsträger betrachtet werden. Es handelt
...
\s{
    \begin{figure}[H]
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \raggedright
                \includesvg[width=0.9\textwidth]{Bilder/kap1/GitterstrukturUndBaendermodellVonSi/GitterstrukturUndBaendermodellVonSi_1}\alttext{Die Abbildung zeigt die Gitterstruktur und das Bändermodell von Silizium in einer vereinfachten 2D-Betrachtung.
                    Es wird die Gitterstruktur von reinem Silizium bei \( T = 0K \) dargestellt.
        ...
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \raggedleft
                \includesvg[width=0.9\textwidth]{Bilder/kap1/GitterstrukturUndBaendermodellVonSi/GitterstrukturUndBaendermodellVonSi_2}\alttext{Die Abbildung zeigt die Gitterstruktur und das Bändermodell von Silizium in einer vereinfachten 2D-Betrachtung.
                    Es wird das Gittermodell für Silizium bei \( T > 0K \) dargestellt, also bei einer Temperatur über dem absoluten Nullpunkt.
...
\s{
    Bei der Zugabe von Phosphor zu Silizium führt dies dazu, dass das Phosphoratom fünf Valenzelektronen einbringt (n-dotiert) \index{Dotierung}, eins mehr als Silizium. Das in
...
\s{
    \begin{figure}[H]
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \raggedright
                \includesvg[width=0.9\textwidth]{Bilder/kap1/GitterstrukturUndBaendermodellVonN-dotiertesSi/GitterstrukturUndBaendermodellVonN-dotiertesSi_1}\alttext{Die Abbildung zeigt die Gitterstruktur und das Bändermodell von n-dotiertem Silizium in einer vereinfachten 2D-Betrachtung.
                    N-dotiertes Silizium bei \( T = 0K \)
        ...
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \raggedleft
                \includesvg[width=0.9\textwidth]{Bilder/kap1/GitterstrukturUndBaendermodellVonN-dotiertesSi/GitterstrukturUndBaendermodellVonN-dotiertesSi_2}\alttext{Die Abbildung zeigt die Gitterstruktur und das Bändermodell von n-dotiertem Silizium in einer vereinfachten 2D-Betrachtung.
                    N-dotiertes Silizium bei \( T > 0K \)
            ...
            \end{figure}
        \end{minipage}
        \caption{\textbf{Gitterstruktur und Bändermodell von n-dotiertem Si.} Links: N-dotiertes Silizium bei $T={0}\,\mathrm{K}$. Rechts: N-dotiertes Silizium bei $T>{0}\,\mathrm{K}$.}
        \label{fig:GitterstrukturUndBaendermodellVonN-DotiertesSi}
    \end{figure}
}

\s{
    Bei der Zugabe von Bor zu Silizium (p-Dotierung) hat das Boratom nur drei Valenzelektronen, eins weniger als Silizium. Dadurch entsteht im Kristallgitter ein
...
\s{
    \begin{figure}[H]
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \raggedright
                \includesvg[width=0.9\textwidth]{Bilder/kap1/GitterstrukturUndBaendermodellVonP-dotiertesSi/GitterstrukturUndBaendermodellVonP-dotiertesSi_1}\alttext{Die Abbildung zeigt die Gitterstruktur und das Bändermodell von p-dotiertem Silizium in einer vereinfachten 2D-Betrachtung.
                    P-dotiertes Silizium bei \( T = 0K \)
        ...
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \raggedleft
                \includesvg[width=0.9\textwidth]{Bilder/kap1/GitterstrukturUndBaendermodellVonP-dotiertesSi/GitterstrukturUndBaendermodellVonP-dotiertesSi_2}\alttext{Die Abbildung zeigt die Gitterstruktur und das Bändermodell von p-dotiertem Silizium in einer vereinfachten 2D-Betrachtung.
                    P-dotiertes Silizium bei \( T > 0K \)
            ...
            \end{figure}
        \end{minipage}
        \caption{\textbf{Gitterstruktur und Bändermodell von p-dotiertem Si.} Links: P-dotiertes Silizium bei $T={0}\,\mathrm{K}$. Rechts: P-dotiertes Silizium bei $T>{0}\,\mathrm{K}$.}
...
\s{
    ...
    sind zwei weitere wichtige Größen der Driftstrom \index{Driftstrom} und der Diffusionsstrom. Driftstrom in einem Halbleiter tritt aufgrund der Bewegung geladener
    ...
    auf die freien Ladungsträger (Elektronen und Löcher), die sie, je nach Vorzeichen oder Ladung, in Feldrichtung beschleunigt oder deren Bewegung verlangsamt.
...
\s{
    \begin{figure}[H]
        \centering
        \includesvg[width=0.4\textwidth]{Bilder/kap1/DriftstromInnerhalbEinesHalbleiters}\alttext{Die Abbildung zeigt das Prinzip des Driftstroms innerhalb eines Halbleiters.
        ...
        \caption{\textbf{Driftstrom innerhalb eines Halbleiters.} Darstellung mit der Geschwindigkeit $v$ der Ladungsträger aufgrund der elektrischen Feldstärke $E$.}
        \label{fig:DriftstromInnerhalbEinesHalbleiters}
    \end{figure}
}

\s{
    Der andere Teil des Stroms entsteht durch Diffusion \index{Diffusionsstrom}, was die Bewegung von Ladungsträgern aufgrund von Konzentrationsunterschieden darstellt.
    ...
    ähnlich wie bei der Diffusion von Teilchen in einem Konzentrationsgradienten. Elektronen im n-dotierten Halbleiter diffundieren von Regionen hoher zu Regionen niedriger Elektronenkonzentration. Umgekehrt bewegen sich bei einem
    p-dotierten Halbleiter Löcher von Regionen hoher Lochkonzentration zu Regionen niedriger Konzentration.
}

\s{
    \begin{figure}[H]
        \centering
        \includesvg[width=0.8\textwidth]{Bilder/kap1/DiffusionsstromInnerhalbEinesHalbleiters}\alttext{Die Abbildung zeigt den Diffusionsstrom innerhalb eines Halbleiters, insbesondere die Diffusion von Elektronen in einem n-dotierten Halbleiter in Richtung einer geringeren Konzentration.
...
\s{
    Abschließend wird in diesem Abschnitt der Ladungstransport im Bänderdiagramm bei einer angelegten Spannung betrachtet. Bislang wurde das
...
\s{
    \begin{figure}[H]
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \centering
                \includesvg[width=0.7\textwidth]{Bilder/kap1/EinflussvonSpannungenaufHalbleiter/EinflussvonSpannungenaufHalbleiter_1}\alttext{Die Abbildung zeigt den Einfluss von Spannungen auf einen Halbleiter.
                    Halbleiter ohne angelegte Spannung
        ...
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \centering
                \includesvg[width=0.7\textwidth]{Bilder/kap1/EinflussvonSpannungenaufHalbleiter/EinflussvonSpannungenaufHalbleiter_2}\alttext{Die Abbildung zeigt den Einfluss von Spannungen auf einen Halbleiter.
                    Halbleiter mit angelegter Spannung
        ...
        \caption{\textbf{Einfluss von Spannungen auf Halbleiter.} Links: Festkörper und Bändermodell ohne angelegte Spannung. Rechts: Verschiebung des Bändermodells aufgrund einer angelegten Spannung.}
...
\s{
    ...
    sich im Über\-gangs\-be\-reich eine sogenannte Raumladungszone (RLZ) \index{Raumladungszone} bildet. In Abbildung \ref{fig:VorgaengeInnerhalbDesPn-Uebergangs} ist dieser Vorgang dargestellt. Die RLZ ist eine schmale
...
\s{
    \begin{figure}[H]
        \centering
        \includesvg[width=0.7\textwidth]{Bilder/kap1/VorgaengeInnerhalbDesPN-Uebergangs}\alttext{Die Abbildung zeigt die Vorgänge innerhalb eines pn-Übergangs, insbesondere die Drift- und Diffusionsprozesse der Ladungsträger sowie die Bildung der Raumladungszone.
...
\s{
    Wenn eine Spannung in Durchlassrichtung angelegt wird (siehe Abbildung \ref{fig:EinflussVonSpannungenAufPn-Uebergang} links), wird die RLZ verkleinert und der Übergang wird leitend.
...
\s{
    \begin{figure}[H]
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \centering
                \includesvg[width=0.7\textwidth]{Bilder/kap1/EinflussvonSpannungenaufpn-Uebergang/EinflussvonSpannungenaufpn-Uebergang_1}\alttext{Die Abbildung zeigt den Einfluss von Spannungen auf einen pn-Übergang.
                    Spannung in Durchlassrichtung (\( U_{HL} > 0 \))
        ...
        \begin{minipage}[c]{0.48\textwidth}
            \begin{figure}[H]
                \centering
                \includesvg[width=0.7\textwidth]{Bilder/kap1/EinflussvonSpannungenaufpn-Uebergang/EinflussvonSpannungenaufpn-Uebergang_2}\alttext{Die Abbildung zeigt den Einfluss von Spannungen auf einen pn-Übergang.
                    Spannung in Sperrrichtung (\( U_{HL} < 0 \))
