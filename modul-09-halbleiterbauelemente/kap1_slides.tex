...
\begin{frame}
    ...
    \silence{3}
    \speech{Baendermodell_Atommodell}{2}{Links unten sehen wir die Entsprechung im Bändermodell:
...
\begin{frame}
    \b{
        ...
        \end{itemize}}
    \speech{Halbleitermaterialien_Merke}{1}{Was solltest du dir merken?
...
\begin{frame}
    \b{
        ...
        \end{itemize}}
    \speech{Ladungstraegertransport_Merke}{4}{Fassen wir kurz zusammen:
