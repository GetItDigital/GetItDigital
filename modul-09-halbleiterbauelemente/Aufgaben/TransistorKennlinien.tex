...
\Aufgabe{
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.45\textwidth}
            ...
            \alttext{Die Abbildung zeigt eine elektronischen Schaltung und ein Diagramm mit Bezug auf den Kollektorstrom \(I_\mathrm{C}\) und die Kollektor Ermitter Spannung \(U_{\mathrm{CE}}\). Aus dem Diagramm lässt sich der Basisstrom ermitteln.
