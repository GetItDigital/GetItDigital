...
\Aufgabe{
  ...
  \begin{figure}[H]
    ...
    \alttext{Zu sehen ist eine elektrische Schaltung mit vier Bauteilen zur Bestimmung Ermittlung der Betriebsgrenzen einer Zenerdiode. Auf der linken Seite befindet sich die Spannungsquelle \(U_\mathrm{E}\), deren Spannungspfeil nach unten zeigt. In Reihe zur Spannungsquelle sind ein Widerstand \(R_\mathrm{V}\) und eine Zenerdiode \(D_\mathrm{z}\) geschaltet.  Parallel zu der Zenerdiode befindet sich ein Lastwiderstand gekennzeichnet mit \(R_\mathrm{L}\). Ein Spannungspfeil in Stromrichtung kennzeichnet die Spannung der Parralelschaltung mit Der Beschriftung \(U_\mathrm{A}\).}
...
\Loesung{
  \begin{figure}[H]
    ...
    \alttext{Zu sehen ist eine elektrische Schaltung mit vier Bauteilen zur Bestimmung Ermittlung der Betriebsgrenzen einer Zenerdiode.
    Auf der linken Seite befindet sich die Spannungsquelle \(U_\mathrm{E}\), deren Spannungspfeil nach unten zeigt. In Reihe zur Spannungsquelle sind ein Widerstand \(R_\mathrm{V}\) und eine Zenerdiode \(D_\mathrm{z}\) geschaltet.
    Der durch den Widerstand \(R_\mathrm{V}\) fließende Strom ist mit \(I\) gekennzeichnet, Der durch die Z-Diode fließende Strom ist als Zenerstrom \(I_\mathrm{Z}\) eingezeichnet. 
    Parallel zu der Zenerdiode befindet sich ein Lastwiderstand gekennzeichnet mit \(R_\mathrm{L}\).Der durch diesen Widerstand \(R_\mathrm{L}\) fließende Strom ist als Laststrom \(I_\mathrm{L}\) eingezeichnet. 
    Ein Spannungspfeil in Stromrichtung kennzeichnet die Spannung der Parralelschaltung mit Der Beschriftung \(U_\mathrm{A}\).}
