...
\begin{frame}
    \b{\frametitle{Temperaturverhalten von Dioden}
        \begin{columns}
            ...
            \end{itemize}
        \end{columns}}
    \speech{Diode_Temp}{4}{Auch die Temperatur spielt eine Rolle:
...
\begin{frame}
    \b{
        \frametitle{Spannungsverlauf eines Einweggleichrichters}
        \begin{figure}[H]
            \centering
    ...
    \speech{Einweggleichrichter_Spannung}{1}{Hier sehen wir den entsprechenden Spannungsverlauf - nach der Gleichrichtung mit einer Diode und der Glättung mit einem Kondensator.}
    \silence{3}
\end{frame}

\begin{frame}
    \b{ 
        \frametitle{ Stromverlauf eines Einweggleichrichters}
        \begin{figure}
            \centering
