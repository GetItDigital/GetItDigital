...
\begin{frame}
    \b{
        ...
        \begin{figure}
            \centering
            \includesvg[width= .7\textwidth]{Bilder/kap2/FolienStromsteuerungskennlinieKurvenschar}
        \end{figure}
    }
...
\begin{frame}
    \b{
        ...
        \begin{figure}
            \centering
            \includesvg[width= .7\textwidth]{Bilder/kap2/FolienRueckwirkungskennlinie}
        \end{figure}
    }
...
\begin{frame}
    \b{
        ...
        \begin{figure}[H]
            \onslide<1->{
                \begin{itemize}
                    \item Kleinsignal-Ersatzschaltbild eines Bipolartransistors.
                \end{itemize}
                \begin{minipage}[b]{0.48\textwidth}
                    \raggedright
...
\begin{frame}
    \b{
        ...
        \begin{figure}[H]
            ...
            \begin{minipage}[b]{0.48\textwidth}
                \raggedright
                \includesvg[width= .7\textwidth]{Bilder/kap3/ArbeitenMitTransistorkennlinie}
            \end{minipage}
            \begin{minipage}[b]{0.48\textwidth}
                \raggedleft
