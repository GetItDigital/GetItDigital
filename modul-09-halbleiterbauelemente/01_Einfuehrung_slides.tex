    ...
    \b{ 
        ...
        \begin{Lernziele}{Halbleiter}
            ...
            \begin{itemize}
                ...
                \item verschiedene Halbleitermaterialien und deren Eigenschaften bennen.
            \end{itemize}
        \end{Lernziele}
    }
    \speech{Einfuehrung_Lernziel}{1}{Bevor wir starten, ein kurzer Blick auf die Lernziele dieses Kapitels.
...
\begin{frame}
    ...
    \speech{Einfuehrung_Uebersicht}{1}{Zum Einstieg sehen wir hier eine Auswahl typischer Halbleiterbauelemente.
...
\begin{frame}
    \b{
        ...
        \end{itemize}}
    \speech{Einfuehrung_Zusmmenfassung}{1}{Halbleiter sind die Grundlage moderner Elektronik - vom Smartphone bis zur Solaranlage.
...
\b{
    % fix für die Erstellung von Lesezeichen bei Folien die onslide Befehle haben, ansonsten werden diese häufiger aufgezählt
...
\begin{frame}
        ...
        \begin{columns}
            ...
            \begin{figure}[H]
                \onslide<1->{
                    \begin{figure}[H]
                        \centering
                        \includesvg[width=.7\linewidth]{Bilder/kap1/ZusammenhangBohrscheAtommodellundBaendermodell/ZusammenhangBohrscheAtommodellundBaendermodell_1}
                    \end{figure}
                    \vspace*{0.8cm}
                }
                \onslide<2->{
                    \begin{figure}[H]
                        \centering
                        \includesvg[width=.8\linewidth]{Bilder/kap1/ZusammenhangBohrscheAtommodellundBaendermodell/ZusammenhangBohrscheAtommodellundBaendermodell_2}
                    \end{figure}
                }
    ...
    \speech{Baendermodell_Atommodell}{1}{Links sehen wir das Bohrsche Atommodell, das du vielleicht noch aus der Schule kennst:
        Elektronen kreisen in definierten Bahnen - oder Schalen - um den Atomkern.
        Jede dieser Schalen hat ein festes Energieniveau.}
    \silence{3}
    \speech{Baendermodell_Atommodell}{4}{Links unten sehen wir die Entsprechung im Bändermodell:
        Auch hier geht es um mögliche Energienivohs - aber jetzt denken wir nicht mehr an einzelne Bahnen, sondern an Energiezonen im Material, die später zu Bändern zusammengefasst werden.}
    \silence{3}
\end{frame}
...
\begin{frame}
    \b{
        ...
        \begin{figure}[H]
            \centering
            \includesvg[width=.9\textwidth]{Bilder/kap1/UebergangVonEnergieniveausZuBaendern}
    ...
    \speech{Baendermodell_Uebergang}{1}{Jetzt gehen wir einen Schritt weiter.
        Ein einzelnes Atom hat klar definierte Energienivohs - das sehen wir links.
        Kommen zwei Atome zusammen, wirken sie elektrisch aufeinander.
        Nach dem Pauli-Prinzip dürfen zwei Elektronen nicht denselben Zustand einnehmen - ihre Energienivohs verschieben sich also leicht voneinander.
        Je mehr Atome beteiligt sind, desto mehr dieser leicht verschobenen Nivohs entstehen.
...
\begin{frame}
    \b{
        \subsubsection{Einteilung von Materialien}
        \frametitle{Einteilung von Materialien}
        \begin{figure}[H]
            \centering
            \includesvg[width=.7\textwidth]{Bilder/kap1/BaendermodelleinesMaterialsbei0K}
    ...
    \speech{Baendermodell_0K}{1}{Was bedeuten jetzt die Begriffe Valenzband, Leitungsband und Bandlücke?
...
\begin{frame}
    \b{
        ...
        \begin{figure}[H]
            \centering
            \includesvg[width=.95\textwidth]{Bilder/kap1/BaendermodellverschiedenerMaterialien}
    ...
    \speech{Einteilung_Materialien}{1}{In der nächsten Abbildung sehen wir, wie sich Materialien anhand ihrer Bandstruktur unterscheiden.
...
\begin{frame}
    ...
    \speech{Einteilung_Materialien_Merke}{3}{Merken wir uns:
...
\begin{frame}
    ...
    \speech{Halbleitermaterialien_Si}{1}{In diesem Abschnitt schauen wir uns an, wie Halbleitermaterialien aufgebaut sind - und wie man ihre Leitfähigkeit gezielt beeinflussen kann.
...
\begin{frame}
    ...
    \speech{Halbleitermaterialien_GaAs}{1}{Ein anderes Beispiel ist Galliumarsenid - ein sogenannter Verbindungshalbleiter.
...
\begin{frame}
    ...
    \speech{Halbleitermaterialien_Merke}{3}{Was solltest du dir merken?
...
\begin{frame}
    \b{
        ...
        \begin{table}[H]
            \centering
            \begin{tabular}{|p{1.6cm}|p{1.1cm}|p{2cm}|p{2.2cm}|p{2.2cm}|p{2.4cm}|}
                \hline
                \textbf{Material} & \textbf{Band\-lücke \newline (eV)} & \textbf{Ladungs\-trägerdichte \newline (cm$^{-3}$)} & \textbf{Elektronen\-beweglichkeit \newline (cm$^2$/Vs)} & \textbf{Löcher\-beweglichkeit \newline (cm$^2$/Vs)} & \textbf{Anwendungen}   \\
                \hline
                Si                & 1,1                                         & $10^{10} - 10^{15}$                                          & 1500                                                             & 450                                                          & Mikrochips, Solar\-zellen, Sensoren\\
                \hline
                Ge                & 0,7                                         & $10^{13} - 20^{19}$                                          & 3900                                                             & 1900                                                         & Transistoren, \newline Infrarot-Detektoren\\
                \hline
                GaAs              & 1,43                                        & $10^6 - 10^8$                                                & 8500                                                             & 400                                                          & Hoch\-fre\-quenz\-schaltungen, LEDs, Laser\-dioden \\
                \hline
            \end{tabular}
    ...
    \speech{Halbleitermaterialien_Tabelle1}{1}{Diese Tabellen geben dir einen Überblick über verschiedene Halbleitermaterialien - mit ihren physikalischen Eigenschaften und typischen Anwendungen.
...
\begin{frame}
    \b{
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|p{1.6cm}|p{1.1cm}|p{2cm}|p{2.2cm}|p{2.2cm}|p{2.4cm}|}
                ...
                \textbf{Material} & \textbf{Band\-lücke \newline (eV)} & \textbf{Ladungs\-trägerdichte \newline (cm$^{-3}$)} & \textbf{Elektronen\-beweglichkeit \newline (cm$^2$/Vs)} & \textbf{Löcher\-beweglichkeit \newline (cm$^2$/Vs)} & \textbf{Anwendungen}   \\
                \hline
                InP               & 1,35                                        & $10^{16} - 10^{17}$                                          & 5000 - 7000                                                      & 200 - 400                                                    & Optoelektro\-nik, Solar\-zellen \\
                \hline
                GaN               & 3,4                                         & $10^{13} - 10^{17}$                                          & 1000 - 2000                                                      & 50- 200                                                      & Leistungs\-elektronik, LED-Beleuch\-tung, Displays \\
                \hline
                SiC               & 3,0                                         & $10^{12} - 10^{16}$                                          & 800 - 1200                                                       & 200 - 400                                                    & Leistungs\-eletronik, Hoch\-tem\-peratur\-an\-wen\-dung \\
                \hline
            \end{tabular}
            \caption{Eigenschaften verschiedener Halbleitermaterialien}
            %\label{tab:EigenschaftenVerschiedenerHalbleitermaterialien}
    ...
    \speech{Halbleitermaterialien_Tabelle2}{1}{Gallium-Nitrid und Siliziumcarbid haben eine sehr große Bandlücke - das macht sie perfekt für die Leistungselektronik oder Anwendungen mit hoher Temperatur oder Spannung.
...
\b{
    % fix für die Erstellung von Lesezeichen bei Folien die onslide Befehle haben, ansonsten werden diese häufiger aufgezählt
    \subsection{Ladungsträgertransport}
}
...
\begin{frame}
        ...
        \onslide<1->{
            \begin{minipage}[t]{0.48\textwidth}
                \begin{figure}[H]
                    ...
                    \caption{Gitterstruktur und Bändermodell von \textbf{reinem Silizium} bei $T=0\,\mathrm{K}$}
    ...
    \speech{Ladungstraegertransport_Si}{1}{Und wie kommt Bewegung in die Sache?
    ...
    \silence{3}
    \speech{Ladungstraegertransport_Si}{2}{Rechts: Steigt die Temperatur, erhalten manche Elektronen genug Energie, um in das Leitungsband zu springen.
...
\begin{frame}
        ...
        \onslide<1->{
            \begin{minipage}[t]{0.48\textwidth}
                \begin{figure}[H]
                    ...
                    \caption{Gitterstruktur und Bändermodell von \textbf{n-dotiertem Silizium} bei $T=0\,\mathrm{K}$}
    ...
    \speech{Ladungstraegertransport_nSi}{1}{Noch effektiver wird es durch Dotierung.
    ...
    \silence{3}
    \speech{Ladungstraegertransport_nSi}{2}{Links: Bei 0 Kelvin bleibt es noch dort - aber rechts sehen wir: Schon bei leicht erhöhter Temperatur kann es ins Leitungsband springen.
...
\begin{frame}
        ...
        \onslide<1->{
            \begin{minipage}[t]{0.48\textwidth}
                \begin{figure}[H]
                    ...
                    \caption{Gitterstruktur und Bändermodell von \textbf{p-dotiertem Silizium} bei $T=0\,\mathrm{K}$}
    ...
    \speech{Ladungstraegertransport_pSi}{1}{Bei der p-Dotierung funktioniert es umgekehrt.
    ...
    \silence{3}
    \speech{Ladungstraegertransport_pSi}{2}{Rechts: Bei höherer Temperatur kann ein Elektron aus der Umgebung in dieses Loch springen.
...
\begin{frame}
    ...
    \speech{Ladungstraegertransport_Merke}{3}{Zusammengefasst:
...
\begin{frame}
    ...
    \speech{Ladungstraegertransport_Driftstrom}{1}{In diesem Video schauen wir uns an, wie sich Ladungsträger in Halbleitern bewegen - und was im sogenannten p n-Übergang passiert.
...
\begin{frame}
    ...
    \speech{Ladungstraegertransport_Diffusionsstrom}{1}{Der zweite wichtige Stromanteil ist der Diffusionsstrom.
...
\begin{frame}
    ...
    \speech{Ladungstraegertransport_Biasspannung}{1}{Und was passiert, wenn wir eine Spannung anlegen?
...
\begin{frame}
    \b{
        ...
        \begin{Merksatz}{}
            \begin{itemize}
                \onslide<1->{\item Driftstrom ist der Ladungsträgertransport auf Grund eines elektrischen Feldes.}
                \onslide<2->{\item Diffusionsstrom ist die Bewegung von Ladungsträgern auf Grund eines Konzentrationsunterschiedes.}
                \onslide<3->{\item Drift- und Diffusionsstrom ergeben zusammen den Gesamtstrom.}
                \onslide<4->{\item Eine externe Spannung führt zu einer Verschiebung des Bändermodells.}
            \end{itemize}
        \end{Merksatz}
    }
    \speech{DriftDiffusion_Merke}{4}{Fassen wir kurz zusammen:
...
\begin{frame}
    ...
    \speech{pn-Uebergang_1}{1}{Jetzt kommen wir zum p n-Übergang, einem zentralen Baustein vieler Bauelemente.
...
\begin{frame}
    \b{
        ...
        \end{figure}
        \begin{itemize}
            \onslide<1->{\item Durch die Bindung der Löcher und Elektronen an deren Atome begrenzt diese den Diffusionsstrom.}
                  \onslide<2->{\item Der Bereich in der Mitte nennt sich Raumladungszone (RLZ). Dort sind keine freien Ladungsträger, da die Elektronen und Löcher sich gegenseitig neutralisieren.}
                  \onslide<3->{\item Es entsteht ein elektrisches Feld zwischen den p- und n-dotierten Bereichen.}
        \end{itemize}
    }
    \speech{pn-Uebergang_RLZ}{3}{Durch Diffusion wandern Elektronen vom n- ins p-Gebiet, und Löcher vom p- ins n-Gebiet.
...
\begin{frame}
    ...
    \speech{pn-Uebergang_Vorgaenge}{1}{In der Raumladungszone wirken jetzt zwei Kräfte gegeneinander:
        Die Diffusion möchte weiterhin Ladungsträger nach außen treiben,
...
\begin{frame}
    ...
    \speech{pn-Uebergang_Spannung}{1}{Was passiert, wenn wir eine äußere Spannung anlegen?
...
\begin{frame}
    \b{
        ...
        \begin{Merksatz}{}
            \begin{itemize}
                \onslide<1->{\item Der pn-Übergang kombiniert eine p- und n-dotierte Halbleiterschicht.}
                \onslide<2->{\item Im Übergangsbereich sind keine freien Ladungsträger, der Bereich wird Raumladungszone genannt.}
                \onslide<3->{\item In Durchlassrichtung wird die RLZ verkleinert, in Sperrrichtung wird diese vergrößert.}
            \end{itemize}
        \end{Merksatz}
    
    }
    \speech{pn-Uebergang-Merke}{3}{Was du dir merken solltest:
