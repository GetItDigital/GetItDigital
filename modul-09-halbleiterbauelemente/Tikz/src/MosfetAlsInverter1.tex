\begin{tikzpicture}
    ...
    \draw (-1,1)  to [short, o-*] (pmos.S |- 2,1) to[short, -o] (4,1) node[right]{$5\,\mathrm{V}$};
    \draw (-1,-4)  to [short, o-*] (pmos.S |- 2,-4) to[short, -o] (4,-4) node[right]{$0\,\mathrm{V}$};
    \draw (pmos.D |- 2,-1.5) to[short, *-o] (4,-1.5)node[right]{$Q$};
