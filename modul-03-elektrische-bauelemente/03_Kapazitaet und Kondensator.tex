...
\section{Kapazität und Kondensator}\index{Kapazität}\index{Kondensator}
\s{
...
\begin{frame}
	...
	\b{
		\begin{itemize}\centering
			\item $ \displaystyle C = \frac{Q}{U} \qquad [C] =  1\,\text{Farad} = 1\, \text{F} = 1\,\frac{\text{C}}{\text{V}} = 1\,\frac{\text{A} \text{s}}{\text{V}} $
		\end{itemize}
	}
...
\s{
	Die Eigenschaften des Dielektrikums\index{Dielektrikum} sind materialspezifisch und werden durch die Dielektrizitätszahl $\varepsilon_\mathrm{r}$ quantifiziert.
...
\begin{frame}[t]
	\ftx{Das Dielektrikum}\index{Dielektrizitätszahl}
	\b{
		\begin{itemize}
