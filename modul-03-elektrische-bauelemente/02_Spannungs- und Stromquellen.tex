...
\begin{frame}
    ...
    \speech{02_Spannungs_und_Stromquellen7}{1}{ % ToDo: only 1 , bzw. ich bin nicht sicher ob der Text zur Umwandlung von Strom in Spannungsquelle geeignet ist
        ...
        Es ergibt sich für eine Spannungsquelle das folgende Bild: Wir haben eine Ausgangsspannung U_0. Wir haben einen Strom I, der sowohl durch den Innenwiderstand als auch durch den angeschlossenen Widerstand fließt, und demzufolge eine Spannung U, die an dem Widerstand R abfällt.}
    
    \speech{02_Spannungs_und_Stromquellen7}{2}{ % ToDo: only 2 
    ...
    \speech{02_Spannungs_und_Stromquellen7}{3}{ % ToDo: only 3
    ...
    \speech{02_Spannungs_und_Stromquellen7}{4}{ % ToDo: only 4
...
\begin{frame}%veränderungen von JW höhe der Bounding box von TIKZ
    ...
    \speech{02_Spannungs_und_Stromquellen8}{1}{ % ToDo: only 1
    ...
    \speech{02_Spannungs_und_Stromquellen8}{2}{ % ToDo: only 2 - 4
    ...
    \speech{02_Spannungs_und_Stromquellen8}{3}{ % ToDo: only 5 - 7
