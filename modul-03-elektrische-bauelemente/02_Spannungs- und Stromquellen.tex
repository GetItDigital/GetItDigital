...
\begin{frame}
    ...
    \speech{02_Spannungs_und_Stromquellen3}{1}{
        ...
        Dann würde der gesamte Strom nur durch den Innenwiderstand R-I fließen, was diesen extrem aufheizen würde.
...
\begin{frame}
    ...
    %; TODO: optional, rechnung für umrechnung einfügen und speech dementsprechen ergänzen
    %neuer seed
    \speech{02_Spannungs_und_Stromquellen8}{1}{
        Wir haben jetzt gesehen, dass es Strom- und Spannungsquellen gibt. Und letztlich haben beide an ihren Klemmen einen Ausgangsstrom I und eine Ausgangsspannung U. Bei realen Quellen wird das tatsächliche Verhalten maßgeblich vom Innenwiderstand R-I mitbestimmt.
        Es ergibt sich für eine Spannungsquelle das folgende Bild: Wir haben eine Quellspannung U-q. Wir haben einen Strom I, der sowohl durch den Innenwiderstand als auch durch den angeschlossenen Widerstand fließt, und demzufolge eine Spannung U, die an dem Widerstand R abfällt.
    ...
    \speech{02_Spannungs_und_Stromquellen8}{3}{
        Wir betrachten zuerst die Spannungsquelle auf der linken Seite und berechnen die Spannung U, die an dem Lastwiderstand abfällt. Da es eine Serienschaltung ist, berechnet sich die Spannung einfach über den Spannungsteiler U ist gleich U-q mal R durch R-i plus R.
    ...
    \silence{2}
    %neuer seed, ist schwäbisch geworden
    \speech{02_Spannungs_und_Stromquellen8}{4}{
        Wir erinnern uns aber, bei einer Stromquelle wird der Strom I-q vorgegeben und die Spannung stellt sich ein. Welchen Strom brauchen wir also? Richtig. Wir brauchen den Strom, der durch die Parallelschaltung von Last- und innen-widerstand der Stromquelle fließt wenn die Spannung U anliegt.
        Das ist der Strom i-q ist gleich U durch R parallel R-i.}

    \speech{02_Spannungs_und_Stromquellen8}{5}{
        Wenn wir nun unsere Spannungsteilerformel für U an der Spannungsquelle in die Formel für I-0 einsetzen, können wir einiges kürzen und erhalten dsas Ergebnis i-q ist gleich u-q durch R-i.
...
\begin{frame}
    ...
    % Speech text anpassen mehr auf Graphen eingehen
    ...
    \speech{02_Spannungs_und_Stromquellen9}{2}{
        Denn wenn jetzt der Innenwiderstand 1 Ohm ist, der Lastwiderstand 100 Ohm, dann fließt bei U-0 gleich 10 Volt ziemlich genau ein Strom von 100 mA – genau genommen 99,9 mA. Wenn wir jetzt den Lastwiderstand auf 1 kilo-Ohm erhöhen, dann ändert sich der Strom, in rot zu sehen, aber die Spannung am in blau, die an dem Lastwiderstand abfällt bleibt, wie im graphen zu sehen ist, nahezu konstant bei etwa 10 Volt.
        Das heißt immer dann, wenn der Lastwiderstand groß ist im Vergleich zum Innenwiderstand, haben wir eher Spannungsquellenverhalten. Völlig egal, ob wir eine Strom oder Spannungsquelle Schaltung haben.
        Wenn wir den linken Teil des graphen betrachten, sehen wir die Spannung U-R fällt ab. Das liegt daran, das der Lastwiderstand so klein wird, dass der großteil der Spannung nun am innenwiderstand abfällt.
        Wenn der LastWiderstand R 0 Ohm hat, also ein Kurzschluss ist, dann fällt die gesamte Spannung am Innenwiderstand R-i ab.
    }
\end{frame}
