...
\begin{frame}
    ...
    \b{
        \only<2->{
            \begin{itemize}
            \centering
            \item  $ U_\mathrm{q} = R \cdot I \Rightarrow \lim\limits_{R \to 0} \frac{U_\mathrm{q}}{R} \rightarrow \infty$
        \end{itemize}
        }
    }
...
\begin{frame}%veränderungen von JW höhe der Bounding box von TIKZ
    ...
    \speech{02_Spannungs_und_Stromquellen10}{1}{ % ; TODO: only 1
    ...
    \speech{02_Spannungs_und_Stromquellen10}{2}{ % ; TODO: only 2 - 4
    ...
    \speech{02_Spannungs_und_Stromquellen10}{3}{ % ; TODO: only 5 - 7
