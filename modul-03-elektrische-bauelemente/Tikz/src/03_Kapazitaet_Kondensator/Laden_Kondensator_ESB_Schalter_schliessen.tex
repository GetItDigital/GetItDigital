\begin{circuitikz}[scale=0.8]
    \centering
    \draw (0,-0.3) to [short] (0,4.2)
    -- (1,4.2) to[closing normal open switch, l={Schalter wird bei $t_\mathrm{0} = 0$ geschlossen}] (3,4.2)
    -- (4,4.2);
...
\begin{tikzpicture}
    \begin{axis} [
            xlabel={Zeit},
            ylabel={\textcolor{voltage} {$u_\mathrm{C}(t)$}}/\textcolor{current}{$i(t)$} ,
            % ylabel={
