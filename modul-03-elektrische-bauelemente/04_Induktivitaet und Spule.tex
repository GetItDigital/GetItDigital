...
\section{Induktivität und Spule}\index{Induktivität}\index{Spule}
...
\s{
	Bei der Ringkernspule\index{Ringkernspule} handelt es sich um einen mit Draht umwickelten Ferritring.
