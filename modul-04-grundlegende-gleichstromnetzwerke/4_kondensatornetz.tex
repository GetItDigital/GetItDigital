...
\begin{frame}
	...
	\s{
		...
		\index{Parallelschaltung (Kapazitäten)}
...
\begin{frame}
	...
	\s{
		\index{Reihenschaltung (Kapazitäten)}
...
\begin{frame}
	...
	\s{
	\index{Spannungsteiler (Kapazitäten)}
