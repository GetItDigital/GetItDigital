...
\s{
	...
	\begin{frame} 
		\begin{minipage}{0.45\textwidth}
			...
			\f{width=\textwidth, alt={Nahaufnahme einer elektronischen Leiterplatte mit zahlreichen integrierten Schaltkreisen, Kondensatoren, Widerständen und Leiterbahnen.}}{width=0.7\textwidth}{netzklein.png}{Symbolbild eines kleinen elektrischen Netzwerkes auf einer Platine  \label{fig:platine}}
			%	\fo{width=\textwidth, alt={XX}}{width=\textwidth}{Magnetisches_Feld_Leiter}{
		...
		\begin{minipage}{0.45\textwidth}
			...
			\f{width=\textwidth}{width=0.7\textwidth, alt={Weitwinkeldarstellung eines großflächigen Umspannwerks mit zahlreichen Hochspannungsmasten und elektrischen Leitungen, die ein weit verzweigtes Stromnetz symbolisieren. Im Hintergrund sind Windkraftanlagen und Kühltürme eines Kraftwerks zu erkennen.}}{netzgross.png}{Symbolbild eines großen elektrischen Netzwerkes  \label{fig:stromnetz}}
			%	\fo{width=\textwidth, alt={XX}}{width=\textwidth}{Magnetisches_Feld_Leiterschleife}{
...
\begin{frame}
	...
	\b{
		...
		\begin{columns}
			...
			\f{width=\textwidth}{width=0.7\textwidth, alt={Weitwinkeldarstellung eines großflächigen Umspannwerks mit zahlreichen Hochspannungsmasten und elektrischen Leitungen, die ein weit verzweigtes Stromnetz symbolisieren. Im Hintergrund sind Windkraftanlagen und Kühltürme eines Kraftwerks zu erkennen.}}{netzgross.png}{Symbolbild eines kleinen elektrischen Netzwerkes auf einer Platine}
			\begin{center}
				Symbolbilder
			\end{center}
			
			\f{width=\textwidth, alt={Nahaufnahme einer elektronischen Leiterplatte mit zahlreichen integrierten Schaltkreisen, Kondensatoren, Widerständen und Leiterbahnen.}}{width=0.7\textwidth}{netzklein.png}{Symbolbild eines kleinen elektrischen Netzwerkes auf einer Platine}
...
\begin{frame}
	...
	\s{
		\index{Zweipol}
		Als Zweipol (Abb. \ref{fig:zweipol}) wird ein Bauelement mit zwei äußeren Anschlussklemmen bezeichnet. Der innere Aufbau dieser
		...
		\begin{figure}[ht]
			...
			\label{fig:zweipol}
			\alttext{Schematische Darstellung eines allgemeinen Zweipols als rechteckiger Block mit zwei Anschlussklemmen auf der rechten Seite. Zwei rote Pfeile, beschriftet mit I1 und I2, kennzeichnen die gleich großen ein- und ausgehenden Stromstärken. Ein blauer Pfeil, beschriftet mit $U$, zeigt die anliegende Spannung zwischen den Klemmen}
		\end{figure}
...
\begin{frame}
	...
	\s{
		...
		\index{Erzeugerzählpfeilsystem}
		\index{Verbraucherzählpfeilsystem}
...
\begin{frame}
	...
	\s{
		...
		\begin{figure}[ht]
			...
			\alttext{Schematische Darstellung eines elektrischen Grundstromkreises mit vier Widerständen, einer Spannungsquelle sowie markierten Knoten, Zweigen und einer Masche. Die oberen Leiterverbindungen bilden eine geschlossene Schleife, während die unteren Widerstände über eine gestrichelte Linie als Zweig hervorgehoben sind. Die roten Pfeile kennzeichnen die Richtung der Knotenströme.}
		\end{figure}
