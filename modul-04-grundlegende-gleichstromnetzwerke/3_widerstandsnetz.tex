...
\begin{frame}
	...
	\s{
		...
		\begin{figure}[ht]
			\begin{center}
				\input{Tikz/src/3_widerstandsnetz/Reihenschaltung_Wiederstaende_1}\alttext{Schematische Darstellung einer Reihenschaltung bestehend aus einer Spannungsquelle U0 und zwei in Serie geschalteten Widerständen R1 und R2. Der elektrische Strom I verläuft im Uhrzeigersinn durch die Schaltung.}
		...
		\begin{figure}[ht]
			\begin{center}
				\input{Tikz/src/3_widerstandsnetz/Reihenschaltung_Wiederstaende_2}\alttext{Darstellung einer elektrischen Schaltung. Eine Spannungsquelle U0 treibt den Strom I im Uhrzeigersinn durch die Schaltung. Der Gesamtwiderstand Rges ist rechts im Stromkreis eingezeichnet, über ihm liegt die Spannung Uges, die mit einem Pfeil nach unten gekennzeichnet ist. Die Spannung U0 der Quelle ist ebenfalls nach unten gerichtet.}
	...
	\s{
		...
		\begin{figure}[ht]
			\begin{center}
				...
				\input{Tikz/src/3_widerstandsnetz/Parallelschaltung_Wiederstaende_1}\alttext{Schaltskizze einer elektrischen Parallelschaltung mit zwei Widerständen R1 und R2, die an eine Spannungsquelle U0 angeschlossen sind. Der Gesamtstrom I0 teilt sich am oberen Knoten in die Teilströme I1 durch R1 und I2 durch R2 auf. Beide Widerstände sind parallel zwischen denselben Knoten verbunden und werden von den Spannungen U1 beziehungsweise U2 durchflossen, die identisch zur Quellenspannung U0 ausgerichtet sind. Alle Spannungen sind durch Pfeile nach unten dargestellt.}
		...
		\begin{bsp}{Parallelschaltung von Widerständen}{parallelschaltung}
			...
			\begin{center}
				...
				\input{Tikz/src/3_widerstandsnetz/Parallelschaltung_3_Wiederstaende}\alttext{Darstellung einer Parallelschaltung mit drei Widerständen R1, R2 und R3, die an eine gemeinsame Spannung U angeschlossen sind. Der Gesamtstrom I0 teilt sich am oberen Knoten in die Teilströme I1, I2 und I3 auf.}
	...
	\s{	
		...
		\begin{figure}[ht]
			\begin{center}
				...
				\input{Tikz/src/3_widerstandsnetz/Spannungsteiler_unbelastet}\alttext{Schematische Darstellung eines unbelasteten Spannungsteilers mit zwei Widerständen R1 und R2. Die Spannungsquelle mit der Spannung U0 treibt den Strom I durch den oberen Widerstand R1, an dem die Teilspannung U1 abfällt. Der zweite Widerstand R2 ist in Reihe geschaltet, über ihm liegt die Spannung U2. Beide Spannungen U1 und U2 addieren sich zur Gesamtspannung U0. Der Strompfeil I ist rot eingezeichnet, die Spannungspfeile U0, U1 und U2 sind blau dargestellt.}
		...
		\begin{bsp}{Unbelasteter Spannungsteiler}{Spannungsteiler_unbel}
		...
		\begin{figure}[ht]
			\begin{center}
				...
				\input{Tikz/src/3_widerstandsnetz/Spannungsteiler_belastet}\alttext{Schematische Darstellung eines belasteten Spannungsteilers mit einer Spannungsquelle U0, den Widerständen R1 und R2 sowie einem zusätzlichen Lastwiderstand RL. Die Spannungsquelle U0 treibt den Strom I durch R1, an dem die Spannung U1 abfällt. Die Spannung U2 liegt über dem Parallelzweig aus R2 und RL, der durch eine gestrichelte Linie hervorgehoben ist. Der Strompfeil I ist rot markiert, die Spannungspfeile U0, U1 und U2 sind in Blau dargestellt.}
		...
		\begin{bsp}{Belasteter Spannungsteiler}{Spannungsteiler_bel}
...
\begin{frame}
	...
	\s{
		...
		\begin{figure}[ht]
			...
			\begin{center}
				\input{Tikz/src/3_widerstandsnetz/Stromteiler}\alttext{Schaltskizze einer Parallelschaltung mit zwei Widerständen R1 und R2, die an einer gemeinsamen Spannungsquelle U0 betrieben werden. Der Gesamtstrom I0 teilt sich in die Teilströme I1 und I2 auf, die durch R1 bzw. R2 fließen. Alle Spannungen über den Widerständen sind mit U0 bezeichnet und verlaufen vertikal nach unten, während die Strompfeile I0, I1 und I2 rot markiert sind.}

			\end{center}
			\caption{Stromteiler der Stromstärke $I_0$ in die Teilstromstärken $I_1$ und $I_2$, bestehend aus den parallel geschalteten Widerständen $R_1$ und $R_2$\label{fig:stromteiler}}
...
\begin{frame}
	...
	\s{
		...
		\index{Kurzschlussversuch}
		\index{Leerlaufversuch}
	...
	\s{
		\begin{figure}[h]
			\begin{minipage}[b]{0.45\linewidth}
				\centering
				\input{Tikz/src/3_widerstandsnetz/reale_Spannungsquelle}\alttext{Schaltskizze einer realen Spannungsquelle, bestehend aus einer idealen Spannungsquelle U0 und einem in Reihe geschalteten Innenwiderstand Ri. Über dem Innenwiderstand liegt die Spannung URi an, und der Strom I fließt nach rechts zum Ausgang der Quelle. Die Klemmen­spannung U wird zwischen dem Ausgangspunkt und dem unteren Anschluss gemessen.}
			...
			\begin{minipage}[b]{0.45\linewidth}
				...
				\input{Tikz/src/3_widerstandsnetz/reale_Spannungsquelle_belastet}\alttext{Schaltskizze einer realen Spannungsquelle mit angeschlossenem Lastwiderstand Ra. Die ideale Spannungsquelle U0 ist in Reihe mit dem Innenwiderstand Ri geschaltet. Über Ri fällt die Spannung URi = R·I ab, während der Strom I durch den Lastwiderstand Ra fließt. Die Klemmenspannung U wird parallel zu Ra gemessen.}
	...
	\s{
		...
		\begin{figure}[ht]
			...
			\begin{center}
				...
				\input{Tikz/src/3_widerstandsnetz/Ersatzspannungsquelle}\alttext{Schaltskizze einer Ersatzspannungsquelle, deren Aufbau einer realen Spannungsquelle entspricht. Die ideale Spannungsquelle U0 und der Innenwiderstand Ri befinden sich innerhalb eines gestrichelten Kastens, der die Ersatzspannungsquelle kennzeichnet. Über Ri fällt die Spannung URi = R·I ab. Der Strom I fließt durch den angeschlossenen Lastwiderstand Ra, über dem die Klemmenspannung U anliegt.}
		...
		\begin{figure}[ht]
			...
			\alttext{Kennlinie der Ersatzspannungsquelle im U-I-Diagramm. Auf der y-Achse ist die Spannung U(I) aufgetragen, auf der x-Achse die Stromstärke I. Die Kurve verläuft linear fallend von der Leerlaufspannung U0 bei I = 0 bis zum Kurzschlussstrom IK = U0/Ri, bei dem die Klemmenspannung null beträgt. Die Grafik verdeutlicht den linearen Zusammenhang zwischen Spannung und Stromstärke einer realen Spannungsquelle mit Innenwiderstand Ri.}
		...
		\begin{figure}[ht]
			\begin{center}
				...
				\input{Tikz/src/3_widerstandsnetz/Ermittlung_Leerlaufspannung}\alttext{Schematische Darstellung zur Bestimmung der Leerlaufspannung UL einer Ersatzspannungsquelle. Der Spannungsquelle ist als Zweipol dargestellt, dessen Ausgang offen ist, sodass kein Strom fließt. Zwischen den offenen Klemmen liegt die gemessene Spannung U = UL an, die der Leerlaufspannung der Quelle entspricht.}
		...
		\begin{figure}[ht]
			\begin{center}
				...
				\input{Tikz/src/3_widerstandsnetz/Ermittlung_Kurzschlussstrom}\alttext{Schematische Darstellung zur Bestimmung des Kurzschlusstroems IK einer Ersatzspannungsquelle. Der Spannungsquelle ist als Zweipol dargestellt, dessen Ausgang kurzgeschlossen ist, sodass keine Spannung abfällt. Zwischen den Klemmen fließt der Strim IK}
			\end{center}
...
\begin{frame}
	...
	\s{
		...
		\begin{figure}[h!]
			...
			\centering
			\input{Tikz/src/3_widerstandsnetz/reale_Stromquelle}\alttext{Schematische Darstellung einer realen Stromquelle, bestehend aus einer idealen Stromquelle I0 und einem parallel geschalteten Innenwiderstand Ri. Der Innenwiderstand leitet einen Strom IRi > 0 ab, während der Hauptstrom I über den Lastwiderstand Ra fließt. Die anliegende Spannung U fällt zwischen den oberen und unteren Klemmen ab.}
	...
	\s{
		...
		\begin{figure}[ht]
			\begin{center}
				...
				\input{Tikz/src/3_widerstandsnetz/Ersatzstromquelle}\alttext{Darstellung einer Ersatzstromquelle, bestehend aus einer idealen Stromquelle I0 und einem parallel geschalteten Innenwiderstand Ri. Der Innenwiderstand leitet den Strom IRi ab, der gemäß IRi = U/Ri berechnet wird. Die anliegende Spannung U fällt über dem Lastwiderstand Ra ab. Der gestrichelte Kasten markiert den Bereich der Ersatzstromquelle.}
		...
		\begin{figure}[ht]
			\centering
			\includesvg[width=0.6\textwidth]{kennlinie_ersatzstromquelleskript}\alttext{Kennlinie einer Ersatzstromquelle. Auf der y-Achse ist die Stromstärke I(U), auf der x-Achse die Spannung U dargestellt. Die rote Gerade fällt linear von I0 bei U = 0 bis auf 0 bei UL = I0 * Ri ab.}
	...
	\s{
		...
		\begin{figure}[h!]
			...
			\begin{center}
				...
				\input{Tikz/src/3_widerstandsnetz/Umwandlung_Ersatzstromquelle_Ersatzspannungsquelle}\alttext{Darstellung der Umwandlung zwischen Ersatzstromquelle und Ersatzspannungsquelle. Links befindet sich eine Ersatzstromquelle, bestehend aus einer idealen Stromquelle I0 und einem parallel geschalteten Innenwiderstand Ri. Rechts ist die äquivalente Ersatzspannungsquelle dargestellt, die aus einer idealen Spannungsquelle U0 und einem in Reihe geschalteten Innenwiderstand Ri besteht. Beide versorgen denselben Lastwiderstand Ra. Die beiden Darstellungen sind durch ein Doppelpfeilsymbol verbunden, welches die gegenseitige Austauschbarkeit der beiden Ersatzmodelle verdeutlicht.}


			\end{center}
			\caption{Umwandlung einer Ersatzstromquelle (links) in eine Ersatzspannungsquelle (rechts) und umgekehrt\label{fig:umwandlung}}
		\end{figure}
