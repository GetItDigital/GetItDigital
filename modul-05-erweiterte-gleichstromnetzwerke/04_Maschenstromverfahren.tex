...
\newvideofile{Mastrom}{Maschenstromverfahren}\index{Maschenstromanalyse}
\begin{frame}
...
\ftb{Vorbereitung des Netzwerkes}
    ...
    \fu{
        \input{Tikz/src/Umwandlung_Stromquelle}\alttext{Die Grafik zeigt links ein Zweipolnetzwerk: eine Stromquelle mit Strom I_q nach oben liegt parallel zu einem Widerstand R_i zwischen zwei Anschlussklemmen. Ein Pfeil zeigt auf die äquivalente Darstellung rechts: dort befindet sich eine Spannungsquelle U_q nach unten in Serie mit demselben Widerstand R_i im oberen Zweig. Beide Darstellungen beschreiben dasselbe äußere Verhalten des Zweipols.}
...
\begin{frame}
    ...
    \fu{                                     % Beginn Bild Netzwerk 1 mit rotem Kreis
		\resizebox{\textwidth}{!}{%
        \input{Tikz/src/Umwandlung_Stromquelle_Netzwerk}\alttext{Die Abbildung zeigt links einen Stromkreis mit drei Zweigen zwischen oberer und unterer Sammelschiene; der rechte Zweig ist rot eingekreist und enthält eine Stromquelle I_q nach unten und parallel dazu den Widerstand R_2 mit Spannung U_R2 und Strom I_2 nach oben.
Rechts ist derselbe Gesamtstromkreis dargestellt, oben liegt der Widerstand R_2(Strom I_2nach unten, Spannung U_R2), darunter eine Spannungsquelle U_2 nach unten.
}
        }
...
\begin{frame}
    ...
    \fu{
        ...
        \input{Tikz/src/Beispiel_Maschenanalyse}\alttext{Die Schaltung besitzt eine obere und eine untere Sammelschiene. Links liegt eine Spannungsquelle U_0 in Serie mit dem Widerstand R_0; in der Mitte verbindet ein senkrechter Zweig aus zwei in Reihe geschalteten Widerständen R_3 und R_4 die beiden Schienen. Vom oberen Knoten dieses Mittelzweigs geht nach rechts eine Reihenschaltung aus Spannungsquelle U_1 und Widerstand R_1, vom mittleren Knoten eine horizontale Leitung mit dem Widerstand R_5. Rechts unten befindet sich in der Hauptleitung eine Stromquelle, parallel dazu ein Nebenzweig mit dem Widerstand R_2; an allen Bauelementen sind Ströme und Spannungsabfälle mit Pfeilen gekennzeichnet.}
        }
