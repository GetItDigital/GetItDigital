...
\usepackage{chngcntr} 		% Nummerierung von Formeln, Bildern usw. nur auf Chapter-Ebene
...
%Beispiel
\newtcbtheorem[number within=chapter]{bsp}{Beispiel}{enhanced,
	before skip=1cm,
	after skip=1cm,
	colframe=GETgreen,
