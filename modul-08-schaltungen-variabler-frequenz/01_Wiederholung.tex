...
Willkommen zum ersten Video des Moduls Schaltungen variabler Frequenz.
...
\s{% Skript-only
    ...
    Zwischen Strom und Spannung besteht jeweils eine Phasenverschiebung von $\pm 90\ \degree$.
    ...
    \begin{figure}[H]\centering
        \begin{subfigure}{0.68\textwidth}\centering
            \includegraphics[alt={Plot zeigt sinusförmige Zeitverläufe für u und i bei R. Beide sind in Phase.}]{Tikz/pdf/plot_bauteile_phasenverschiebung_r.pdf}% uR, iR
        \end{subfigure}%
        \begin{subfigure}{0.28\textwidth}\centering
            \includegraphics[alt={Schaltsymbol für R. Weißes Rechteck mit zwei Anschlüssen. Einer je kurzer Seite.}]{Tikz/pdf/circ_bauteil_R_u_i.pdf}% R
        \end{subfigure}\hfill% newline
        \begin{subfigure}{0.68\textwidth}\centering
            \includegraphics[alt={Plot zeigt sinusförmige Zeitverläufe für u und i bei L. Strom eilt 90 Grad voraus.}]{Tikz/pdf/plot_bauteile_phasenverschiebung_l.pdf}% uL, iL
        \end{subfigure}%
        \begin{subfigure}{0.28\textwidth}\centering
            \includegraphics[alt={Schaltsymbol für die Induktivität L. Schwarz ausgefülltes Rechteck mit zwei Anschlüssen. Jeweils einer an den kurzen Seiten.}]{Tikz/pdf/circ_bauteil_L_u_i.pdf}% L
        \end{subfigure}\hfill% newline
        \begin{subfigure}{0.68\textwidth}\centering
            \includegraphics[alt={Plot zeigt sinusförmige Zeitverläufe für u und i bei C. Strom eilt u um 90 Grad nach.}]{Tikz/pdf/plot_bauteile_phasenverschiebung_c.pdf}% uC, iC
            \caption{Strom- und Spannungsverläufe}
        \end{subfigure}%
        \begin{subfigure}{0.28\textwidth}\centering
            \includegraphics[alt={Schaltsymbol für die Kapazität C. Zwei parallele Linien mit Zwischenraum. Von beiden Linien führt senkrecht ein Anschluss weg.}]{Tikz/pdf/circ_bauteil_C_u_i.pdf}% C
...
Bei Induktivitäten L hingegen eilt der Strom der Spannung um neunzig Grad hinterher bei Anregung mit einer sinusförmigen Wechselgröße.
...
Hier eilt die Spannung dem Strom um neunzig Grad hinterher.
Das bedeutet, dass die Spannung ihr Maximum erst eine Viertel Periode nach dem Strom erreicht.
Die Phasenverschiebungen bei Induktivitäten und Kapazitäten beträgt immer betragsmäßig neunzig Grad.
...
\s{% Skript-only
    ...
    \begin{figure}[H]\centering
        \begin{subfigure}{0.45\textwidth}\centering
            \includegraphics[width=0.75\textwidth, alt={Foto einer Spule, die eine Induktivität realisiert. Zu sehen sind Kupferwicklungen um einen Kern herum.}]{./Bilder/Spule.png}
        \end{subfigure}%
        \begin{subfigure}{0.45\textwidth}\centering
            \includegraphics[width=0.75\textwidth, alt={Foto eines Kondensators, der eine Kapazität realisiert. Zu sehen sind zwei parallele Metallplatten mit Luft im Zwischenraum.}]{./Bilder/Kondensator.png}
        \end{subfigure}
...
Im Zeitbereich ausgedrückt, ist U proportional zu L mal der zeitlichen Ableitung von I.
...
Hier ist die Admittanz proportional zur Kreisfrequenz und Kapazität. Die Impedanz der Kapazität ist ebenfalls rein imaginär, allerdings negativ und umgekehrt proportional zur Kreisfrequenz und Kapazität.
Im Zeitbereich ausgedrückt, ist I proportional zu C mal der zeitlichen Ableitung von U.
Die Energie ist bei Kapazitäten im elektrischen Feld gespeichert, dadurch sind Spannungen in Kapazitäten stetig, das heißt sie können keine Sprünge aufweisen.
}% Ende speech
\end{frame}
...
\begin{frame}\ftx{\subsubsecname}
    ...
    \begin{tabular}{ |c|c|c|c|c| }
        ...
        \hline%
        %\textbf{Symbol}
        \includegraphics[alt={Schriftzug: Symbol.}]{Tikz/pdf/circ_bauteil_tabelle_text_symbol.pdf}% Symbol (vertikal zentriert); Schriftart entspricht Textfont im Skript (mit Serifen), nicht in den Folien (ohne Serifen)
                & \includegraphics[alt={Schaltsymbol für den allgemeinen Zweipol. Rechteck mit zwei Anschlüssen. Beschriftung Zweipol Eintor.}]{Tikz/pdf/circ_bauteil_tabelle_zweipol.pdf}
                & \includegraphics[alt={Schaltsymbol für den elektrischen Widerstand R. Weißes Rechteck mit zwei Anschlüssen. Ein Anschluss je kurzer Seite.}]{Tikz/pdf/circ_bauteil_tabelle_R.pdf}
                & \includegraphics[alt={Schaltsymbol für die Induktivität L. Schwarz ausgefülltes Rechteck mit zwei Anschlüssen. Ein Anschluss je kurzer Seite.}]{Tikz/pdf/circ_bauteil_tabelle_L.pdf}
                & \includegraphics[alt={Schaltsymbol für die Kapazität C. Zwei parallele Linien mit Zwischenraum. Von beiden Linien führt senkrecht ein Anschluss weg.}]{Tikz/pdf/circ_bauteil_tabelle_C.pdf} \\[+4pt]
        ...
        \hline
    \end{tabular}
    } % end resizebox % Problem: Resizebox geht nicht mit alttext
    \end{table}
...
Umgekehrt ist die Suszeptanz B, das ist der Imaginärteil der Admittanz Ypsilon, bei Kapazitäten positiv und bei Induktivitäten negativ.
...
Die Grundlagen der komplexen Wechselstromrechnung sind Voraussetzung für das Verständnis der folgenden Kapitel.
...
\begin{frame}\ftx{\subsecname}
    ...
    \begin{figure}[h]
        \begin{subfigure}{0.48\textwidth}\centering
            \includegraphics[alt={Schaltsymbol für einen allgemeinen Zweipol/Eintor. Strom I geht an einer Klemme hinein und an der anderen Klemme heraus. Spannung U von Klemme zu Klemme.}]{Tikz/pdf/circ_eintor.pdf}
        \end{subfigure}\hfill
        \begin{subfigure}{0.48\textwidth}\centering
            \includegraphics[alt={Schaltsymbol für einen allgemeinen Vierpol/Zweitor. Komplexe Spannung U1 über den zwei Eingangsklemmen und komplexe Spannung U2 über den zwei Ausgangsklemmen.}]{Tikz/pdf/circ_zweitor.pdf}
        \end{subfigure}
    ...
    \fu{\includegraphics[alt={Schaltungsbild mit Eintor Quelle über Zweitor Verbindungselement an Eintor Last angeschlossen.}]{Tikz/pdf/circ_zweitor_quelle_last.pdf}
