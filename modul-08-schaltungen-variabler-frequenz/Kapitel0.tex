...
\s{% Skript-only
    ...
    \begin{figure}[H]\centering
        \begin{subfigure}{0.68\textwidth}\centering
            \includegraphics[alt={Plot zeigt sinusförmige Zeitverläufe für u und i bei R. Beide sind in Phase.}]%
            {Tikz/pdf/plot_bauteile_phasenverschiebung_r.pdf}% uR, iR
        \end{subfigure}%
        \begin{subfigure}{0.28\textwidth}\centering
            \includegraphics[alt={Schaltsymbol für R. Weißes Rechteck mit zwei Anschlüssen. Einer je kurzer Seite.}]%
            {Tikz/pdf/circ_bauteil_R_u_i.pdf}% R
        \end{subfigure}\hfill% newline
        \begin{subfigure}{0.68\textwidth}\centering
            \includegraphics[alt={Plot zeigt sinusförmige Zeitverläufe für u und i bei L. Strom eilt 90 Grad voraus.}]%
            {Tikz/pdf/plot_bauteile_phasenverschiebung_l.pdf}% uL, iL
        \end{subfigure}%
        \begin{subfigure}{0.28\textwidth}\centering
            \includegraphics[alt={Schaltsymbol für die Induktivität L. Schwarz ausgefülltes Rechteck mit zwei Anschlüssen. Jeweils einer an den kurzen Seiten.}]%
            {Tikz/pdf/circ_bauteil_L_u_i.pdf}% L
        \end{subfigure}\hfill% newline
        \begin{subfigure}{0.68\textwidth}\centering
            \includegraphics[alt={Plot zeigt sinusförmige Zeitverläufe für u und i bei C. Strom eilt u um 90 Grad nach.}]%
            {Tikz/pdf/plot_bauteile_phasenverschiebung_c.pdf}% uC, iC
            \caption{Strom- und Spannungsverläufe}
        \end{subfigure}%
        \begin{subfigure}{0.28\textwidth}\centering
            \includegraphics[alt={Schaltsymbol für die Kapazität C. Zwei parallele Linien mit Zwischenraum. Von beiden Linien führt senkrecht ein Anschluss weg.}]%
            {Tikz/pdf/circ_bauteil_C_u_i.pdf}% C
