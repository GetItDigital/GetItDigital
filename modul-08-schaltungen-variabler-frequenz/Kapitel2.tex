...
Hier wird humorvoll dargestellt, wie eine logarithmische Skala es ermöglich t,
...
Dies entspricht einer Dämpfung von drei Dezibel beziehungsweise einer Ausgangsleistung, die die Hälfte der Eingangsleistung beträgt.
}% Ende speech
...
Anders als ein idealer Tiefpass mit keiner Dämpfung im Durchlassbereich und unendlicher Dämpfung im Sperrbereich mit einer unendlich steilen Flanke dazwischen,
...
Im folgenden Video werden wir die Grenzkreisfrequenz Omega G bei des gezeigten Tiefpasses bestimmen und den Frequenzgang anschließend in einem Bode-Diagramm darstellen.
...
Durch Umstellen erhalten wir den Term Omega G ist gleich dem Kehrwert von R C.
}% Ende speech
\speech{05LogDarstellung2TiefpassErsterOrdnung}{4}{%
Die Phasendifferenz bei der Grenzkreisfrequenz beträgt dabei minus 45 Grad.
}% Ende speech
...
Der Frequenzgang lässt sich so Komponenten unabhängig nur in Abhängigkeit der normierten Frequenz darstellen. 
}% Ende speech
