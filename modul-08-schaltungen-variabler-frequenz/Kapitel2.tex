...
Wilkommen zum Video über logarithmische Darstellungen.
...
Der Comic beginnt mit der Grenze des sichtbaren Teil des Universums in sechs und vierzig Milliarden Lichtjahren Entfernung. 
Knapp darunter kommt die Grenze von einer Milliarde Lichtjahre. 
Bei etwas über einer Millionen Lichtjahre liegt die Andromeda Galaxie.
Die Grenze von Tausend Lichtjahren ist nicht eingezeichnet, liegt aber ungefähr auf Höhe des Orionnebels oder Betageuze.
...
Darunter kommen Spermien, Baktereophagen, Carbon Nanotubes bis hin zu regelmäßig angeordneten Silizium Atomen.
}% Ende speech
...
wie bei der Messung des Schalldruckpegels in Bezug auf eine Nenn Schall Leistung. 
...
Im folgenden Video werden wir die Grenzkreisfrequenz Omega G für den gezeigten Tiefpasses bestimmen 
...
Wilkommen zum Video über logarithmische Darstellungen von Frequenzgängen von Filterschaltungen verschiedener Ordnung.
...
In diesem Beispiel ist Omega G gleich dem Eins durch R C.
}% Ende speech
...
Hier noch einmal im Vergleich noch einmal links die lineare und rechts die logarithmische Darstellung des Amplituden- und Phasenganges eines Tiefpasses erster Ordnung.
...
Beim Phasengang eines Tiefpasses erster Ordnung in halb logarithmischer Darstellung, sehen wir, 
...
Der Übergangsbereich um die Grenzfrequenz ist durch eine S Kurve gekennzeichnet dem Wendepunkt bei der Grenzfrequenz mit minus fünfundvierzig Grad.
...
so wird der Bereich zwischen beiden Grenzfrequenzen durch gelassen, während Frequenz außerhalb dieses Frequenzbandes gesperrt werden.
...
Sie ist definiert als geometrisches Mittel der beiden Grenzfrequenzen, dass heißt als Wurzel aus dem Produkt beider Grenzfrequenzen.
}% Ende speech
\silence{2}%
\speech{05LogDarstellung7BandpassZweiterOrdnung}{1}{%
