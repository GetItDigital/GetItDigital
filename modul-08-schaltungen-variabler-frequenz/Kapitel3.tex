...
Wilkommen zum Video über Ortskurven.
...
Die Ortskurve ist definiert als die graphische Darstellung einer komplexen Größe in Abhängigkeit eines reellen Parameters in der komplexen Ebene.
...
Der dargestellte Kreis ist die Ortskurve für den komplexen Statorstrom I S in Abhängigkeit des Schlupfes S dar.
...
In diesem Fall sind sind das beispielsweise der Motor-, der Brems- und der Generatorbetrieb der Asynchronmaschine.
}% Ende speech
...
\silence{1}%
\speech{06Ortskurven6AdmittanzInversionOrtskurven}{1}{%
Bei Inversionen ergeben sich speziell für Geraden und Kreisen die in der Tabelle dargestellten Beziehungen.
...
Wie Sie sehen können, erhalten wir bei der Impedanzkurve jeweils eine Halbgerade, das heißt von einem Punkt bis ins unendlich laufend
