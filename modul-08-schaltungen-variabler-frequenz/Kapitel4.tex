...
Wilkommen zum Video über Resonanzkreise.
...
Am Beispiel der Schwingkreise, auch Resonanzkreise genannt, links im Bild erläutern wir nun die wichtigsten Definitionen im Zusammenhang mit Resonanz.
...
Bei niedrigen Frequenzen dominiert die Kapazität, bei hohen Frequenzen die Induktivität.
Im Resonanzfall heben sich die Effekte von Induktivität und Kapazität gegenseitig auf.
Die Resonanzbedingung wie rechts gezeigt besagt, dass im Resonanzfall der Imaginärteil der Gesamtimpedanz gleich null ist.
}% Ende speech
\silence{1}
\speech{07Resonanzkreise3Definitionen}{1}{%
...
Analog dazu ist der Kennleitwert B k definiert als der Betrag des Leitwertes der Induktivität beziehungsweise der Kapazität im Resonanzfall.
Die Schwingkreisgüte Kuh, auch kurz Güte genannt, ist definiert als das Verhältnis von Blindleistungsbetrag der Induktivität oder der Kapazität zur Wirkleistung des Schwingkreises im Resonanzfall.
...
Bei der Eigenkreisfrequenz wird zwischen der gedämpften Eigenkreisfrequenz f d und der ungedämpften Eigenkreisfrequenz f null unterschieden.
Die ungedämpfte Eigenkreisfrequenz entspricht exakt der Resonanzkreisfrequenz, die gedämpfte Eigenkreisfrequenz ist bei realen Schwingkreisen, das heißt mit elektrischem Widerstand, 
geringfügig kleiner als die Resonanzkreisfrequenz. Die Eigenfrequenzen und das freie Schwingverhalten werden in Modul zwölf Schaltvorgänge näher behandelt.
}% Ende speech
\end{frame}
...
Die Strom I komplex ist gleich der Spannung U komplex mal dem Admittanz des Schwingkreises.
...
Auf dieser Folie sehen Sie die Nebenrechnung zur Herleitung für die Resonanzkreisfrequenz, den Kennwidesrtand, die Güte und die Spannungsteiler der einzelnen Bauteile 
...
Durch Erweiterung mit dem Kehrwert des Kennwiderstandes können lassen sich die Impedanzterme normieren und mithilfe der Resonanzkreisfrequenz und der Güte ausdrücken.
...
Der Maximaltrom im Resonanzfall ist dabei durch den ohmschen Widerstand begrenzt.
...
Der Unterschied liegt darin, dass der in diesem Fall die Suszeptanz der Kapazität linear verläuft, wie an der roten gestrichelten Linie zu erkennen ist.
...
Oben links sehen Sie nochmals das Schaltbild des Parallelschwingkreises mit der und links sehen sie exemplarisch die Stromteilerregel für den Kondensatorstrom.
So wie es beim Serienschwingkreis zu Überspannungen kommen kann, können im Parallelschwingkreis Überströme auftreten.
...
Diese Blindströme sind von außerhalb der Schaltung nicht messbar, können aber um ein Vielfaches größer als der Wirkstrom beziehungsweise der Quellenstrom sein.
Das Verhältnis von Überstrom zu Gesamtstrom im Resonanzfall ist durch die Güte des Parallelschwingkreises beschrieben.
