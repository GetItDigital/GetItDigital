...
%
\newvideofile{LogDarstellungAllgemeinDefinitionen}{Logarithmische Darstellung - Allgemeines und Definitionen}%
\v{% Video only Frame
\begin{frame}\ftx{\secname}
    \begin{Lernziele}{Video - Logarithmische Darstellung, Allgemeines}
        ...
        \item{Dezibel als Einheit kennen und zu verwenden, und}
        \item{Grenzfrequenzen von Filterschaltungen kennen und zu bestimmen.}
        \end{itemize}
    \end{Lernziele}
\speech{04LogDarstellung1Lernziele}{1}{%
Willkommen zum Video über logarithmische Darstellungen.
Sie lernen in diesem Video Unterschiede zwischen linearer und logarithmischer Darstellung kennen.
Außerdem lernen Sie Dezibel als Einheit kennen und zu verwenden, 
sowie Grenzfrequenzen von Filterschaltungen kennen und zu bestimmen.
}% Ende speech
\end{frame}%
...
\begin{frame}\ftx{\secname}%
% <--- here is an empty page (Skript), unknown why, disappears if surrounding \begin{frame}...\b{...}\end{frame} is commented out --->
\s{% single page comic strips (left and right)
    \begin{figure}[H]
        \begin{subfigure}{.5\textwidth}\centering% left
            \resizebox{!}{.95\textheight}{\includegraphics[alt={Comic Strip Height von XKCD zeigt Objekte in verschiedenen Höhen auf einer logarithmischen Skala von der Grenze des beobachtbaren Universums in 46 Milliarden Lichtjahren Entfernung bis zu Menschen mit einer Größe von ein-zwei Metern mit maßstabsgetreuen Höhen. Zwischen einer Milliarde und einer Millionen Lichtjahre sind u.a. die Andromeda Galaxie und kollidierende Antennae Galaxien dargestellt. Zwischen einer Millionen und einem Lichtjahr Höhe sind u.a. der Orion Nebel und Betegeuze gezeigt. Einige Objekte: Voyager I - Pluto - Saturn - Jupiter - Sonne - Mond - Apollo 13 - GPS Satelliten - ISS - Weltraummüll - Flugzeuge - Mount Everest - Helicopter - Eiffelturm (325m) - Großen Pyramiden (140m) - Mammutbaum (115m) - Eiche (20m) - Brachosaurus (13m) - Giraffe (8m) - Menschen (ca. 2m)}]{Bilder/xkcd_482_height_logaxis_large_scales_cc-2.5-by-sa.png}}
                \caption{Comic \textit{Height}, Log-Skala Höhe\cite[\#482]{xkcd}}%
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}\centering% right
            \resizebox{!}{.95\textheight}{\includegraphics[alt={Comic Strip Depth von XKCD zeigt Objekte in verschiedenen Tiefen auf einer logarithmischen Skala von einem Menschem bis zu Protonen. Der Comic zeigt in maßstabsgetreuer Größe in absteigender Reihenfolge überlagernd die Bestandteile eines Arbeitsrechner u.a. Gehäuse - DVD Laufwerke - Maus (Tier) - CPU-Socket - Mücke (Torrent) - CPU (upcoming Segfault) - Reiskorn - Staubmilbe - Haarquerschnitt - Rostmilbe - Spermium (Fork();) - Pter Norton vs. Bakteriophage - Memory - Carbon Nanotubes (Space Elevator) - Silizium Atome - Elektronenwolke - Siliziumkerne - Ipod Femto - Proton - Brian Greene knitting furiously (String theorist)}]{Bilder/xkcd_485_depth_logaxis_small_scales_cc-2.5-by-sa.png}}
...
\speech{04LogDarstellung2Comic}{1}{%
Beginnen wir mit einem lockeren Einstieg in das Thema logarithmische Darstellung.
Links sehen Sie das obere Drittel des Comic Strips Height von XKCD. 
Hier wird humorvoll dargestellt, wie eine logarithmische Skala es ermöglicht,
Objekte in Höhen extrem unterschiedlicher Größenordnungen übersichtlich in einem Diagramm darzustellen.
Der Comic beginnt mit der Grenze des sichtbaren Teil des Universums in sechsundvierzig Milliarden Lichtjahren Entfernung. 
Knapp darunter kommt die Grenze von einer Milliarde Lichtjahre. 
Bei etwas über einer Million Lichtjahre liegt die Andromeda Galaxie.
Die Grenze von Tausend Lichtjahren ist nicht eingezeichnet, liegt aber ungefähr auf Höhe des Orionnebels oder Beteigeuze.
Die Höhe im Comic entspricht relativ maßstabsgetreu der Entfernung der dargestellten Objekten im All bei logarithmischer Skalierung.
}% Ende speech
\speech{04LogDarstellung2Comic}{2}{%
Auf dieser Folie sehen Sie den mittleren Teil des Comics.
Hier sind Objekte von etwas unterhalb von Tausend Lichtjahren bis zum Mond der Erde dargestellt.
Die Voyager One Raumsonde befindet sich in etwa einen Lichttag Entfernung von der Erde.
Das entspricht in etwa drei mal zehn hoch minus drei Lichtjahren.
Die Sonne wiederum ist mit circa fünfhundert Lichtsekunden Entfernung ungefähr sechzehn mal zehn hoch minus sechs Lichtjahre entfernt.
}% Ende speech
\speech{04LogDarstellung2Comic}{3}{%
Hier sehen Sie den unteren Teil des Comics, wo wir über den geostationären Orbit bei circa sechsunddreißigtausend Kilometer Höhe hinaus bis zur Erdoberfläche zoomen.
Die Größe der Objekte ist nicht maßstabsgetreu, um die Objekte erkennbar zu machen, aber die Höhenpositionen sind es.
Ein gleichmäßiger Abstand auf der Y Achse entspricht dem gleichen Faktor in der Höhe.
Auf die gleiche Weise können wir auch sehr kleine Größenordnungen darstellen, wie im Comic Depth von XKCD auf der rechten Seite.
Im ersten Drittel des Comics sehen wir Lebewesen und Objekte ab einer ungefähr menschlichen Größe,
von Computern, über Mäuse, CPU Sockets, Moskitos, Staubmilben, Haare, sowie nicht näher definierte Elemente einer Prozessoreinheit in verschiedenen Größenordnungen.
}% Ende speech
\speech{04LogDarstellung2Comic}{4}{%
Im mittleren Teil des Depth Comics sehen wir Rust Mites zu Deutsch Rost Milben mit einer Größe im zwei bis dreistelligen Mikrometerbereich. 
Darunter kommen Spermien, Bakteriophagen, Carbon-Nanotubes bis hin zu regelmäßig angeordneten Silizium Atomen.
}% Ende speech
\speech{04LogDarstellung2Comic}{5}{%
Am Ende des Comics sehen wir eine Elektronenwolke, einen Siliziumkern und schließlich ein Proton mit einer Größe von etwa einem Femtometer,
also zehn hoch minus fünfzehn Metern, neben einigen Anspielungen und Witzen.
}% Ende speech
\end{frame}%
    ...
    \s{
        ...
        \begin{figure}[H]
            \begin{subfigure}{0.48\textwidth}\centering
                \resizebox*{\textwidth}{!}{\includegraphics[alt={Lineare Darstellung mehrerer Potenzfunktionen x^n als Kurven. Nur x^0 und x^1 sind Geraden. Alle Funktionen kreuzen sich in f(1)=1.}]{Tikz/pdf/plot_potenzfunktionen_lin_scale.pdf}}
                \caption{Potenzfunktionen, lineare Achsen}
            \end{subfigure}%
            \begin{subfigure}{0.48\textwidth}\centering
                \resizebox*{\textwidth}{!}{\includegraphics[alt={Logarithmische Darstellung mehrerer Potenzfunktionen x^n als Geraden. Alle Funktionen kreuzen sich in f(1)=1.}]{Tikz/pdf/plot_potenzfunktionen_log_scale.pdf}}
...
\speech{04LogDarstellung3Potenzfunktionen}{1}{%
Vergleichen wir nun die lineare Darstellung von Potenzfunktionen auf der linken Seite 
mit der doppelt-logarithmischen Darstellung auf der rechten Seite.
Wie in den beiden Comics zuvor, ist es möglich in logarithmischer Darstellung 
sehr große Wertebereiche übersichtlich darzustellen.
Ein weiterer Vorteil der doppelt-logarithmischen Darstellung ist, 
dass Potenzfunktionen als Geraden dargestellt werden können,
was gerade bei der Analyse von Amplitudengängen von Filtern und Verstärkern hilfreich ist.
}% Ende speech
\silence{1}
\speech{04LogDarstellung3Potenzfunktionen}{1}{%
In der linearen Darstellung links, sind alle 
Potenzfunktionen mit Exponenten ungleich null oder eins gekrümmt.
In der doppelt-logarithmischen Darstellung rechts hingegen, 
sind alle Potenzfunktionen Geraden mit Steigung entsprechend ihrem Exponenten.
Eine Verschiebung der Kurve wird durch Multiplikation und eine Streckung durch Änderung des Exponenten erreicht.
}% Ende speech
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\s{%
	...
	\begin{align}% script only - with numbering
        &\textrm{Leistungsgrößen }(\textrm{z.B. }P,\ W)&
            Q_{\mathrm{(P)}} &= \mathrm{log}\frac{P_2}{P_1}\ \operatorname{B} = 10\cdot \mathrm{log}\frac{P_1}{P_2}\,\mathrm{dB} &&
            \label{eq:def:dezibel:leistung}\\
        &\textrm{Leistungswurzelgr.}(\textrm{z.B. }U,\ I)&
            Q_{\mathrm{(R)}} &= \mathrm{log}\frac{U_2^2}{U_1^2}\ \operatorname{B} = 20\cdot \mathrm{log}\frac{U_1}{U_2}\,\mathrm{dB} &&
...
\s{%
    Die Angabe $Q$ in $\mathrm{dB}$ beschreibt hier die Verstärkung\index{Verstärkung} eines Systems von Eingangs- (Index $1$) zu Ausgangssignal (Index $2$).
    ...
    Eine Änderung um $6\mathrm{dB}$ entspricht auf die zweite Nachkommastelle gerundet genau dem Faktor $2$ für Spannungen
    und auf die erste Nachkommastelle gerundet genau dem Faktor $4$ für Leistungen. 
} 

% Tabelle Braille-Form
% Tyische Dezibelwerte (Verstärkung in $\mathrm{dB}$) bei Spannungsverhältnissen
% U2/U1     | P1/P2 | Q in dB
% ----------|-------|--------
% 1/2       | 1/4   | -6
% sqrt(1/2) | 1/2   | -3
...
\b{
    ...
    \centering{Tyische Dezibelwerte (Verstärkung in $\mathrm{dB}$) bei Spannungsverhältnissen}
    \begin{table}[H]\centering
        \begin{tabular}{ |c|g|c|g|c|g|c|g|c| }
            \hline &&&&&&&&\\[-11pt]
                $\frac{U_2}{U_1}$   & $\frac{1}{\sqrt{2}}$  & $1$ 		        & $\sqrt{2}$ 	    & $2$               & $\sqrt{10}$       & $10$	            & $20$ 		        & $100$ \\[+2pt]
            \hline &&&&&&&&\\[-11pt]
                $Q_{\mathrm{dB}}$   & $-3\,\mathrm{dB}$     & $0\,\mathrm{dB}$ 	& $+3\,\mathrm{dB}$ & $+6\,\mathrm{dB}$ & $10\,\mathrm{dB}$ & $20\,\mathrm{dB}$ & $26\,\mathrm{dB}$ & $40\,\mathrm{dB}$ \\[+2pt]
            \hline
        \end{tabular}
    \end{table}
}
...
\s{%
    ...
    \newcolumntype{g}{>{\columncolor{Gray}}c}
    \begin{table}[H]\centering
        \caption{Tyische Dezibelwerte (Verstärkung in $\mathrm{dB}$) bei Spannungs- und Leistungsverhältnissen}
        \label{tab:dezibel}
        \begin{tabular}{ |l c|g|c|g|c|g|c|g|c| }
            ...
            \hline &&&&&&&&&\\[-10pt]
                \textbf{Verstärkung}    & $Q_{\mathrm{dB}}$ &
                $-3\,\mathrm{dB}$ 		& $0\,\mathrm{dB}$ 	& $+3\,\mathrm{dB}$  $+6\,\mathrm{dB}$  & $10\,\mathrm{dB}$ & $20\,\mathrm{dB}$ & $26\,\mathrm{dB}$	& $40\,\mathrm{dB}$ \\[+3pt]
            \hline
        \end{tabular}
    \end{table}%
    Dadurch, dass $3\,\mathrm{dB}$ sehr präzise dem Faktor $2$ bei Leistungen (Faktor $\sqrt{2}$ bei Spannungen) entspricht, 
    beziehungsweise $6\,\mathrm{dB}$ dem Faktor $4$, lassen sich relativ einfach Abschätzungen vornehmen.
    ...
    \begin{itemize}
        \item Faktor $1 = 0\,\mathrm{dB}$
        \item Faktor $2 \approx 6\,\mathrm{dB}$
        \item Faktor $4 \approx 12\,\mathrm{dB}$ \quad mit \quad $4 = 2^2 \approx 2\cdot 6\,\mathrm{dB}$
        \item Faktor $5 \approx 14\,\mathrm{dB}$ \quad mit \quad $5 = 10 \cdot \frac{1}{2} \approx 20\,\mathrm{dB} - 6\,\mathrm{dB}$
        \item Faktor $8 \approx 18\,\mathrm{dB}$ \quad mit \quad $8=2^3 \approx 3\cdot 6\,\mathrm{dB}$
        \item Faktor $10 = 20\,\mathrm{dB}$ \quad $\Longrightarrow$ \quad $20 \mathrm{dB} / \mathrm{Dek}$ (spannungsbezogen)
    \end{itemize}    
    
    Exemplarisch ist in Abbildung \ref{plot:tiefpass:bode:ampli:detail} die logarithmische y-Achse für $A(\omega)$ 
    einmal einheitenlos (links) und einmal in $\mathrm{dB}$ (rechts) angegeben mit Kennzeichnung der ganzzahligen Faktoren 
    ...
    Beide Angaben werden typischerweise in $\mathrm{dB}$ und falls nicht näher deklariert in Bezug auf Spannungspegel angegeben.
    In Datenblättern wird die Dämpfung in $\mathrm{dB}$ teilweise auch mit negativem Vorzeichen angegeben.
}%


\speech{04LogDarstellung4Dezibel}{1}{%
Kommen wir nun zur Definition des Dezibels.
Das Dezibel ist eine Hilfsmaßeinheit zur Kennzeichnung dekadisch-logarithmischer Verhältnisse zweier einheitengleicher Größen.
Verwendung findet es unter anderem in der Signaltheorie und Nachrichtentechnik, beispielsweise um die Verstärkung oder Dämpfung
eines Bauteils oder einer Signalstrecke anzugeben. In unserem Fall dient es zur Beschreibung des Amplitudenganges von Filtern.
}% Ende speech
\silence{1}
\speech{04LogDarstellung4Dezibel}{1}{%
Das Dezibel ist definiert als das zehnfache des dekadisch-logarithmischen Verhältnisses zweier einheitengleicher Leistungsgrößen, 
wie in der ersten Gleichung gezeigt ist.
Der Faktor zehn stammt von der Umrechnung der Basiseinheit Bel in Dezibel, welche auf Alexander Graham Bell zurückgeht.
Da die Leistung proportional zum Quadrat von Spannung oder Strom ist, 
muss bei der Verwendung von Dezibel als Einheit unterschieden werden,
ob es sich auf Leistungsgrößen oder sogenannte Leistungswurzelgrößen bezieht.
Der Faktor zwei bei letzterer entspricht der Quadratproportionalität, 
welche vor die Logarithmusfunktion gezogen wird.
}% Ende speech
\silence{2}
\speech{04LogDarstellung4Dezibel}{1}{%
In der Tabelle unten sind typische Dezibelwerte für bestimmte Spannungsverhältnisse aufgelistet, 
welche eine schnelle Abschätzung ermöglichen.
Anders als die SI-Einheit Neper, welche auf dem natürlichen Logarithmus basiert, 
ist das Dezibel in der Praxis weiter verbreitet.
Das liegt vor allem daran, dass die Umrechnung von typischen Spannungsverhältnissen in Dezibel 
relativ einfach mit Hilfe von Faustformeln möglich ist.
Drei Dezibel entsprechen beispielsweise dem Faktor zwei bei Leistungsgrößen, 
wie bei der Messung des Schalldruckpegels in Bezug auf eine Nenn-Schallleistung. 
Bei Spannungen entsprechen drei Dezibel dem Faktor Wurzel zwei, sechs Dezibel dem Faktor zwei 
und zwanzig Dezibel entsprechen dem Faktor zehn.
Die Addition der Dezibelwerte entspricht der Multiplikation der entsprechenden Verhältnisse. 
Das heißt sechsundzwanzig Dezibel entsprechen zum Beispiel dem Faktor zwanzig bei Spannungen.
}% Ende speech
\end{frame}
...
\s{% Skript only, ohne Miniapge
    ...
    Nach Tabelle \ref{tab:dezibel} entspricht dies einer Dämpfung von $3\mathrm{dB}$ respektive einer Verstärkung von $-3\mathrm{dB}$. 
    ...
    \fu{\includegraphics[alt={Amplitudengang eines einfachen Tiefpasses in linearer Skala mit gekennzeichnetem Durchlass- und Sperrbereich. Ideal springt A(omega) schlagartig von 1 auf 0 bei der Grenzfrequenz. Real nimmt A(omega) langsam ab mit A(omega)=1/sqrt(2) bei der Grenzkreisfrequenz.}]{Tikz/pdf/plot_tiefpass_mini_ampli_lin_bereiche.pdf}}{Durchlassbereich und Sperrbereich eines einfachen Tiefpasses, lineare Skala\label{plot:tiefpass:ampli:bereiche:lin}}
...
\speech{04LogDarstellung5Grenzfrequenz}{1}{%
Kommen wir nun zur Grenzfrequenz F G einfacher Filterschaltungen und der daraus abgeleiteten Grenzkreisfrequenz Omega G.
Für einfache Filterschaltungen ist die Grenzfrequenz definiert als die Frequenz, bei der das Verhältnis von Ausgangs- zu Eingangsspannung
den Wert Eins durch Wurzel Zwei annimmt, wie in der Gleichung gezeigt ist.
Dies entspricht einer Dämpfung von drei Dezibel beziehungsweise einer Ausgangsleistung, 
die die Hälfte der Eingangsleistung beträgt.
}% Ende speech
\speech{04LogDarstellung5Grenzfrequenz}{2}{%
Die Grenzfrequenz teilt den Frequenzbereich des Amplitudenganges in einen Durchlassbereich und einen Sperrbereich.
Im Durchlassbereich ist die Ausgangsspannung größer als der Wert bei der Grenzfrequenz, im Sperrbereich kleiner.
}% Ende speech
\speech{04LogDarstellung5Grenzfrequenz}{3}{%
Als Beispiel betrachten wir einen R C Tiefpass erster Ordnung.
Anders als ein idealer Tiefpass mit keiner Dämpfung im Durchlassbereich 
und unendlicher Dämpfung im Sperrbereich mit einer unendlich steilen Flanke dazwischen,
zeigt der reale Tiefpass einen kontinuierlichen Übergang zwischen Durchlass- und Sperrbereich.
Die Grenzfrequenz dient hier als sinnvolle Abgrenzung zwischen beiden Bereichen.
Im folgenden Video werden wir die Grenzkreisfrequenz Omega G des gezeigten Tiefpasses bestimmen 
und anschließend den Frequenzgang in einem Bode-Diagramm darstellen.
...
%
\newvideofile{LogDarstellungFrequenzgangFilterOrdnung}{Logarithmische Darstellung - Frequenzgang von Filterschaltungen verschiedener Ordnung}%
\v{% Video only Frame
\begin{frame}\ftx{\secname}
    \begin{Lernziele}{Video - Logarithmische Darstellung, Frequenzgang von Filterschaltungen verschiedener Ordnung}
        Sie lernen in diesem Video:
        \begin{itemize}\b{\setlength\itemsep{0.7em}}
        \item Bodediagramme zu konstruieren und zu interpretieren.
        \item Funktionsweise von Bandpass- und Bandsperrfilter kennen und verstehen.
        ...
        \end{itemize}
    \end{Lernziele}
\speech{05LogDarstellung1Lernziele}{1}{%
Willkommen zum Video über logarithmische Darstellungen von Frequenzgängen von Filterschaltungen verschiedener Ordnung.
Sie lernen in diesem Video Bodediagramme zu konstruieren und zu interpretieren.
Zudem lernen Sie die Funktionsweise von Bandpass- und Bandsperrfiltern kennen und verstehen.
Abschließend lernen Sie den prinzipiellen Aufbau und das frequenzabhängige Übertragungsverhalten von Filtern höherer Ordnung kennen und verstehen.
}% Ende speech
\end{frame}%
}% Ende Video only Frame
%
...
\s{%
    ...
    % Plot
    \fu{\includegraphics[alt={Bode-Diagramm des Amplitudengangs eines Tiefpasses 1. Ordnung normiert auf die Grenzkreisfrequenz. Doppelt logarithmische Skalierung. Der Amplitudengang zeigt einen Durchlassbereich für Frequenzen unterhalb der Grenzfrequenz und einen Sperrbereich für Frequenzen oberhalb der Grenzfrequenz. Die Steigung im Sperrbereich beträgt -20 dB pro Dekade. Dämpfung bei Grenzfrequenz -3 dB.}]{Tikz/pdf/plot_tiefpass_detail_amplitudengang_log_norm_detail.pdf}}{Bode-Diagramm Tiefpass 1. Ordnung, Amplitudengang\label{plot:tiefpass:bode:ampli:detail}}
    ...
    \end{align*}
    Die Steigung der Asymptote (Gerade) im Sperrbereich beträgt $-20 \mathrm{dB}/\mathrm{Dek}$, 
    aufgrund der Proportionalität von $A(\omega) \sim \omega^{-1}$.
    
    Die Näherung durch beide Asymptoten weicht maximal $3 \mathrm{dB}$ für $\omega = \omega_g$ vom realen Verlauf ab.
    ...
    % Plot
    \fu{\includegraphics[alt={Bode-Diagramm des Phasengangs eines Tiefpasses 1. Ordnung normiert auf die Grenzkreisfrequenz. Doppelt logarithmische Skalierung. Die Phasenverschiebung geht von 0 Grad bis -45 Grad im Durchlassbereich und von -45 Grad bis -90 Grad im Sperrbereich. S-förmiger Kurvenverlauf.}]{Tikz/pdf/plot_tiefpass_detail_phasengang_log_norm_detail.pdf}}{Bode-Diagramm Tiefpass 1. Ordnung, Phasengang\label{plot:tiefpass:bode:phase:detail}}
...
\speech{05LogDarstellung2TiefpassErsterOrdnung}{1}{%
Kommen wir nun zurück zum Tiefpass erster Ordnung.
Auf der linken Seite sehen Sie die Schaltung eines RC-Tiefpasses erster Ordnung mit dem zugehörigen 
Frequenzgang, Amplitudengang und Phasengang, wie in den Videos zu Frequenzgängen bereits hergeleitet wurde.
Beginnen wir mit der Bestimmung der Grenzkreisfrequenz Omega G, bevor wir die logarithmische Darstellung betrachten.
}% Ende speech
\speech{05LogDarstellung2TiefpassErsterOrdnung}{2}{%
Der Amplitudengang A von Omega G wird gleichgesetzt mit Eins durch Wurzel Zwei.
Durch Umstellen erhalten wir den Term für Omega G.
}% Ende speech
\speech{05LogDarstellung2TiefpassErsterOrdnung}{3}{%
In diesem Beispiel ist Omega G gleich Eins durch R C.
}% Ende speech
\speech{05LogDarstellung2TiefpassErsterOrdnung}{4}{%
Die Phasendifferenz beträgt minus 45 Grad bei der Grenzkreisfrequenz.
}% Ende speech
\speech{05LogDarstellung2TiefpassErsterOrdnung}{5}{%
Setzen wir Omega G in die Gleichungen für den Frequenzgang, Amplitudengang und Phasengang ein,
können wir die Größen R und C eliminieren und erhalten normierte Ausdrücke in Abhängigkeit von Omega durch Omega G.
Der Frequenzgang lässt sich so Komponenten unabhängig in Abhängigkeit der Grenzkreisfrequenz darstellen. 
}% Ende speech
\speech{05LogDarstellung2TiefpassErsterOrdnung}{6}{%
Für den Amplitudengang ergibt sich in doppelt logarithmischer Darstellung der folgende Verlauf, hier für eine Grenzkreisfrequenz von Hundert pro Sekunde.
}% Ende speech
\speech{05LogDarstellung2TiefpassErsterOrdnung}{7}{%
Für den Phasengang in einfach logarithmischer Darstellung, das heißt mit linearer Y Achse, ergibt sich der folgende gezeigte Verlauf.
Die gemeinsame Darstellung von Amplituden- und Phasengang wie hier gezeigt, wird als Bode-Diagramm bezeichnet und ist die übliche Darstellungsform von Frequenzgängen.
}% Ende speech
\end{frame}
...
\s{%
    ...
    \begin{figure}[H]
        \begin{subfigure}{0.5\linewidth}\centering
            \includegraphics[alt={Lineare Darstellung des Amplitudengangs eines Tiefpasses 1. Ordnung. Die Amplitude bleibt für sehr niedrige Frequenzen gleich und fällt bei höheren Frequenzen ab. Die Kurve stagniert knapp über null.}]{Tikz/pdf/plot_tiefpass_minimal_amplitudengang_linear3.pdf}
        \end{subfigure}
        \begin{subfigure}{0.5\linewidth}\centering
            \includegraphics[alt={Logarithmische Darstellung des Amplitudengangs eines Tiefpasses 1. Ordnung. Verlauf des Amplitudenganges ist unterhalb der Grenzfrequenz näherungsweise konstant und oberhalb der Grenzfrequenz näherungsweise gerade abfallend mit einer Steigung von einer Dekade pro Dekade. Abgerundeter Übergang an der Grenzfrequenz.}]{Tikz/pdf/plot_tiefpass_detail_amplitudengang_log.pdf}
        \end{subfigure}\hfill%
        \begin{subfigure}{0.5\linewidth}\centering
            \includegraphics[alt={Lineare Darstellung des Phasengangs eines Tiefpasses 1. Ordnung. Die Phasenverschiebung von 0 Grad bis -90 Grad. Kurvenverlauf zunächst steil und dann immer flacher.}]{Tikz/pdf/plot_tiefpass_minimal_phasengang_linear3.pdf}
            \caption{Lineare Darstellung}
        \end{subfigure}
        \begin{subfigure}{0.5\linewidth}\centering
            \includegraphics[alt={Logarithmische Darstellung des Phasengangs eines Tiefpasses 1. Ordnung. Die Phasenverschiebung von 0 Grad bis -45 Grad im Durchlassbereich und von -45 Grad bis -90 Grad im Sperrbereich. S-förmiger Kurvenverlauf. Wendepunkt bei Grenzfrequenz.}]{Tikz/pdf/plot_tiefpass_detail_phasengang_log.pdf}%
    ...
    jedoch einer minimalen Steigung von $-20\,\mathrm{dB}/\mathrm{Dek}$ an. 
...
\speech{05LogDarstellung3TiefpassLinLog}{1}{%
Hier noch einmal im Vergleich links die lineare und rechts die logarithmische Darstellung des Amplituden- und Phasenganges eines Tiefpasses erster Ordnung.
Deutlich zu erkennen ist der Unterschied in der Skalierung der Achsen. Im Bode Diagramm rechts lassen sich deutlich größere Wertebereiche abbilden.
Zudem ist insbesondere der Amplitudengang deutlich einfacher zu interpretieren und zu skizzieren.
}% Ende speech
\end{frame}
...
\speech{05LogDarstellung4AmplitudengangDetail}{1}{%
Sehen wir uns den Amplitudengang eines Tiefpasses erster Ordnung im Detail an.
Wie zu erkennen ist, ist der Verlauf im Durchlassbereich nahezu konstant bei zehn hoch null, also dem Faktor eins, was null Dezibel entspricht.
Im Sperrbereich fällt der Amplitudengang mit einer konstanten Steigung von minus zwanzig Dezibel pro Dekade ab, das entspricht dem Faktor zehn pro Dekade.
Wie wir später noch sehen werden, bestimmt die Ordnung des Filters die Steigung im Sperrbereich.
Das liegt daran, dass der Amplitudengang im Sperrbereich bei Filtern erster Ordnung näherungsweise proportional zu eins durch Omega ist.
Die Grenzfrequenz liegt bei exakt eins durch Wurzel zwei also circa null Komma sieben null sieben. Das entspricht sehr genau den minus drei Dezibel.
}% Ende speech
\silence{1}
\speech{05LogDarstellung4AmplitudengangDetail}{1}{%
Die Y Achsen Schritte sind links einheitenlos in Dekaden angegeben und rechts in zwanzig Dezibel Schritten.
Üblich ist eine der beiden Darstellungen, hier sind zur Verdeutlichung der Dezibel Skala beide Darstellungen gezeigt.
Die linearen Zwischenschritte in Null Komma Eins Schritten einer Dekade verteilen sich durch die logarithmische Skalierung entsprechend.
Zu erkennen ist, dass sich viele dieser Zwischenschritte sehr exakt mit ganzzahligen Dezibel Schritten auf der rechten Seite decken, wodurch die Umrechnung zwischen beiden Skalen erleichtert wird.
Das heißt Null Komma eins entspricht minus zwanzig Dezibel, Null Komma zwei entspricht minus vierzehn Dezibel, Null Komma vier entspricht minus acht Dezibel und so weiter.
}% Ende speech
\end{frame}
%
...
\speech{05LogDarstellung5PhasengangDetail}{1}{%
Beim Phasengang eines Tiefpasses erster Ordnung in halblogarithmischer Darstellung, sehen wir, 
dass der Verlauf im Durchlassbereich bei null Grad beginnt und sich asymptotisch auf minus neunzig Grad im Sperrbereich zubewegt.
Der Übergangsbereich um die Grenzfrequenz ist durch eine S Kurve gekennzeichnet, mit dem Wendepunkt bei der Grenzfrequenz und minus fünfundvierzig Grad.
Die S Kurve ist symmetrisch um diesen Wendepunkt und ungefähr drei bis vier Dekaden breit.
}% Ende speech
\end{frame}
}% End Beamer only
...
\s{%
    ...
    \begin{figure}[H]\centering
        \begin{subfigure}{0.48\linewidth}\centering
            \includegraphics[alt={Bode-Diagramm: Amplitudengang eines Tiefpass 1. Ordnung doppeltlogarithmisch skaliert. Konstant 1 unterhalb der Grenzfrequenz. Gerade abfallend oberhalb der Grenzfrequenz. }]{Tikz/pdf/plot_tiefpass_detail_amplitudengang_log_norm.pdf}% Leerzeile für Zeilenumbruch:

            \includegraphics[alt={Bode-Diagramm: Phasengang eines Tiefpass 1. Ordnung halblogarithmisch skaliert. S-förmiger Verlauf von 0 Grad bis -90 Grad mit Wendepunkt bei der Grenzfrequenz.}]{Tikz/pdf/plot_tiefpass_detail_phasengang_log_norm.pdf}%
            \caption{Tiefpass 1. Ordnung}
        \end{subfigure}%
        \begin{subfigure}{0.48\linewidth}\centering
            \includegraphics[alt={Bode-Diagramm: Amplitudengang eines Hochpass 1. Ordnung doppeltlogarithmisch skaliert. Gerade steigend unterhalb der Grenzfrequenz. Konstant 1 oberhalb der Grenzfrequenz. }]{Tikz/pdf/plot_hochpass_detail_amplitudengang_log_norm.pdf}% Leerzeile für Zeilenumbruch:

            \includegraphics[alt={Bode-Diagramm: Phasengang eines Hochpass 1. Ordnung halblogarithmisch skaliert. S-förmiger Verlauf von 90 Grad bis 0 Grad mit Wendepunkt bei der Grenzfrequenz.}]{Tikz/pdf/plot_hochpass_detail_phasengang_log_norm.pdf}%
...
\speech{05LogDarstellung6TiefpassHochpassVergleich}{1}{%
Beim Vergleich der Bode-Diagramme von Tief- und Hochpass erster Ordnung fällt auf,
dass beide Filtertypen spiegelbildliche Amplitudengänge besitzen.
Der Tiefpass sperrt bei hohen Frequenzen, während der Hochpass bei niedrigen Frequenzen sperrt.
Die Dämpfungssteigung im Sperrbereich beträgt bei beiden Filtertypen betragsmäßig zwanzig Dezibel pro Dekade.
Die Phasengänge hingegen wirken auf den ersten Blick identisch.
Sie unterscheiden sich jedoch im Wertebereich.
Beim Tiefpass bewegt sich der Phasengang S förmig von null Grad auf minus neunzig Grad,
während der Hochpass von plus neunzig Grad auf null Grad verläuft.
}% Ende speech
\end{frame}
...
\s{%
    ...
    \fu{\resizeboxsb{0.8}{1}{\includegraphics[alt={Schaltbild eines Bandpasses 2. Ordnung als Serienschaltung eines RC-Tiefpasses und eines RC-Hochpasses jeweils erster Ordnung. Symbolischer OP-Verstärkerblock zwischen beiden Filtern verhindert Rückwirkung.}]{Tikz/pdf/circ_bandpass.pdf}}}{Bandpass 2. Ordnung, Schaltbild\label{fig:circ:bandpass}}
    ...
    Der Verstärkungsfaktor beträgt $1$ (passiv) und die Grenzkreisfrequenzen liegen bei $10^2\,\mathrm{s}^{-1}$ und $10^4\,\mathrm{s}^{-1}$.

    \begin{figure}[h]\centering
        \begin{subfigure}{\textwidth}\centering
            \includegraphics[alt={Bode-Diagramm des Amplitudengangs eines Bandpasses 2. Ordnung. Der Amplitudengang zeigt einen Durchlassbereich zwischen zwei Grenzkreisfrequenzen und Sperrbereiche außerhalb. Steigungen im Sperrbereich jeweils +/-20 dB pro Dekade. }]{Tikz/pdf/plot_bandpass_amplitudengang_no_xaxis.pdf}
        \end{subfigure}\newline
        \begin{subfigure}{\textwidth}\centering
            \includegraphics[alt={Bode-Diagramm des Phasengangs eines Bandpasses 2. Ordnung. Der Phasengang zeigt eine Phasenverschiebung von +90 Grad bei niedrigen Frequenzen (Hochpassverhalten) und -90 Grad bei hohen Frequenzen (Tiefpassverhalten). Die Mittenkreisfrequenz liegt geometrisch in der Mitte zwischen den beiden Grenzkreisfrequenzen. Die Phasenverschiebung ist dort null (Hoch- und Tiefpassverhalten heben sich auf).}]{Tikz/pdf/plot_bandpass_phasengang.pdf}
        \end{subfigure}
    ...
    ebenso wie die $-3\,\mathrm{dB}$ Grenze (schwarz gestrichelt, horizontal)
    ...
    \begin{align}
        \omega_{\mathrm{gu}} &= 10^2\,\mathrm{s}^{-1} \qquad \text{und} \qquad
            \omega_{\mathrm{go}} = 10^4\,\mathrm{s}^{-1}\vphantom{\bigg|}\\
    ...
    Gut zu erkennen ist das Hochpassverhalten im unteren Sperrbereich (mit $+20\mathrm{dB}/\mathrm{Dek}$ und $\varphi(\omega) > 0\degree$)
    und das Tiefpassverhalten im oberen Sperrbereich (mit $-20\mathrm{dB}/\mathrm{Dek}$ und $\varphi(\omega) > 0\degree$).
...
\speech{05LogDarstellung7BandpassZweiterOrdnung}{1}{%
Hoch- und Tiefpass können auch kombiniert werden, um Bandpass- und Bandsperren-Filter zu realisieren.
Hier sehen Sie exemplarisch den Bode-Diagramm eines Bandpasses zweiter Ordnung,
der durch die Serienschaltung eines Tiefpasses und eines Hochpasses erster Ordnung realisiert wurde.
Wie im Schaltbild oben rechts zu sehen ist, sorgt ein Spannungsfolger zwischen beiden Filtern für Rückwirkungsfreiheit.
Dadurch kann der Gesamtfrequenzgang als Produkt der Einzelfrequenzgänge berechnet werden.
}% Ende speech
\silence{1}%
\speech{05LogDarstellung7BandpassZweiterOrdnung}{1}{%
Liegt die Grenzfrequenz des Hochpasses unterhalb der Grenzfrequenz des Tiefpasses, 
so wird der Bereich zwischen beiden Grenzfrequenzen durchgelassen, während Frequenz außerhalb dieses Frequenzbandes gesperrt werden.
Die Differenz der beiden Grenzfrequenzen definiert die Bandbreite des Filters und damit die Breite des durchgelassenen Frequenzbandes.
Die Mittenfrequenz liegt dabei im Bodediagramm exakt in der Mitte zwischen beiden Grenzfrequenzen.
Sie ist definiert als geometrisches Mittel der beiden Grenzfrequenzen, das heißt als Wurzel aus dem Produkt beider Grenzfrequenzen.
}% Ende speech
\silence{2}%
\speech{05LogDarstellung7BandpassZweiterOrdnung}{1}{%
Links im Bode Diagramm sind die Sperrbereiche und der Durchlassbereich markiert, sowie die im jeweiligen Sperrbereich dominierenden Filtertypen.
Eine Bandsperre kann im Prinzip durch eine Art Parallelschaltung von Tief- und Hochpass realisiert werden, wird hier jedoch nicht näher erläutert. 
Bei Bandsperren wird umgekehrt ein Frequenzband herausgefiltert, während Frequenzen außerhalb des Bandes durchgelassen werden.
}% Ende speech
\end{frame}
...
\speech{05LogDarstellung8BandpassAmplitudengangDetail}{1}{%
Sehen wir uns den Amplitudengang des Bandpasses im Detail an. Der Gesamt Amplitudengang entspricht genau der Überlagerung der Amplitudengänge von Tief- und Hochpass.
Im Durchlassbereich zwischen den beiden Grenzfrequenzen liegt der Amplitudengang nahezu konstant bei eins, also null Dezibel.
Außerhalb des Durchlassbereiches fällt der Amplitudengang mit einer Steigung von jeweils zwanzig Dezibel pro Dekade ab.
Die Ordnung des Filters bemisst sich an der summierten Steilheit der Flanken aller Sperrbereiche.
In diesem Fall ist das zwei mal zwanzig Dezibel pro Dekade, da es zwei Flanken gibt, was einer Gesamtsteilheit von vierzig Dezibel pro Dekade entspricht.
Da wir die Schaltung des Filters kennen, können wir die Ordnung auch daraus ableiten, dass der Bandpass aus zwei Filtern erster Ordnung besteht, also insgesamt zweiter Ordnung ist. 
}% Ende speech
\end{frame}
...
\speech{05LogDarstellung9BandpassPhasengangDetail}{1}{%
Beim Phasengang können wir gut die Überlagerung der Phasengänge von Tief- und Hochpassverhalten erkennen.
In der Mittenfrequenz heben sich die Phasenverschiebungen beider Filtertypen gegenseitig auf, sodass die Gesamtphasenverschiebung null Grad beträgt.
Im unteren Sperrbereich dominiert das Hochpassverhalten mit einer positiven Phasenverschiebung, während im oberen Sperrbereich das Tiefpassverhalten mit einer negativen Phasenverschiebung dominiert.
}% Ende speech
\end{frame}
}% Ende Beamer-only
...
\index{Ordnung, (Filter-)}%
    ...
    \fu{\includegraphics[alt={Amplitudengang verschiedener Tiefpassfilter höherer Ordnung im Vergleich in halblogarithmischer Darstellung. Die Filter unterscheiden sich in Welligkeit und Steilheit.}]{Tikz/pdf/plot_tiefpass_5_ord_amplitudengang_vergleich.pdf}}
    ...
    \begin{itemize}
    \item Tief-/Hochpass (eine Flanke): Ordnung $n$  bei $\pm\ n \cdot 20\mathrm{dB}/\mathrm{Dek}$
    \item Bandpass/-sperre (zwei Flanken): Ordnung $2n$ bei $\pm\ n \cdot 20\mathrm{dB}/\mathrm{Dek}$
    \end{itemize}
    ...
    \begin{Merksatz}{}
        %Die Ordnung entspricht der Steilheit aller Flanken summiert in $\pm\ 20\mathrm{dB}/\mathrm{Dek}$.
...
\speech{05LogDarstellung10HoehereOrdnung}{1}{%
In der Praxis gibt es eine Vielzahl von Filtern unterschiedlicher Bauart und Ordnung.
Hier sind exemplarisch einige Amplitudengänge von typischen Tiefpass Filtern höherer Ordnung dargestellt.
Wie zu erkennen ist, unterscheiden sich die gezeigten Filter wesentlich im Verlauf des Amplitudenganges.
Ein gleichmäßigerer Verlauf kann auf Kosten einer geringeren Steilheit im Sperrbereich einhergehen,
während eine steilere Flanke im Sperrbereich mit stärkeren Schwankungen im Durchlassbereich einhergehen kann. 
Die Wahl eines geeigneten Filters hängt stark von der jeweiligen Anwendung ab.
}% Ende speech
\end{frame}
