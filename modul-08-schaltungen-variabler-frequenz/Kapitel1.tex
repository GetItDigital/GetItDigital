...
\s{% Einleitung
    ...
    \begin{figure}[H]\centering
        \includegraphics[alt={Schaltsymbol eines Zweitors als Rechteck mit vier Polen. Spannung U1 am Eingang und U2 am Ausgang.}]{Tikz/pdf/circ_zweitor.pdf}
        \caption{Schaltsymbol eines Zweitors (Vierpols) mit Eingang (links) und Ausgang (rechts)\label{fig:zweitor}} % in Folien im folgenden Kapitel (Frequenzgang, Amplitudengang, Phasengang)
    \end{figure}
}%\s Ende
...
\newvideofile{FrequenzgangDefinitionenBspTiefpass}{Frequenzgang: Definitionen, Beispiel Tiefpass}
\v{% Video only Frame
\begin{frame}\ftx{\secname}
    \begin{Lernziele}{Video - Frequenzgang, Definitionen, Beispiel Tiefpass}
        Sie lernen in diesem Video:
        \begin{itemize}\b{\setlength\itemsep{0.7em}}
            \item{die Definition von Frequenzgang, Amplitudengang und Phasengang kennen,}% Wissen, Verständnis
            \item{Frequenzgänge anhand der Schaltungstopologie algebreaisch zu bestimmen,}% Anwendung
            \item{und die Funktionsweise und das Grenzverhalten einfacher Tiefpässe und Hochpässe zu bestimmen.}% Analyse
        \end{itemize}
    \end{Lernziele}
\speech{02Frequenzgang1Lernziele}{1}{%
Willkommen zum Video über den Frequenzgang, Amplitudengang und Phasengang.
Sie lernen in diesem Video die Definition und Bedeutung der Begriffe Frequenzgang, Amplitudengang und Phasengang kennen und verstehen.
Am Beispiel eines einfachen Tiefpassfilters lernen Sie den Frequenzgang anhand der Schaltungstopologie zu berechnen, 
dessen Funktionsweise zu verstehen und dessen Grenzverhalten zu analysieren. 
Gleiches wird für einen einfachen Hochpassfilter durchgeführt.
}% Ende speech
\end{frame}
...
\b{%
    ...
    \begin{minipage}[c][4cm][c]{0.48\textwidth}% left col
        \only<beamer:2| handout:0>{$\mathrlap{\textbf{Wie sieht das Übertragungsverhalten aus?}}$}%
        \onslide<beamer:3-| handout>{\textbf{Linear und zeitinvariant (LZI):}}
        \begin{itemize}
...
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{1}{%
Beginnen wir mit der Analyse des frequenzvariablen Verhaltens elektrischer Netze in Form von Zweitoren.
In der dargestellten Abbildung sehen wir das einfachste Beispiel eines Zweitors in einem elektrischen Netzwerk.
Im Netzwerk ist die Quelle links über das Zweitor in der Mitte mit der Last rechts verbunden.
}% Ende speech
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{2}{%
Wie sieht das Übertragungsverhalten des Zweitors aus? 
Wenn wir von Rückwirkungsfreiheit ausgehen, können wir das Zweitor als eigenständiges System betrachten, 
das eine Eingangsspannung U eins in eine Ausgangsspannung U zwei überträgt.
Bei der Analyse von Frequenzgängen untersuchen wir den Zusammenhang zwischen Ein- und Ausgangsspannung bei sinusförmiger Anregung im eingeschwungenen Zustand.
}% Ende speech
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{3}{%
Für unsere Anwendungsfälle gehen wir idealerweise immer von linearen und zeitinvarianten Systemen aus, kurz LZI-Systeme.
Diese bringen einige Eigenschaften mit sich, die wir uns nun anschauen wollen.
}% Ende speech
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{4}{%
Wird ein LZI-System mit einer sinusförmigen Spannung U 1 mit der Kreisfrequenz Omega angeregt,
wie in der Grafik rechts dargestellt ist, so erhalten wir im eingeschwungenen Zustand 
aufgrund der Linearität ebenfalls eine sinusförmige Spannung U 2 am Ausgang. 
}% Ende speech
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{5}{%
Die sinusförmige Ausgangsspannung hat dabei die gleiche Frequenz wie die Eingangsspannung. 
Die Ausgangsspannung kann sich jedoch sowohl in der Amplitude als auch in der Phase von der Eingangsspannung unterscheiden.
}% Ende speech
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{5}{%
Beim Analysieren von Zweitoren ist es daher interessant zu wissen, wie groß die Phasenverschiebung Delta Vieh zwischen Ein- und Ausgangsspannung ist und 
wie das Amplitudenverhältnis U zwei Dach durch U eins Dach aussieht.
}% Ende speech
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{6}{%
Die Phasenverschiebung und Amplitudenverhältnis sind dabei in der Regel frequenzabhängig, also Funktionen der Kreisfrequenz Omega, 
wie hier rechts im Diagramm für unterschiedliche Frequenzen dargestellt ist. Hier für Omega gleich K eins.
}% Ende speech
\silence{2}
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{7}{%
Hier für Omega gleich K zwei.
}% Ende speech Tonlose Slides für Quasi Animation durch Overlays.
\silence{2}
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{8}{%
Hier für eine weitere Kreisfrequenz.
}% Ende speech Tonlose Slides für Quasi Animation durch Overlays.
\silence{2}
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{9}{%
...
\end{columns}
\speech{02Frequenzgang3Definitionen}{1}{%
Kommen wir nun zu den Definitionen von Frequenzgang, Amplitudengang und Phasengang.
Beginnen wir mit dem Zweitor, dem Grundbaustein unserer Analyse.
Das Zweitor wird mit einer sinusförmigen Spannung U eins angeregt und befindet sich im eingeschwungenen Zustand.
}% Ende speech
\speech{02Frequenzgang3Definitionen}{2}{%
Das System sei linear und zeitinvariant. Das bedeutet, dass die Sinusform am Ausgang U zwei erhalten bleibt.
Die Ausgangsspannung kann sich jedoch in Amplitude und Phase von der Eingangsspannung unterscheiden.
Wie beschreiben wir nun die Änderung von Eingangs- zu Ausgangsspannung?
}% Ende speech
\speech{02Frequenzgang3Definitionen}{3}{%
Hier kommt der Frequenzgang ins Spiel. Der Frequenzgang F von J Omega beschreibt das Verhältnis der komplexen Ausgangsspannung U zwei zur komplexen Eingangsspannung U eins.
Der Frequenzgang kann auch in Polarkoordinaten durch den Amplitudengang und den Phasengang ausgedrückt werden.
}% Ende speech
\speech{02Frequenzgang3Definitionen}{4}{%
Der Amplitudengang A von Omega beschreibt den Betrag des Frequenzganges und damit das Amplitudenverhältnis zwischen Ausgangs- und Eingangsspannung.
}% Ende speech
\speech{02Frequenzgang3Definitionen}{5}{%
Der Phasengang Vieh von Omega beschreibt die Phase des Frequenzganges und damit die Phasendifferenz zwischen Ausgangs- und Eingangsspannung.
}% Ende speech
\end{frame}
...
\column{0.45\textwidth}% left col
    \s{\index{Filter>Tiefpass}%
        ...
        \fu{\includegraphics[alt={Schaltbild eines RC-Tiefpass-Filters 1. Ordnung. Spannung U1 über RC-Serienschaltung und Spannung U2 über C.}]{Tikz/pdf/circ_tiefpass_rc_annotated.pdf}}{Schaltbild, RC-Tiefpass 1. Ordnung\label{circ:filter:rctief}}%
...
\speech{02Frequenzgang4EinfacherTiefpass}{1}{%
Nehmen wir das hier dargestellte R C Serienglied als Beispiel eines Zweitors. 
Mit der Eingangsspannung über beiden Bauteilen und der Ausgangsspannung über der Kapazität handelt es sich um einen einfachen Tiefpass-Filter.
Der Name Tiefpass leitet sich von dem Verhalten her, dass Signale tiefer Frequenzen nahezu unverändert passieren, 
Signale hoher Frequenzen jedoch stark gedämpft werden.
}% Ende speech
\speech{02Frequenzgang4EinfacherTiefpass}{2}{%
Den Frequenzgang des Tiefpasses können wir mittels der komplexen Wechselstromrechnung bestimmen.
Durch Anwendung der komplexen Spannungsteilerregel und Vereinfachung erhalten wir die rechts dargestellte Gleichung für den Frequenzgang.
Das Spannungsverhältnis entspricht dem Verhältnis der Impedanz der Kapazität zur Summe der Impedanzen von Widerstand und Kapazität.
Durch Erweiterung mit J Omega C lässt sich der Bruch deutlich vereinfachen. 
Die kartesische Form am Ende erhalten wir durch Erweiterung des Bruches mit dem konjugiert komplexen Wert des Nenners. 
}% Ende speech
\speech{02Frequenzgang4EinfacherTiefpass}{3}{%
Für den Amplitudengang bietet sich die Form mit dem Nenner 1 plus J Omega C R an.
Der Gesamtbetrag entspricht dem Betrag des Zählers, hier eins, durch den Betrag des Nenners.
Für den Phasengang bietet sich die kartesische Form an, da hier Real- und Imaginärteil direkt abgelesen werden können.
Der Nenner hat als rein reelle Größe keinen Einfluss auf die Phasenlage.
}% Ende speech
\end{frame}
...
\s{
    ...
    Beide Graphen sind mit linearen Skalen dargestellt, wobei die Skalierungen beider x-Achsen für $\omega \left[\frac{1}{\mathrm{s}}\right]$ identisch sind. 
    ...
    \begin{figure}[h]\centering
        \begin{subfigure}{0.45\textwidth}\centering
            \includegraphics[alt={Darstellung des Amplitudengangs eines Tiefpass 1. Ordnung mit linearen Achsen. Der Verlauf von A(omega) beginnt bei 1 für omega=0 und fällt mit steigender Frequenz ab. Für hohe Frequenzen ist A(omega) leicht größer als null.}]{Tikz/pdf/plot_tiefpass_mini_ampli_lin_samesize.pdf}
            \caption{Amplitudengang $A(\omega)$, lineare Achsen}
            \label{plot:tiefpass:ampli:mini:lin}
        \end{subfigure}
        \begin{subfigure}{0.45\textwidth}\centering
        \includegraphics[alt={Darstellung des Phasengangs eines Tiefpass 1. Ordnung mit linearen Achsen. Der Verlauf von phi(omega) beginnt bei 0 Grad für omega=0 und fällt mit steigender Frequenz ab. Für hohe Frequenzen ist phi(omega) nahe -90 Grad.}]{Tikz/pdf/plot_tiefpass_mini_phase_lin_samesize.pdf}
...
%        \caption{Amplitudengang $A(\omega)$ und Phasengang $\varphi(\omega)$ eines Tiefpass 1. Ordnung, lineare Achsen}
    ...
    \fu{\includegraphics[alt={Darstellung des Funktionsgraphen 1/sqrt(1+x*x) über x. Für x deutlich kleiner als 1 nähert sich der Graph 1 an. Für x deutlich größer als 1 nähert sich der Graph der Kurve 1/x.}]{Tikz/pdf/plot_tiefpass_ampli_lin_approx.pdf}}{
    ...
    \fu{\includegraphics[alt={Darstellung der Tangensfunktion und deren Umkehrfunktion Arcustangens mit invertierten Achsen. Zusätzlich eingezeichnet sind die an der y-Achse gespiegelten Funktionen. Die überlagerten Funktionen formen ein symmetrisches Muster.}]{Tikz/pdf/plot_tan_atan_mirror.pdf}}{
...
\speech{02Frequenzgang5EinfacherTiefpassGrenzverhalten}{1}{%
Betrachten wir nun das Grenzverhalten des Tiefpasses für sehr niedrige und sehr hohe Frequenzen.
Dazu bestimmen wir die Grenzwerte des Amplitudengangs und des Phasengangs.
}% Ende speech
\speech{02Frequenzgang5EinfacherTiefpassGrenzverhalten}{2}{%
Für Omega gegen null, verschwindet der Term Omega C R im Nenner des Amplitudengangs.
Der Amplitudengang geht gegen eins, was bedeutet, dass der Tiefpass bei sehr niedrigen Frequenzen kaum dämpft.
Für Omega gegen unendlich wächst der Term Omega C R stark an.
Der Amplitudengang geht gegen null, was bedeutet, dass der Tiefpass bei sehr hohen Frequenzen stark dämpft.
}% Ende speech
\speech{02Frequenzgang5EinfacherTiefpassGrenzverhalten}{3}{%
Die gezeigten Grenzwerte lassen sich gut anhand des Schaltbildes erklären.
Bei einer Gleichspannung am Eingang sperrt die Kapazität, wodurch die gesamte Spannung am Ausgang anliegt.
Bei sehr hohen Frequenzen verhält sich die Kapazität wie ein Kurzschluss,
wodurch die Ausgangsspannung gegen null geht.
Als passives Zweitor, kann der gezeigte Tiefpass niemals verstärken, das heißt der Amplitudengang ist immer kleiner oder gleich eins.
}% Ende speech
\speech{02Frequenzgang5EinfacherTiefpassGrenzverhalten}{4}{%
Bei der Grenzwertbetrachtung des Phasenganges hilft es, die Form der Arkustangensfunktion zu kennen.
Für Omega gegen null geht der Phasengang gegen null Grad, was bedeutet, dass der Tiefpass bei sehr niedrigen Frequenzen kaum Phasenverschiebung aufweist.
Für Omega gegen unendlich geht der Phasengang gegen minus neunzig Grad, was bedeutet, dass der Tiefpass bei sehr hohen Frequenzen eine Phasenverschiebung bis minus neunzig Grad aufweist.
}% Ende speech
\speech{02Frequenzgang5EinfacherTiefpassGrenzverhalten}{5}{%
Hier sehen wir die grafische Darstellung des Amplituden- und Phasenganges in linearer Skalierung.
Da keine negativen Frequenzen existieren, beginnen beide Kurven bei null.
}% Ende speech
\end{frame}
...
\begin{frame}\ftx{\subsecname}
    \begin{columns}
        \column[T]{0.45\textwidth}% left col
            \s{\index{Filter>Hochpass}%
                ...
                \fu{\includegraphics[alt={Schaltbild eines RC-Hochpass-Filters 1. Ordnung. Spannung U1 über RC-Serienschaltung und Spannung U2 über R.}]{Tikz/pdf/circ_hochpass_rc_annotated.pdf}}{Schaltbild, RC-Hochpass 1. Ordnung\label{circ:filter:rchoch}}%
    ...
    \end{columns}
\speech{02Frequenzgang6EinfacherHochpass}{1}{%
Tauschen wir im RC-Tiefpass die Positionen von Widerstand und Kapazität,
so erhalten wir einen RC-Hochpass erster Ordnung wie im Schaltbild oben rechts dargestellt.
Der Hochpass lässt hohe Frequenzen nahezu ungedämpft passieren,
während niedrige Frequenzen stark gedämpft werden.
Den Frequenzgang des Hochpasses können wir genauso wie beim Tiefpass mittels der komplexen Wechselstromrechnung bestimmen.
Über den komplexen Spannungsteiler erhalten wir die rechts dargestellte Gleichung für den Frequenzgang.
Amplitudengang und Phasengang bestimmen wir durch Betragsbildung und Phasenberechnung des Frequenzganges.
}% Ende speech
\end{frame}
...
\s{%
    ...
    \begin{figure}[h]\centering
        \begin{subfigure}{0.45\textwidth}\centering
            \includegraphics[alt={Darstellung des Amplitudengangs eines Hochpass 1. Ordnung mit linearen Achsen. Der Verlauf von A(omega) beginnt bei 0 für omega=0 und steigt mit steigender Frequenz an. Für hohe Frequenzen nähert sich A(omega) 1.}]{Tikz/pdf/plot_hochpass_mini_ampli_lin_samesize.pdf}
            \caption{Amplitudengang $A(\omega)$, lineare Achsen}
            \label{plot:hochpass:ampli:mini:lin}
        \end{subfigure}
        \begin{subfigure}{0.45\textwidth}\centering
        \includegraphics[alt={Darstellung des Phasengangs eines Hochpass 1. Ordnung mit linearen Achsen. Der Verlauf von phi(omega) beginnt bei +90 Grad für omega=0 und fällt mit steigender Frequenz ab. Für hohe Frequenzen nähert sich phi(omega) 0 Grad.}]{Tikz/pdf/plot_hochpass_mini_phase_lin_samesize.pdf}
            \caption{Phasengang $\varphi(\omega)$, lineare Achsen}
...
\speech{02Frequenzgang7EinfacherHochpassGrenzverhalten}{1}{%
Untersuchen wir nun das Grenzverhalten des Hochpasses für sehr niedrige und sehr hohe Frequenzen.
Dazu bestimmen wir die Grenzwerte des Amplitudengangs und des Phasengangs.
Der Rechenweg ist analog zum Tiefpass, weshalb an dieser Stelle nur die Ergebnisse dargestellt werden.
Da bei niedrigen Frequenzen die Kapazität sperrt, fällt die gesamte Spannung über dieser ab.
Bei hohen Frequenzen verhält sich die Kapazität wie ein Kurzschluss, wodurch die gesamte Spannung über dem Widerstand abfällt.
Der Phasengang kann Werte zwischen null und plus neunzig Grad annehmen.
}% Ende speech
\end{frame}
    ...
    \resizeboxsb{1}{1}{% 90% textwidth skript, 100% textwidth beamer
        \begin{tabular}{|c|c l|c l|c|}
            ...
            \\\hline\parbox[c][2cm][c]{0.3cm}{\rotatebox[origin=c]{90}{\textbf{RL}}}
                &   \parbox[c][2cm][c]{3.0cm}{\resizebox{\linewidth}{!}{\includegraphics[alt={Schaltbild eines RL-Tiefpasses. U1 über RL-Serienschaltung und U2 über R.}]{Tikz/pdf/circ_tiefpass_rl_annotated.pdf}}} % resizebox breaks tikz without parbox around
                &   \parbox[c][2cm][c]{1.7cm}{$\dfrac{1}{1+\mathrm{j} \omega \frac{L}{R}}$}
                &   \parbox[c][2cm][c]{3.0cm}{\resizebox{\linewidth}{!}{\includegraphics[alt={Schaltbild eines RL-Hochpasses. U1 über RL-Serienschaltung und U2 über L.}]{Tikz/pdf/circ_hochpass_rl_annotated.pdf}}}
            ...
            \\\hline\parbox[c][2cm][c]{0.3cm}{\rotatebox[origin=c]{90}{\textbf{RC}}}
                &   \parbox[c][2cm][c]{3.0cm}{\resizebox{\linewidth}{!}{\includegraphics[alt={Schaltbild eines RC-Tiefpasses. U1 über RC-Serienschaltung und U2 über C.}]{Tikz/pdf/circ_tiefpass_rc_annotated.pdf}}}
                &   \parbox[c][2cm][c]{1.7cm}{$\dfrac{1}{1+\mathrm{j}\omega CR}$}
                &   \parbox[c][2cm][c]{3.0cm}{\resizebox{\linewidth}{!}{\includegraphics[alt={Schaltbild eines RC-Hochpasses. U1 über RC-Serienschaltung und U2 über R.}]{Tikz/pdf/circ_hochpass_rc_annotated.pdf}}}
...
\speech{02Frequenzgang8VergleichRLFilter}{1}{%
Das gleiche Filterverhalten wie bei R C Filtern lässt sich auch mit R L Filtern realisieren.
In der Tabelle sind die Schaltbilder und die zugehörigen Frequenzgänge von R L und R C Filtern erster Ordnung gegenübergestellt.
Die Filter unterscheiden sich lediglich in der Anordnung von L und R beziehungsweise R und C.
Wenn wir uns die Gleichungen der Frequenzgänge anschauen, stellen wir fest, dass sie sich nur im Faktor L durch R beziehungsweise C mal R vor Omega unterscheiden.
Dieser Faktor entspricht dem Kehrwert der Grenzkreisfrequenz Omega G, welche in der Tabelle rechts aufgeführt ist.
Die Grenzkreisfrequenz wird im Kapitel über logarithmische Darstellung des Frequenzganges noch näher erläutert.
Zur Übung können Sie die Herleitung der Frequenzgänge der R L Filter analog zu den R C Filtern durchführen.
}% Ende speech
\end{frame}
...
\newvideofile{FrequenzgangBspAufgabe}{Frequenzgang: Beispiel Aufgabe}% Aufgabenstellung statt Video-Lernziele
\begin{frame}\ftx{\subsecname}
...
\begin{minipage}{\textwidth}
    \begin{minipage}[c]{0.44\textwidth}% R2+(R1||C), u1 über gesamt, u2 über C
        \fu{\includegraphics[alt={Schaltbild einer passiven Filterschaltung mit zwei Widerständen und einer Kapazität. R2 in Reihe zur Parallelschaltung aus R1 und C. Spannung u1 über die gesamte Schaltung und Spannung u2 über C.}]{Tikz/pdf/circ_aufgabe_filter.pdf}}{Filterschaltung, passiv}% Schaltbild
        \b{\vfill}%
        \begin{align*}
...
\end{minipage}
\end{bsp}%
\speech{03Frequenzgang1BspAufgabenstellung}{1}{%
In diesem Video berechnen wir die folgende Beispiel Aufgabe zu einer passiven Filterschaltung.
Gegeben ist die links gezeigte Schaltung mit zwei Widerständen er eins und er zwei in Reihe und einer Kapazität C, die sich parallel an er eins anliegt. 
Die Eingangsspannung U eins liegt über der gesamten Schaltung an, während die Ausgangsspannung U zwei über der Kapazität C abgegriffen wird. 
Die Ein- und Ausgangsspannung sind sinusförmig mit gleicher Frequenz. 
Die Aufgabenstellung besteht aus drei Teilen.
In Teil A bestimmen wir den Frequenzgang F gleich U zwei komplex durch U eins komplex allgemein.
In Teil B skizzieren wir den Amplituden- und Phasengang des Frequenzganges für die angegebenen Bauteilwerte 
er eins gleich neunhundert Ohm, er zwei gleich einhundert Ohm und C gleich eins Komma zwei fünf Mikrofarad.
In Teil C berechnen wir die Frequenz, bei welcher die Ausgangsamplitude halb so groß ist wie die Eingangsamplitude.
Zudem bestimmen wir die Phasenverschiebung der Ausgangsspannung gegenüber der Eingangsspannung bei dieser Frequenz.
Pausieren Sie das Video, um die Aufgabe zu bearbeiten, bevor die Musterlösung präsentiert wird.
}% Ende speech
\end{frame}%
%
%-------------------------------------------------------------------------------------------------%
%
\begin{frame}[allowframebreaks]\ftx{\subsecname - Lösung}% EVIL: allowed (auto/manual) framebreaks (ermöglicht Beispielkasten im Skript auf einer A4-Seite und in Beamer auf vier Folien)
...
\textbf{Lösung b) Grenzverhalten und Skizze}
    ...
    \begin{minipage}{\textwidth}
        ...
        \end{minipage}\hfill
        \begin{minipage}[c][6cm][c]{0.48\textwidth}
            \resizeboxsb{0.75}{0.75}{% n % textwidth skript, m % textwidth beamer
            \includegraphics[alt={Amplitudengang in linearer Darstellung. Für omega 0 bis 1*10^5*1/s. A(0)=0.9. A(omega) gegen 0 für große Frequenzen.}]{Tikz/pdf/plot_beispiel_filter_amplitudengang_lin.pdf}%
            }% end resizeboxsb
            \hfill
            \resizeboxsb{0.75}{0.75}{% n % textwidth skript, m % textwidth beamer
            \includegraphics[alt={Phasengang in linearer Darstellung. Für omega 0 bis 1*10^5*1/s. Phase 0 bei omega 0 und gegen -90 Grad für große Frequenzen.}]{Tikz/pdf/plot_beispiel_filter_phasengang_lin.pdf}%
            }% end resizeboxsb
        \end{minipage}
    \end{minipage}
...
\textbf{Lösung c) Bestimmten Arbeitspunkt ermitteln}\vspace{+5pt}
    ...
    \begin{align*}%
        A(\omega_1) &= \frac{R_1}{\sqrt{(R_1+R_2)^2+(\omega_1 CR_1R_2)^2}} \overset{!}{=} \frac{1}{2} & 
        &\text{mit}&
...
\speech{03Frequenzgang2LoesungA1}{1}{%
Den Frequenzgang erhalten wir durch Anwendung der komplexen Spannungsteilerregel.
Die Ausgangsspannung liegt über dem Parallelzweig aus R eins und C.
Die Eingangsspannung liegt über der gesamten Schaltung, dass heißt über R zwei in Reihe mit dem Parallelzweig.
Die Impedanz der Kapazität Z C ist gleich eins durch j Omega C.
Durch Einsetzen in die Spannungsteilerformel und anschließendes Umformen erhalten wir die dargestellte Gleichung für den Frequenzgang.
Durch den Parallelzweig und den Spannungsteiler können sehr komplizierte Ausdrücke mit verschachtelten Brüchen entstehen.
Um den Bruch zu vereinfachen wird hier der Gesamtbruch mit dem Nenner der Parallelimpedanz erweitert.
Im nächsten Schritt wird mit J Omega C erweitert, um die Brüche im Zähler und Nenner zu beseitigen.
Der letzte Schritt ist die Umformung in die kartesische Form durch Erweiterung mit dem konjugiert komplexen Wert des Nenners.
}% Ende speech
\speech{03Frequenzgang3LoesungA2}{2}{%
Hier sind oben nochmal die letzten beiden Formen des Frequenzganges dargestellt.
Für den Amplitudengang bestimmen wir den Betrag des Frequenzganges. Für den Betrag bietet sich die erste Form an. 
Da der Zähler rein reell ist, müssen wir nur den Betrag des Nenners bilden.
Für den Phasengang bietet sich die kartesische Form an. Den Nenner können wir dann ignorieren, da er rein reell ist.
Der Phasengang ergibt sich somit aus dem Arkustangens des Verhältnisses von Imaginär- zu Realteil des Zählers.
Alternativ können wir den Phasengang auch aus der ersten Form des Frequenzganges bestimmen.
Der Phasengang entspricht dann der Differenz der Phase des Zählers minus der Phase des Nenners.
Da die Phase des Zählers null ist, vereinfacht sich die Gleichung zu minus Arkustangens 
von Klammer auf dem Imaginärteil des Nenners durch den Realteil des Nenners Klammer zu. 
}% Ende speech
\speech{03Frequenzgang4LoesungB}{3}{%
Für die Skizze in Aufgabenteil B hilft es zunächst das Grenzverhalten des Amplituden- und Phasenganges zu bestimmen.
Der Amplitudengang geht für sehr niedrige Frequenzen gegen den Spannungsteiler R eins durch R eins plus R zwei, da die Kapazität sich wie offene Klemmen verhält.
Für sehr hohe Frequenzen geht der Amplitudengang gegen null, da die Kapazität sich wie ein Kurzschluss verhält.
Der Phasengang geht für sehr niedrige Frequenzen gegen null Grad, für sehr hohe Frequenzen gegen minus neunzig Grad.
Die Skizzen des Amplituden- und Phasenganges sind rechts dargestellt.
Die Verläufe sind ähnlich wie bei einem Tiefpass erster Ordnung, jedoch mit einem anderen Anfangswert beziehungsweise Maximalwert für den Amplitudengang.
}% Ende speech
\speech{03Frequenzgang5LoesungC}{4}{%
In Aufgabenteil C soll die Frequenz bestimmt werden, bei der die Ausgangsamplitude halb so groß ist wie die Eingangsamplitude.
Dazu setzen wir den Amplitudengang von Omega eins gleich ein Halb und stellen nach Omega eins um.
Durch Kehrwertbildung und Quadrieren, können wir den Wurzelausdruck zunächst in den Zähler bringen und anschließend eliminieren.
Nach einigem Umformen erhalten wir einen Ausdruck wie Omega eins Quadrat ist gleich einer Konstante. 
Da die Kreisfrequenz positiv sein muss, wählen wir nur die positive Wurzel.
Die Frequenz F eins ergibt sich durch Teilen der Kreisfrequenz durch zwei Pi, mit dem Ergebnis von etwa zwei Komma eins eins sieben Kilohertz.
Anschließend können wir die Phasenverschiebung bei dieser Frequenz berechnen, indem wir Omega eins in die Gleichung für den Phasengang einsetzen.
Die Phasenverschiebung beträgt minus sechsundfünfzig Komma zwei fünf Grad. 
}% Ende speech
\end{frame}