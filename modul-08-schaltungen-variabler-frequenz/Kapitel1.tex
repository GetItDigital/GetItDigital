...
Wilkommen zum Video über den Frequenzgang, Amplitudengang und Phasengang.
...
Das Netzwerk sei gespeist von der Quelle links und über das Zweitor in der Mitte mit einer Last rechts verbunden.
}% Ende speech
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{2}{%
Wie sieht das Übertragungsverhalten des Zweitors aus? 
Wie wirkt es das Zweitor auf die Signale U 1 oder I 1 am Eingang im Vergleich zu den Signalen U 2 oder I 2 am Ausgang aus?
}% Ende speech
...
wie in der Grafik rechts dargestellt ist, so erhalten wir aufgrund der Linearität ebenfalls eine sinusförmige Spannung U 2 am Ausgang. 
}% Ende speech
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{5}{%
Die Sinusförmige Ausgangsspannung hat dabei die selbe Frequenz wie die Eingangsspannung, das heißt Omega zwei gleich Omega eins, kurz Omega. 
Die Spannung am Ausgang kann sich jedoch in der Amplitude und Phase von der Eingangsspannung unterscheiden.
}% Ende speech
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{5}{%
Beim Analysieren von Zweitoren ist es daher interessant zu wissen, wie groß die Phasenverschiebung Delta Phi zwischen Ein- und Ausgangsspannung ist und 
...
}% Ende speech Tonlose Slides für Quasi Animation durch Overlay
\silence{7}
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{7}{Omega gleich K zwei.}%
\silence{8}
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{8}{Omega gleich K drei.}%
\silence{9}
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{9}{Omega gleich K vier.}%
\silence{10}
\speech{02Frequenzgang2ZweitorUebertragungsverhalten}{10}{Omega gleich K fünf.}%
\end{frame}
...
Der Phasengang Phi von Omega beschreibt die Phase des Frequenzganges und damit die Phasendifferenz zwischen Ausgangs- und Eingangsspannung.
}% Ende speech
\end{frame}
...
Gegeben ist die links gezeigte Schaltung mit zwei Widerständen R eins und R zwei in Reihe und einer Kapazität C, die sich parallel an R eins anliegt. 
...
R eins gleich neunhundert Ohm, R zwei gleich einhundert Ohm und C gleich eins Komma zwei fünf Mikrofarad.
