...
\begin{frame}
	...
	\s{
	\index{Arbeit (elektrisches Feld)}
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.5\textwidth]{homogenfeld_w}\alttext{Parallele Metallplatten mit homogenem elektrischem Feld nach unten. Der Plattenabstand beträgt d, Zählrichtung von x ist von unten nach oben. Zwischen den Platten befindet sich eine positive Punktladung Q, deren Bewegung in Feldrichtung durch eine gestrichelte Bahn nach unten angedeutet ist.}
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.5\textwidth]{homogenfeld_elektr_arbeit}\alttext{Graph der Feldstärke E zwischen Platten: Für 0<x<d ist E von x konstant negativ, für x kleiner gleich 0 und x größer gleich d ist E von x = 0.}
...
$Q$ vom Ort $x$ der Probeladung linear abhängig ist (siehe Abbildung \ref{fig:zusammenhangEA}). Verfügt die Probeladung
 ...
 \begin{figure}[ht]
	\centering
	\includesvg[width=0.5\textwidth]{homogenfeld_elektr_arbeit2}\alttext{Diagramm mit zwei Kurven: Die rote Feldstärke E(x) ist für 0<x<d konstant negativ und sonst null. Die blaue potentielle Energie W(x) steigt innerhalb von 0<x<d linear mit an, erreicht bei x=d ein Maximum und bleibt für x größer als d konstant auf diesem Niveau.}
...
\begin{figure}[ht]
	\centering
	\includesvg[width=0.5\textwidth]{energieumwandlung}\alttext{Eine Balkenwaage zeigt links einen Block mit der Beschriftung „Kinetische Energie“ und rechts einen Block mit „Potentielle Energie“. Darunter deutet ein gebogener Pfeil vom elektrischen Feld zur Probeladung den Energieaustausch zwischen kinetischer und potentieller Energie an.}
...
Dazu wird die potentielle Energie auf ein Arbeitspotential normiert. 
 ...
 \end{equation*}
	...
	%	\caption{Probeladung $Q$ in einem elektrischen Homogenfeld $\vec{E}$}
		%\alttext{Parallele Metallplatten mit homogenem elektrischem Feld nach unten. Der Plattenabstand beträgt d, Zählrichtung von x ist von unten nach oben. Zwischen den Platten befindet sich eine positive Punktladung Q, deren Bewegung in Feldrichtung durch eine gestrichelte Bahn nach unten angedeutet ist.}
	...
	%	\caption{Probeladung $Q$ in einem elektrischen Homogenfeld $\vec{E}$}
		%\alttext{Diagramm mit zwei Kurven: Die rote Feldstärke E(x) ist für 0<x<d konstant negativ und sonst null. Die blaue potentielle Energie W(x) steigt innerhalb von 0<x<d linear mit an, erreicht bei x=d ein Maximum und bleibt für x größer als d konstant auf diesem Niveau.}
...
%\alttext{Eine Balkenwaage zeigt links einen Block mit der Beschriftung „Kinetische Energie“ und rechts einen Block mit „Potentielle Energie“. Darunter deutet ein gebogener Pfeil vom elektrischen Feld zur Probeladung den Energieaustausch zwischen kinetischer und potentieller Energie an.}
...
\begin{frame}
	...
	\label{eq:potential}
	 ...
	 \begin{figure}[ht]
		\centering
		\includesvg[width=0.5\textwidth]{potential_homogenfeld}\alttext{Darstellung eines homogenen elektrischen Feldes zwischen zwei parallelen Metallplatten. Rote Pfeile zeigen senkrecht nach unten und symbolisieren die Feldrichtung E. Zwischen den Platten befindet sich eine positive Punktladung Q, durch die eine grün gestrichelte horizontale Linie verläuft, die das elektrische Potential Phi kennzeichnet.}
	...
	\end{figure}
	 ...
	 \begin{figure}[ht]
		\centering
		\includesvg[width=0.5\textwidth]{homogenfeld_phi_graph}\alttext{Diagramm mit zwei Kurven: Die rote Feldstärke E(x) ist für 0<x<d konstant negativ und sonst null. Die grüne Kurve zeigt das Potential phi von x und steigt innerhalb von 0<x<d linear an, erreicht bei x=d ein Maximum und bleibt für x größer als d konstant auf diesem Niveau.}
	...
	\end{figure}
		...
		\begin{figure}[ht]
			...
			%\alttext{Diagramm mit zwei Kurven: Die rote Feldstärke E(x) ist für 0<x<d konstant negativ und sonst null. Die grüne Kurve zeigt das Potential phi von x und steigt innerhalb von 0<x<d linear an, erreicht bei x=d ein Maximum und bleibt für x größer als d konstant auf diesem Niveau.}
...
\begin{frame}
	...
	\s{
	\index{Äquipotentiallinie}
	\index{Quellenfeld (wirbelfrei)}
	Im homogenen elektrischen Feld ist das Potential $\varphi$ wie Formel \ref{eq:potential} zeigt
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.5\textwidth]{potentialdifferenz}\alttext{Darstellung eines homogenen elektrischen Feldes zwischen zwei parallelen Metallplatten mit roten Feldlinien nach unten. Eine positive Probeladung Q bewegt sich von der oberen Äquipotentiallinie Phi 1 zur unteren Äquipotentiallinie Phi 2. Die beiden Potentiallinien sind grün gestrichelt dargestellt.}
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.5\textwidth]{phi_diff_graph}\alttext{Diagramm des Potentialverlaufs Phi von x. Die grüne Kurve steigt linear zwischen den Punkten X 2 und d an und bleibt danach konstant. Die Potentialwerte Phi von x1 und Phi von d sind mit gestrichelten Hilfslinien markiert, die den linearen Zusammenhang zwischen Ort und Potential verdeutlichen.}
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.5\textwidth]{wirbelfrei}\alttext{Darstellung eines homogenen elektrischen Feldes zwischen zwei parallelen Metallplatten. Rote Feldlinien zeigen senkrecht nach unten. Vier Positionen positiver Punktladungen sind mit den Nummern 1 bis 4 markiert. Schwarze gestrichelte Pfeile deuten eine Bewegung von Punkt eins über zwei, drei und vier zurück zu eins an.}
		\caption{Darstellung des Potentialverlaufs $\varphi(x)$ innerhalb des elektrischen Homogenfeldes}
	...
	%\begin{figure}[h!]
		\begin{center}
		\includesvg[width=0.5\textwidth]{radialfeld}\alttext{Darstellung einer positiven Punktladung Q, von der radiale Feldlinien ausgehen. Rechts daneben befindet sich eine zweite positive Probeladung $Q_1$, die sich auf der Verbindungslinie in Richtung einer dritten Position r 1 bewegen kann. Die Abstände r 1 und r 2 sind entlang der Verbindungslinie markiert. Die roten Pfeile zeigen die Richtung der elektrischen Feldstärke E nach außen.}
		\end{center}
	%\end{figure}
	...
	\begin{columns}
      \column[c]{0.4\textwidth}
		...
		\begin{figure}[h!]
			...
			%\alttext{Diagramm des Potentialverlaufs Phi von x. Die grüne Kurve steigt linear zwischen den Punkten X 2 und d an und bleibt danach konstant. Die Potentialwerte Phi von x1 und Phi von d sind mit gestrichelten Hilfslinien markiert, die den linearen Zusammenhang zwischen Ort und Potential verdeutlichen.}
...
\begin{frame}
	...
	\begin{equation*}
	 ...
	 \begin{figure}[h!]
		\centering
		\includesvg[width=0.3\textwidth]{spannung}\alttext{Darstellung eines homogenen elektrischen Feldes mit gleichmäßig verlaufenden Feldlinien E, die von oben nach unten zeigen. Zwei positive Ladungen bewegen sich entlang der Feldlinien von der höheren Äquipotentiallinie phi 1 zur niedrigeren phi 2. Der Potentialunterschied zwischen den beiden Linien ist als Spannung U 1,2 gekennzeichnet.}
	...
	Die elektrische Spannung $U$ kann in einem wie in Abbildung \ref{fig:spannunghomogen} dargestellten Homogenfeld wie folgt berechnet werden,
	  ...
	  \begin{figure}[ht]
		\centering
		\includesvg[width=0.4\textwidth]{spannung_homogenfeld}\alttext{Mehrere rote Pfeile zwischen zwei grauen Platten zeigen gleichmäßig nach unten und stellen die Feldlinien E dar. Links ist die Spannung U mit einem Pfeil von der oberen zur uneteren Platte eingezeichnet, rechts der Plattenabstand d und sowie die Zählrichtung für x von unten nach oben.}
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.4\textwidth]{homogenfeld_spannung_graph}\alttext{Diagramm mit zwei Kurven: Die rote Linie zeigt zwischen 0 und d das konstante elektrische Feld E(x) entlang der x-Achse, davor und danach ist die Linie bei 0. Die blaue Linie zeigt den linear ansteigenden Verlauf der Spannung U von x. Markiert sind die Intervalle Delta x auf der x-Achse und Delta U auf der y-Achse, die den Zusammenhang zwischen Spannung und Feldstärke im Homogenfeld verdeutlichen.}
		\caption{Zusammenhang zwischen elektrischer Spannung $U(x)$ und elektrischem Homogenfeld $E(x)$.}
	...
	gleiche Richtung, dürfen die Vektorpfeile eliminiert werden, andernfalls muss das Skalarprodukt verwendet werden: 
		...
		\begin{figure}[ht]
			\centering
			\includesvg[width=0.5\textwidth]{skalarprodukt}\alttext{Zwei Vektoren, die von einem gemeinsamen Ursprung ausgehen: Der rote Pfeil stellt die elektrische Feldstärke E dar, der schwarze Pfeil das Wegstück d s. Zwischen beiden Pfeilen ist der Winkel alpha eingezeichnet.}
	...
	\begin{columns}
      \column[c]{0.65\textwidth}
		...
		\begin{figure}[ht]
			...
			%\alttext{Darstellung eines homogenen elektrischen Feldes mit gleichmäßig verlaufenden Feldlinien $\vec{E}$, die von oben nach unten zeigen. Zwei positive Ladungen bewegen sich entlang der Feldlinien von der höheren Äquipotentiallinie $\varphi_1$ zur niedrigeren $\varphi_2$. Der Potentialunterschied zwischen den beiden Linien ist als Spannung $U_{12}$ gekennzeichnet.}
		...
		%	\alttext{Mehrere rote Pfeile zwischen zwei grauen Platten zeigen gleichmäßig nach unten und stellen die Feldlinien E dar. Links ist die Spannung U mit einem Pfeil von der oberen zur uneteren Platte eingezeichnet, rechts der Plattenabstand d und sowie die Zählrichtung für x von unten nach oben.}
	...
	\phantom{text}\\
		...
		\begin{figure}[h!]
			...
			\includesvg[width=\textwidth]{homogenfeld_spannung_graph_folie}
					%\alttext{Diagramm mit zwei Kurven: Die rote Linie zeigt zwischen 0 und d das konstante elektrische Feld E(x) entlang der x-Achse, davor und danach ist die Linie bei 0. Die blaue Linie zeigt den linear ansteigenden Verlauf der Spannung U von x. Markiert sind die Intervalle Delta x auf der x-Achse und Delta U auf der y-Achse, die den Zusammenhang zwischen Spannung und Feldstärke im Homogenfeld verdeutlichen.}
...
\begin{frame}
	...
	%	\alttext{Zwei Vektoren, die von einem gemeinsamen Ursprung ausgehen: Der rote Pfeil stellt die elektrische Feldstärke E dar, der schwarze Pfeil das Wegstück d s. Zwischen beiden Pfeilen ist der Winkel alpha eingezeichnet.}
	\end{figure}
