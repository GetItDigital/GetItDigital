\subsection{Elektrisches Homogenfeld 3}
\Aufgabe{
    ...
    \newline
    $\left(E_{\mathrm{r}}(r)=\frac{U}{r\cdot\ln\left(\frac{a}{b}\right)};\ r_{\mathrm{a}}: \text{Außenradius}; r_{\mathrm{i}}: Radius \ des \ Innenzylinders\right)$
