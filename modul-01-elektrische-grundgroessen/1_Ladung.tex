...
\begin{frame}
	...
	\begin{figure}[ht!]
		...
		\s{\includesvg[width=0.8\textwidth]{atommodell_bohr}\alttext{Schematische Darstellung des Bohr’schen Atommodells. In der Mitte befindet sich der Atomkern, bestehend aus positiv geladenen Protonen und neutralen Neutronen. Um den Kern bewegen sich Elektronen auf unterschiedlichen, elliptisch dargestellten Bahnen, die die Elektronenhülle symbolisieren. Links oben ist eine Legende mit Symbolen für Elektron (blau, negativ geladen), Proton (rot, positiv geladen) und Neutron (grau, neutral) dargestellt. Beschriftungen kennzeichnen den Atomkern und die Elektronenhülle.}}
...
\s{	Die \textbf{Ladung} $Q$ eines Protons und eines Elektrons ist betragsmäßig gleich und wird als 
    ...
    \begin{columns}
		...
		\begin{figure}[ht]
			...
			\s{\includesvg[width=0.6\textwidth]{ionisierung}\alttext{Schematische Darstellung der Ionisation eines Atoms durch Energiezufuhr. Ein Energiepfeil zeigt auf ein neutrales Atom mit Atomkern und Elektronenhülle. Durch die zugeführte Energie löst sich eines der Elektronen und bewegt sich als freies Elektron weg. Zurück bleibt ein positiv geladenes Ion mit einem Elektron weniger in der Hülle.}}
		...
		\b{Freie Elektronen als kleinste, leichteste und beweglichste Ladungsträger bedeutsam!}
			...
			\index{Ladung}
			Durch Zufuhr von Energie oder durch Wechselwirkung mit anderen Teilchen (beispielsweise durch
...
\begin{frame}
	...
	\s{
	\index{Ladungsdichte}
	\index{Raumladungsdichte}
	\index{Flächenladungsdichte}
	\index{Linienladungsdichte}
	\index{Punktladung}
	Nicht nur die Anzahl, sondern auch die Verteilung der elektrischen Ladungsträger 
	...
	Die \textbf{Punktladung} dient als idealisiertes Modell einer Ladungsverteilung auf
	 ...
	 Die \textbf{Linienladungsdichte} $\lambda$ (lambda), angegeben in C/m, beschreibt die Verteilung der elektrischen
	  ...
	  \begin{figure}[ht]
		...
		\s{\includesvg[width=0.3\textwidth]{linienladung}\alttext{Darstellung einer Linienladungsdichte. Eine positive Ladung Q ist gleichmäßig auf einem eindimensionalen Pfad der Länge dl verteilt. Die Linie ist rot gezeichnet, mit einem Pluszeichen in der Mitte zur Kennzeichnung der Ladung.}}
	...
	\begin{figure}[ht]
		...
		\s{\includesvg[width=0.4\textwidth]{flächenladung}\alttext{Darstellung einer Flächenladungsdichte. Eine positive Ladung Q ist gleichmäßig auf einer roten, schräg dargestellten Fläche der Größe dA verteilt. In der Mitte der Fläche befindet sich ein Pluszeichen zur Kennzeichnung der positiven Ladung.}}
	...
	\begin{figure}[ht]
		...
		\s{\includesvg[width=0.4\textwidth]{raumladung}\alttext{Darstellung einer Raumladungsdichte. Eine positive Ladung Q ist gleichmäßig in einem roten, würfelförmigen Volumen der Größe dV verteilt. In der Mitte des Würfels befindet sich ein Pluszeichen zur Kennzeichnung der positiven Ladung.}}
	...
	\begin{columns}
		\column[c]{0.3\textwidth}
				...
				%alttext{Darstellung einer Linienladungsdichte. Eine positive Ladung Q ist gleichmäßig auf einem eindimensionalen Pfad der Länge dl verteilt. Die Linie ist rot gezeichnet, mit einem Pluszeichen in der Mitte zur Kennzeichnung der Ladung.}
	...
	\visible<2->{
		...
		%	\alttext{Darstellung einer Flächenladungsdichte. Eine positive Ladung Q ist gleichmäßig auf einer roten, schräg dargestellten Fläche der Größe dA verteilt. In der Mitte der Fläche befindet sich ein Pluszeichen zur Kennzeichnung der positiven Ladung.}
		...
		\rule{.1mm}{0.7\textheight}
		 ...
		 \begin{figure}[h!]
			...
			%\alttext{Darstellung einer Raumladungsdichte. Eine positive Ladung Q ist gleichmäßig in einem roten, würfelförmigen Volumen der Größe dV verteilt. In der Mitte des Würfels befindet sich ein Pluszeichen zur Kennzeichnung der positiven Ladung.}
		\end{figure}		
		 \begin{equation*}
...
\begin{frame}
	\ftb{Elektrische Leiter - Metalle}
		...
		\index{Metalle}
		\index{Elektronenmangel}
		\index{Elektronenüberschuss}
		Diese Aufteilung der Ladungsträger ist beispielsweise in Metallen gut zu sehen. 
		...
		Elektronen der Summe aller Protonen entspricht.
			...
			\begin{figure}[ht]
				...
				\s{\includesvg[width=0.4\textwidth]{metalle}\alttext{Darstellung eines Ausschnitts aus einem Metallblech. Mehrere rote Kreise mit Pluszeichen symbolisieren positiv geladene Atomkerne. Zwischen ihnen befinden sich kleine blaue Kreise mit Minuszeichen, die die frei beweglichen Elektronen darstellen. Eine Legende erklärt die Symbole für Atomkern und Elektron.}}
		...
		\begin{figure}[h!]
			...
			\s{\includesvg[width=0.7\textwidth]{leiter_ladung}\alttext{Zwei Darstellungen von Metallen im Vergleich. Links zeigt ein graues Metallstück mit roten positiven Atomkernen und zahlreichen blauen Elektronen mit Elektronenüberschuss. Rechts zeigt ein ähnliches Metallstück mit weniger Elektronen, also einen Elektronenmangel.}}
...
\begin{frame}
	\ftb{Das Coulombsche Gesetz}
		...
		\begin{figure}[h!]
			\centering
			\s{\includesvg[width=0.7\textwidth]{kraft}\alttext{Darstellung zweier positiver Punktladungen Q₁ und Q₂, die in einem Abstand r zueinander angeordnet sind. Zwischen ihnen sind zwei entgegengesetzt gerichtete Kraftpfeile eingezeichnet, die die abstoßende Coulomb-Kraft zwischen den gleichnamigen Ladungen symbolisieren.}}
		...
		\begin{figure}[h!]
			\centering
			\only<handout:0| beamer:1>{{\includesvg[width=0.7\textwidth]{kraft2}}}
			\only<handout:1| beamer:2-4>{{\includesvg[width=0.7\textwidth]{kraft}}}
			\label{fig:coulomb}
		%\alttext{Darstellung zweier positiver Punktladungen Q₁ und Q₂, die in einem Abstand r zueinander angeordnet sind. Zwischen ihnen sind zwei entgegengesetzt gerichtete Kraftpfeile eingezeichnet, die die abstoßende Coulomb-Kraft zwischen den gleichnamigen Ladungen symbolisieren.}
