...
\begin{frame}
	...
	\begin{figure}[h!]
		...
		\label{fig:efeld_def}
		\alttext{Darstellung der anziehenden Kraft zwischen einer positiven und einer negativen Punktladung. Oben befindet sich die positive Ladung Q2 mit einem nach unten gerichteten Kraftpfeil F2. Darunter liegt die negativ geladene Metallplatte mit der Ladung Q2.}
	\end{figure}
...
\begin{frame}
	...
	\begin{figure}[h!]
		...
		\alttext{In der linken Grafikseite zeigt das elektrische Feld eines negativ geladenen Leiters in Form von roten Pfeilen zum leiter hin. Rechts zeigt das elektrische Feld von einem positiv geladenen Leiter nach oben weg. In beiden Feldern befindet sich jeweils eine positive Probeladung Q.}
	\end{figure}
