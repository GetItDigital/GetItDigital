...
\begin{frame}
	...
	\s{
	\index{Elektrische Feldstärke}
	Wie gezeigt haben elektrische Ladungen einen direkten Einfluss auf andere Ladungen.
	...
	\begin{figure}[ht]
		...
		\includesvg[width=0.2\textwidth]{kraft_e}\alttext{Darstellung der anziehenden Kraft zwischen einer positiven und einer negativen Punktladung. Oben befindet sich die positive Ladung Q2 mit einem nach unten gerichteten Kraftpfeil F2. Darunter liegt die negativ geladene Metallplatte mit der Ladung Q2.}
...
\phantom{.}
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.2\textwidth]{definition_e}\alttext{Unterhalb einer gestrichelt angedeuteten aber nicht mehr existierenden Probeladung zeigt ein roter Pfeil nach unten auf die blaue negative Ladung Q2. Der Pfeil symbolisiert das elektrische Feld, das von Q2 ausgeht und unabhängig von einer Probeladung existiert.}
...
$ [E] =  \frac{\mathrm{N}}{\mathrm{C}} =  \frac{\mathrm{V}}{\mathrm{m}} $
		...
		\begin{columns}
			...
			\begin{figure}[h!]
				\centering
				\includesvg[width=1\textwidth]{kraft_e}%\alttext{Darstellung der anziehenden Kraft zwischen einer positiven und einer negativen Punktladung. Oben befindet sich die positive Ladung Q2 mit einem nach unten gerichteten Kraftpfeil F2. Darunter liegt die negativ geladene Metallplatte mit der Ladung Q2.}
			...
			\end{figure}
				...
				\begin{figure}[h!]
					...
					%\alttext{Unterhalb einer gestrichelt angedeuteten aber nicht mehr existierenden Probeladung zeigt ein roter Pfeil nach unten auf die blaue negative Ladung Q2. Der Pfeil symbolisiert das elektrische Feld, das von Q2 ausgeht und unabhängig von einer Probeladung existiert.}
				\end{figure}
...
\begin{frame}
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.5\textwidth]{leiter_pos_neg}\alttext{In der linken Grafikseite zeigt das elektrische Feld eines negativ geladenen Leiters in Form von roten Pfeilen zum leiter hin. Rechts zeigt das elektrische Feld von einem positiv geladenen Leiter nach oben weg. In beiden Feldern befindet sich jeweils eine positive Probeladung Q.}
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.5\textwidth]{Fehlvorstellung}\alttext{Zweiteilige Darstellung der Ladungs- und Feldlinienverteilung in einem Leiter. Links ist ein grauer Leiter mit blauen, freien Elektronen, wobei alle 
	außer einem Elektron an der Leiteroberfläche sitzen. Bei diesem führt eine Feldlinie in den Leiter hinein, wobei ein kleiner Pfeil von diesem Elektron in Richtung der Leiteroberfläche zeigt.
	Im rechten Bild ist die Feldlinie im Leiter verschweunden udn alle freien Elektronen befinden sich auf der Leiteroberfläche.}
	...
	Oberfläche von Leitern stehen müssen (siehe Abbildung \ref{fig:e_vertikal}). Eine schräg stehende Feldlinie ließe sich sonst vektoriell
	 ...
	 \begin{figure}[ht]
		\centering
		\includesvg[width=0.5\textwidth]{feldlinien_senkrecht}\alttext{Zweiteilige Darstellung des elektrischen Feldes an einer Leiteroberfläche. In der linken, durchgestrichenen Abbildung ist das elektrische Feld in eine horizontale Komponente E1 und eine vertikale Komponente E2 zerlegt, die zusammen das resultierende Feld E ges bilden. Rechts bleibt nach der Eliminierung der horizontalen Komponente nur die senkrecht zur Leiteroberfläche stehende Feldkomponente E ges bestehen.}
	...
	\begin{columns}
	   ...
	   \textbf{Feldlinien} beginnen und enden immer auf Ladungen (oft Leiteroberflächen).
		...
		\begin{figure}[h!]
			...
			%\alttext{Elektrisches Feld eines negativ geladenen Leiters in Form von roten Pfeilen zum Leiter, auf dessen Oberfläche sich blaue, negativ geladenen Ladungsträger befinden. Im Feld befindet sich eine rote Punktladung mit Plussymbol in der Mitte.}
		...
		%	geladenen Leiter auf eine positive Probeladung}
		%	\label{fig:leiter}
			%\alttext{Elektrisches Feld eines positiv geladenen Leiters in Form von roten Pfeilen vom Leiter weg, auf dessen Oberfläche sich rote, positiv geladenen Ladungsträger befinden. Im Feld befindet sich eine rote Punktladung mit Plussymbol in der Mitte.}
		\end{figure}   
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}[h!]
			...
			%\alttext{Zweiteilige Darstellung der Ladungs- und Feldlinienverteilung in einem Leiter. Links ist ein grauer Leiter mit blauen, freien Elektronen, wobei alle 
	%außer einem Elektron an der Leiteroberfläche sitzen. Bei diesem führt eine Feldlinie in den Leiter hinein, wobei ein kleiner Pfeil von diesem Elektron in Richtung der Leiteroberfläche zeigt.
	%Im rechten Bild ist die Feldlinie im Leiter verschweunden udn alle freien Elektronen befinden sich auf der Leiteroberfläche.}
		\end{figure}
...
%\alttext{Zweiteilige Darstellung des elektrischen Feldes an einer Leiteroberfläche. In der linken, durchgestrichenen Abbildung ist das elektrische Feld in eine horizontale Komponente E1 und eine vertikale Komponente E2 zerlegt, die zusammen das resultierende Feld E ges bilden. Rechts bleibt nach der Eliminierung der horizontalen Komponente nur die senkrecht zur Leiteroberfläche stehende Feldkomponente E ges bestehen.}
		\end{figure}
	\end{columns}
...
\begin{frame}
	...
	\index{Homogenfeld}
	\index{Radialfeld}	
	Das einfachste elektrische Feld ist das \textbf{Homogenfeld}. In diesem Feld sind sowohl
	 ...
	 Erzeugen lässt sich ein solches Feld wie in Abbildung \ref{fig:homogenfeld} dargestellt beispielsweise zwischen zwei  parallelen Metallplatten, welche
	  ...
	  \begin{figure}[ht]
		\centering
		\includesvg[width=0.3\textwidth]{elektr_homogenfeld}\alttext{Darstellung eines homogenen elektrischen Feldes zwischen zwei parallelen Metallplatten. Die obere Platte ist positiv geladen und mit roten Pluszeichen markiert, die untere Platte negativ geladen und mit blauen Minuszeichen dargestellt. Gleichmäßig verlaufende rote Feldlinien zeigen senkrecht von der positiven zur negativen Platte.}
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.26\textwidth]{feld_Punktladung}\alttext{Darstellung des radialen elektrischen Feldes einer positiven Punktladung. In der Mitte befindet sich eine rote Kugel mit Pluszeichen. Von ihr gehen mehrere rote Pfeile gleichmäßig in alle Richtungen nach außen, die die Feldlinien des elektrischen Feldes symbolisieren.}
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.44\textwidth]{feldlinien}\alttext{Eine rote positive Punktladung mit Pluszeichen befindet sich oberhalb einer blauen negativen Punktladung mit Minuszeichen. Rote Feldlinien verlaufen von der positiven zur negativen Ladung und bilden charakteristische gekrümmte Bahnen, die zwischen den beiden Ladungen näher sind, während sie außen weiter voneinander entfernt sind.}
	...
	\begin{figure}[ht]
		\centering
		\includesvg[width=0.4\textwidth]{feldlinien_protonen}\alttext{Zwei rote Kugeln mit Pluszeichen befinden sich nebeneinander, aus beiden gehen rote Feldlinien radial nach außen. Zwischen den Ladungen verlaufen die Feldlinien gekrümmt, sodass sie sich gegenseitig abstoßen. Genau zwischen beiden sind keien Feldlinien abgebildet.}
...
%
	...
	\end{figure}
		...
		\begin{figure}[h!]
			...
			%\alttext{Darstellung des radialen elektrischen Feldes einer positiven Punktladung. In der Mitte befindet sich eine rote Kugel mit Pluszeichen. Von ihr gehen mehrere rote Pfeile gleichmäßig in alle Richtungen nach außen, die die Feldlinien des elektrischen Feldes symbolisieren.}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}[h!]
			...
			%\alttext{Eine rote positive Punktladung mit Pluszeichen befindet sich oberhalb einer blauen negativen Punktladung mit Minuszeichen. Rote Feldlinien verlaufen von der positiven zur negativen Ladung und bilden charakteristische gekrümmte Bahnen, die zwischen den beiden Ladungen näher sind, während sie außen weiter voneinander entfernt sind.}
		...
		\begin{figure}[h!]
			...
			%\alttext{Zwei rote Kugeln mit Pluszeichen befinden sich nebeneinander, aus beiden gehen rote Feldlinien radial nach außen. Zwischen den Ladungen verlaufen die Feldlinien gekrümmt, sodass sie sich gegenseitig abstoßen. Genau zwischen beiden sind keien Feldlinien abgebildet.}
