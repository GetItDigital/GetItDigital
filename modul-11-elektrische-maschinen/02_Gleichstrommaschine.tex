...
\begin{frame} \ftx{Elektrische Maschinen}
	...
	\end{eq}
	\speech{GleichstrommaschinePrinzip}{1}{Die grundlegenden Prinzipien, die hinter der Funktion einer Gleichstrommaschine stecken, wurden im Modul sechs bereits vorgestellt.}
\end{frame}
...
\begin{frame} \ftx{Rotor und Kommutator}
	\s{
		In der Abbildung \ref{FotoRotor} sind die Komponenten des Rotors gut ersichtlich. Im Allgemeinen wird der Rotor auch Anker oder als Läufer bezeichnet. Die Funktion des Rotors besteht dahin die elektromagnetische Energie durch Rotationen um die eigene Achse in mechanische Energie (und umgekehrt) zu wandeln.
