...
\begin{frame} \ftx{Elektrische Maschinen}
	...
	\fu{
		\begin{minipage}{0.25\textwidth}
			\foo{width=0.9\textwidth, alt={XX}}{width=0.9\textwidth}{Lorentzkraft_Feldverlaeufe5}{
		...
		\hfill
		\begin{minipage}{0.25\textwidth}
			\foo{width=0.9\textwidth, alt={XX}}{width=0.9\textwidth}{Lorentzkraft_Feldverlaeufe6}{
		...
		\hfill
		\begin{minipage}{0.25\textwidth}
			\foo{width=0.9\textwidth, alt={XX}}{width=0.9\textwidth}{Lorentzkraft_Feldverlaeufe7}{
				\put(85, 78){\color{magnetfeld}N}
				\put(85, 15){\color{magnetfeld}S}
...
\begin{frame}\ftx{Aufbau}
	...
	\fo{width=0.6\textwidth, alt={XX}}{height=0.85\textheight}{gleichstrommaschine1}{
...
\begin{frame}\ftx{Aufbau}
	\fo{width=0.8\textwidth, alt={XX}}{height=0.85\textheight}{Aufbau1}{
...
\begin{frame} \ftx{Rotor und Kommutator}
	...
	\fo{width=0.8\textwidth, alt={XX}}{width=0.75\textwidth}{Rotor_Gleichstrommaschine_kl}{
...
\begin{frame}\ftx{Erregerfeld}
	...
	\fo{width=0.6\textwidth, alt={XX}}{height=0.85\textheight}{Erregerfeld}{
