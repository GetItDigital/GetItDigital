...
\begin{frame}\fta{Der Transformator}
	...
	\begin{columns}
		...
		\f{width=\textwidth, alt={Ein großer, rechteckiger Leistungstransformator in grauer Farbe steht in einer Freiluftanlage. Er hat mehrere Hochspannungsleitungen, die nach oben führen, und ist auf einer betonierten Fläche platziert.}}{width=\textwidth}{20120329Umspannwerk_Altlussheim06.jpg}{{\bf Ein 40 MVA Leistungstransformator.} Aufgenommen im Umspannwerk Altlußheim. \label{bildtrafo1}{\tiny(Quelle: Wikimedia, Lizenz CC0)}}
		\column[c]{0.4\textwidth}
		\f{width=0.4\textwidth, alt={Ein quadratischer Kleintransformator mit einem schwarzen Gehäuse und zwei Spulen. Der Transformator hat an den Seiten mehrere Kontaktstifte.}}{width=0.7\textwidth}{Transformator2b.png}{{\bf Fotografie eines Kleintransformators.} \label{bildtrafo2}}
	\end{columns}
	\b{
		\vspace{0.5cm}
		\begin{itemize}
