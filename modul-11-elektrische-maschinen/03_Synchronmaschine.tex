...
\v{
	\begin{frame}{Lernziele}
		\begin{Lernziele}{Synchronmaschine}
			...
			\end{itemize}
		\end{Lernziele}
		\speech{LernzieleSynchronmaschine}{1}{In diesem Kapietel betrachten wir eine weitere, für viele Zwecke eingesetzte, elektrische Maschine: Die Synchronmaschine. Dabei gehen wir auf den Aufbau und die Vor- und Nachteile dierser elektrischen Maschine ein. Wir werfen eine Blick auf das Statorfeld, das aus drei Phasen besteht und letztlich den Rotor in Bewegung versetzt. Außerdem thematisieren wir dabei den Zusammenhang aus dem Polradwinkel und dem Drehmoment einer Synchronmaschine.}
		\silence{2}
	\end{frame}
}
...
\begin{frame}
	...
	\end{itemize}
	\speech{SynchronmaschineVorNachteile}{1}{Die Synchronmaschine dreht netzsynchron mit konstanter Drehzahl. Daher ihr Name. Sehen wir uns nun zunächst die Vor- und Nachteile einer Synchronmaschine an. Die Vorteile liegen insbesondere in der Robusten Bauweise, weswegen sie sehr wartungsarm ist. Sie hat eine Hohe Regeldynamik, was bedeutet, dass sie schnell und genau auf Last- oder Sollwertänderungen reagiert und Frequenz sowie Drehmoment stabil hält. Sie hat bei einer kleinen Baugröße eine hohe Leistungsdichte und ist zudem Überlastfähig, was bedeutet, dass sie kurzfristig über ihrem Nennstrom oder ihrer Nennleistung hinaus betrieben werden kann, um etwa Spitzenlasten zu decken, und das ohne Schaden zu nehmen.}
	\silence{2}
	\speech{SynchronmaschineVorNachteile}{2}{Die Nachteile de Synchronmaschine liegen vor allem in der dafür notwendigen, aufwändeigen Regeltechnik. Der Betrieb erfordert komplexe und teure Leistungselektronik, also Umrichter, um Frequenz und Spannung passend bereitzustellen. Zudem ist die Regelung der Maschine anspruchsvoll, weil Drehzahl, Erregung und Last synchron abgestimmt und dynamisch geregelt werden müssen. Außerdem ist ein gezielt steuerbarer Betrieb, zum Beispiel schnelle Drehzahl- oder Drehmoment-änderungen nur mit hohem technischem Aufwand oder gar nicht praktikabel, sodass flexible, einfache Regelstrategien – wie bei einer Asynchronmaschine, die wir im späteren Kapitel betrachten werden – schwer umzusetzen sind.}
	\silence{2}
\end{frame}
...
\begin{frame}\ftx{Drehmoment}
	...
	\speech{SynchronmaschineDrehmoment}{1}{Bei der Synchronmaschine bewirkt die magnetische Kopplung zwischen Stator und Rotor das Drehmoment. Im Motorbetrieb folgt das Rotorfeld dem Statorfeld. Die mechanische Drehzahl muss daher immer gleich der elektrischen Drehfrequenz sein. Zwischen dem Stator und dem Rotor befindet sich der lastabhängige sogenannte Pohlrad-winkel Theta. Bei Theta gleich 90 Grad ist das Drehmoment am größten. Wird im Motorbetrieb der Pohlrad-winkel durch eine zu hohe Belastung größer als 90 Grad, sinkt das erzeugte Drehmoment und die Maschine kippt. Das heißt, sie bleibt schlagartig stehen.}
	\silence{2}
\end{frame}
