...
\begin{frame}
	...
	\begin{columns}
		...
		\s{
			\fo{width=0.7\textwidth, alt={XX}}{}{Aufbau_Synchronmaschine1}{
...
\begin{frame} \ftx{Aufbau einer fremderregten Synchronmaschine}
	\s{
		\fo{width=0.8\textwidth, alt={XX}}{}{Aufbau_Synchronmaschine2}{
...
\begin{frame}\ftb{Feldverläufe}
	\s{
		\fo{width=\textwidth, alt={XX}}{}{Synchronmaschine_Feldverlaeufe}{
