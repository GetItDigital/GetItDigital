    ...
    \begin{itemize}
        ...
        \item[\bf a)]
              ...
              \resizebox{0.7\textwidth}{!}{%
                  \input{Tikz/src/Aufgaben/Loesung_Drehstrom2_a1}\alttext{Das Bild zeigt ein Schaltbild zur Analyse einer Drehstromschaltung mit 230-Volt-Quellen. Es ist eine Sternschaltung mit Impedanzen von 10 Ohm und unbekannten Strömen und Spannungen dargestellt. }
              }
              
              \input{Tikz/src/Aufgaben/Loesung_Drehstrom2_a2}\alttext{Das Bild zeigt ein Schaltbild zur Analyse einer Drehstromschaltung mit 230-Volt-Quellen. Es wird das vereinfachte Ersatzschaltbild eines einzelnen Strangs gezeigt. }
              
              ESBs der Dreieckschaltung:\\
              
              \resizebox{0.7\textwidth}{!}{%
                  \input{Tikz/src/Aufgaben/Loesung_Drehstrom2_a3}\alttext{Das Bild zeigt ein Schaltbild zur Analyse einer Drehstromschaltung mit 230-Volt-Quellen. Es ist eine Dreieckschaltung mit Impedanzen von 10 Ohm und unbekannten Strömen und Spannungen dargestellt.}
              }
              
              \input{Tikz/src/Aufgaben/Loesung_Drehstrom2_a4}\alttext{Das Bild zeigt ein Schaltbild zur Analyse einer Drehstromschaltung mit 230-Volt-Quellen. Es wird das vereinfachte Ersatzschaltbild eines einzelnen Strangs gezeigt, wobei die Lastimpedanzen angepasst dargestellt sind.}
        ...
        \item[\bf d)]
              ...
              \begin{figure}
                  ...
                  \resizebox{0.6\textwidth}{!}{%
                      \input{Tikz/src/Aufgaben/Loesung_Drehstrom2_d_Zeigerfiagramm}\alttext{Das Bild zeigt ein Zeigerdiagramm eines Drehstromsystems mit Leiter- und Außenleiterspannungen. Von einem gemeinsamen Ursprung gehen mehrere Spannungszeiger aus, darunter U_L1, U_L2 und U_L3 sowie die zugehörigen Außenleiterspannungen wie U_L1L2, U_L2L3 und U_L3L1. Zusätzlich sind einige Spannungen mit umgekehrter Richtung gekennzeichnet, zum Beispiel −U_L2 und −U_L3. Die Grafik veranschaulicht die geometrischen Beziehungen der Spannungen im Drehstromnetz.}
                  }
              \end{figure}
