...
\newvideofile{Drehstrom1}{Drehstrom 1}
...
\begin{frame}
    ...
    \begin{Lernziele}{Drehstrom}
        ...
        \begin{itemize}
            ...
            \item können Drehstromsysteme mit gleicher Belastung analysieren.
            \item kennen die Gegebenheiten von Drehstromsystemen mit unterschiedlicher Phasenbelastung.
        \end{itemize}
    \end{Lernziele}
...
\begin{frame}
    ...
    \s{\index{Symmetrische Komponenten}
    ...
    \s{
        \fu{
            ...
            \resizebox{0.8\textwidth}{!}{
                \input{Tikz/src/Drehstrom/Drei_Phasen_Drehstrom}\alttext{Das Bild zeigt links drei sinusförmige Spannungen u₁(t), u₂(t) und u₃(t), die zeitlich um jeweils 120 Grad phasenverschoben sind. Die Kurven sind farblich unterschieden und verlaufen periodisch über der Zeit t. Rechts ist ein Zeigerdiagramm mit drei Spannungszeigern dargestellt, die ebenfalls um den Winkel α versetzt sind. Die Grafik veranschaulicht den Zusammenhang zwischen zeitlichen Verläufen und Zeigerdarstellung eines Drehstromsystems.}
            }
...
\begin{frame}
    \ftx{Drehoperator}\index{Drehoperator}
...
\begin{frame}
    ...
    \fu{
        \resizebox{0.8\textwidth}{!}{%
            \input{Tikz/src/Drehstrom/Zeigerdiagramm_Drehstromoperator}\alttext{Das Bild zeigt links drei komplexe Zeiger im Einheitskreis, die um 120 Grad gegeneinander versetzt sind. Die Zeiger sind mit a, a² und a³ = 1 beschriftet, wobei der Winkel α = 2π/3 beträgt. Rechts sind diese drei Zeiger zu einem gleichseitigen Dreieck verbunden dargestellt.}
        }
...
\begin{frame}
    ...
    \fu{
        \resizebox{0.8\textwidth}{!}{%
            \input{Tikz/src/Drehstrom/ESB_Drehstromsystem}\alttext{Das Bild zeigt eine Drehstromschaltung mit drei Außenleitern und einem Neutralleiter. Links sind die drei Spannungsquellen der Phasen dargestellt, rechts die zugehörigen Lastimpedanzen Z_L1, Z_L2 und Z_L3 sowie die Neutralimpedanz Z_N. Die Leiterströme I_L1, I_L2 und I_L3 sowie der Neutralstrom I_N sind eingezeichnet. Zusätzlich sind die Leiter- und Außenleiterspannungen zwischen den Phasen markiert.}
        }
...
\begin{frame}
    ...
    Der Strom im Neutralleiter ergibt sich aus dem 1. Kirchhoffschen Gesetzt:
    \begin{eqa}
        \underline{I}_{\mathrm{N}}=\underline{I}_{\mathrm{L1}}+\underline{I}_{\mathrm{L2}}+\underline{I}_{\mathrm{L3}}
    \end{eqa}

    \onslide<2->{
    Umgestellt nach dem Ohmschen Gesetz:
    \begin{eqa}
    ...
    \s{
        \textbf{Ströme}
        \index{Sternstrom}\index{Außenleiterstrom}
...
\begin{frame}
    ...
    \fu{
        \resizebox{0.9\textwidth}{!}{%
            \input{Tikz/src/Drehstrom/Dreisphasiges_ESB}\alttext{Das Bild zeigt eine symmetrische Drehstromschaltung mit drei identischen Lastimpedanzen Z. Links sind drei um 120 Grad phasenverschobene Spannungsquellen dargestellt. In allen drei Leitern fließt derselbe Strom I. Eingezeichnet sind die Leiter- und Außenleiterspannungen zwischen den Phasen sowie die Neutralpunkte N_Q und N_V.}
        }
...
\begin{frame}
    ...
    \fu{
        \input{Tikz/src/Drehstrom/Einphasiges_ESB}\alttext{Das Bild zeigt einen einfachen einphasigen Wechselstromkreis. Eine Spannungsquelle mit der Spannung Uᵧ speist eine Lastimpedanz Zᵧ. Durch den geschlossenen Stromkreis fließt ein Strom I in Pfeilrichtung. Die Darstellung veranschaulicht das Ersatzschaltbild eines einzelnen Strangs.}
...
\begin{frame}
    ...
    \resizebox{0.35\textwidth}{!}{%
        \input{Tikz/src/Drehstrom/Zeigerdiagramm_Herleitung_Stern_Dreieck}\alttext{Das Bild zeigt ein Zeigerdiagramm eines Drehstromsystems. Drei Spannungszeiger der Leiter U_L1, U_L2 und U_L3 sind um den Winkel α gegeneinander versetzt dargestellt. Zusätzlich ist die Außenleiterspannung U_L1L2 als Differenz zweier Leiterzeiger eingezeichnet. Die Grafik veranschaulicht die geometrische Beziehung zwischen Leiter- und Außenleiterspannungen.}
    }
...
\begin{frame}
    ...
    \fu{\resizebox{\textwidth}{!}{%
            \input{Tikz/src/Drehstrom/Stern-Dreieck_dreiphasiges_ESB}\alttext{Das Bild zeigt eine Drehstromschaltung mit Stern-Dreieck-Zusammenhang. Links sind drei gleich große Strangspannungen U_Y mit zugehörigen Strömen I_Y dargestellt. Rechts ist eine dreieckförmig verschaltete Last mit den Impedanzen Z_L1L2, Z_L2L3 und Z_L3L1 eingezeichnet. Die Außenleiterspannungen U_Δ und die zugehörigen Ströme in den Dreieckszweigen sind markiert.}
        }
...
\begin{frame}
    ...
    \onslide<2->{
    \fu{
        \input{Tikz/src/Drehstrom/Stern-Dreieck_einphasiges_ESB}\alttext{Das Bild zeigt einen einfachen Wechselstromkreis mit einer Spannungsquelle Uᵧ und einer angeschlossenen Lastimpedanz Z_Δ ⁄ 3. Der Strom I fließt im geschlossenen Kreis von der Quelle zur Last. Die Darstellung veranschaulicht ein Ersatzschaltbild für eine Stern-Dreieckschaltung.}
...
\newvideofile{Drehstrom2}{Drehstrom 2}

\v{
\begin{frame}
	\ftx{Drehstrom 2}

    \begin{Lernziele}{Drehstrom 2}
        Die Studierenden
        \begin{enumerate}
            \item kennen die Gegebenheiten von Drehstromsystemen mit unterschiedlicher Phasenbelastung.
        \end{enumerate}
    ...
    \speech{DrehLrnz2}{1}{Nachdem die Grundlagen von Drehstromsystemen und eine gleichmäßige Belastung erklärt wurden,
    werden nun Drehstromsysteme bei ungleichmäßiger Belastung besprochen.}
\end{frame}}


\begin{frame}
    \ftb{Unsymmetrische Belastung}
...
\begin{frame}
    ...
    \fu{
        \input{Tikz/src/Drehstrom/Stern_Dreieck_vereinfachtes_ESB}\alttext{Das Bild zeigt eine unsymmetrische Drehstrom-Sternschaltung mit drei Leitern L1, L2 und L3. Jeder Leiter ist mit einer eigenen Lastimpedanz Z1, Z2 und Z3 verbunden. Die Leiterströme IL1, IL2 und IL3 sowie die zugehörigen Strangspannungen UL1, UL2 und UL3 sind eingezeichnet.}
