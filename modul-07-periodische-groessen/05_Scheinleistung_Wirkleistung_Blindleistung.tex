...
\begin{frame}
    ...
    \speech{LeistungAugenblick}{2}{Die Zeitabhängigen Größen sind die Spannung Uh von Tee und Ih von Tee in der angegebenen Form.}
    \speech{LeistungAugenblick}{3}{Die Augenblicksleistung kann über Produkt für jeden Zeitpunkt Tee berechnet werden.
    Über das zum Anfang vorgestellte Additionsteorem lässt sich die Augenblicksleistung für Sinusförmige Wechselgrößen bestimmen.
    Hierbei lassen sich die Trigonometrischen Funktionen in einen konstanen Anteil und einen zeitabhnängigen Anteil
...
\begin{frame}
    ...
    \speech{LeistungMrk1}{1}{Die Augenblicksleistung P von Tee ist das Produkt aus den Augenlickswerten der Spannung Uh von Tee und des Stromes Ih von Tee. }
\end{frame}
...
\begin{frame}
    ...
    \speech{LeistungMittlKapa}{1}{Auch bei einer Kapazität ist liegt eine Phasenverschiebung zwischen dem Strom und der Spannung vor.
...
\begin{frame}
    ...
    \speech{LeistungBlind}{1}{}
    \speech{LeistungBlind}{2}{}
    \speech{LeistungBlind}{3}{}
    \speech{LeistungBlind}{4}{}
\end{frame}
...
\begin{frame}
    ...
    \speech{LeistungSchein}{1}{Scheinleistung erklärung
    Setzt sich aus beiden Leistungsarten zusammen.
    An einem idealen Widerstand entspricht die Scheinleistung der Wirkleistung am Widerstand.}
    \speech{LeistungSchein}{2}{}
    \speech{LeistungSchein}{3}{}
\end{frame}
...
\begin{frame}
    ...
    \speech{LeistungArten}{1}{}
    \speech{LeistungArten}{2}{}
\end{frame}
