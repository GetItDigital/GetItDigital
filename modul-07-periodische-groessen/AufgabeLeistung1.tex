...
\Aufgabe{
    ...
    \begin{figure}[H]
        ...
        \resizebox{0.7\textwidth}{!}{
            \input{Tikz/src/Aufgaben/Leistungsberechnung1}\alttext{Das Bild zeigt zwei sinusförmige Zeitverläufe über der Zeit t in Millisekunden. Die Spannung u(t) ist als blaue Kurve dargestellt, der Strom i(t) als rote Kurve. Beide Signale haben die gleiche Frequenz, sind jedoch phasenverschoben. }
        }
    \end{figure}
