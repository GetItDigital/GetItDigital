...
\begin{frame}
    ...
    %Der Effektivwert. Oft kann es schwierig werden, mit zeitlich veränderlichen Größen zu Arbeiten.
    ...
    %Der Effektivwert von Wechselspannungen und Wechselströmen soll berechnet werden können.
\end{frame}
...
\begin{frame}
    ...
    %Wie bereits angedeutet dient der Effektivwert der besseren Vergleichbarkeit.
    %Er wird durch den quadratischen Mittelwert auch R M S genannt gebildet.
    %Die Abkürzung steht für Root Mean Square. 
    %In der Anwendung wird unter anderem das angegebene Additionstheorem genutzt.
\end{frame}
...
\begin{frame}
    ...
    %Der Scheitelwert einer Sinusspannung wird auch als Ampltudenwert bezeichnet.
    %Dargestellt werden hier verschiedene Amplituden von unterschiedlichen Sinusspannungen.
    %Der Effektivwert ist direkt proportional zum Ampltudenwert.
    %So verfügt U Drei über den größten Effektivwert und U 1 über den kleinsten Effektivwert.
\end{frame}
...
\begin{frame}
    ...
    %Der Effektivwert ist linear proportional zum Scheitelwert einer Wechselspannung oder eines Wechselstromes.
...
\begin{frame}
    ...
    %Für rein Sinusförmige Schwingungen gilt der Scheitelfaktor Wurzel Zwei. 
...
\begin{frame}
    ...
    %Aufgabe
    %An einer Haushaltssteckdose sollte immer eine Sinusförmige Wechselspannung anliegen.
    %Die Sinusform hat einen Scheitelfaktor von Wurzel Zwei.
    %Außerdem liefert der Haushaltsanschluss über eine Phase Immer einen Effektivwert von 230 Volt.
