\begin{tikzpicture}
    ...
    \draw [->] [dashed,red,very thick] (0, 0) -- (-0.666, -1);
    \draw [->] [dashed,red,very thick] (-4, -6) -- (-4.666, -7);
    \draw (-4.6, -6.5) node [scale=0.8,red,very thick] {$\underline{I}_{\mathrm{0}}$};
    \draw (-0.8, -0.5) node [red,very thick] {$\underline{I}_{\mathrm{0}}$};
    \pause
    ...
    \draw [->] [dashed,red,very thick] (0, -6) -- (2.193, -4.346);
    \draw [->] [dashed] (0, -6) -- (-2.529, -4.927);
    \draw [->] [dashed] (0, -6) -- (0.336, -8.726);
    \draw [->] [dashed,red,very thick] (-0.666, -1) -- (1.527, 0.654);

    \draw (0.8, 0.5) node [,red,very thick] {$\underline{I}_{\mathrm{1}}$};
    \draw (0.9, -5) node [scale=0.8,red,very thick] {$\underline{I}_{\mathrm{1}}$};
    ...
    %warum werden hier die gestrichelten linien operatoren mit angegeben und beim nullsystem nicht?
    ...
    \draw [->] [dashed,red,very thick] (4, -6) -- (4.467, -6.654);
    \draw [->] [dashed] (4, -6) -- (3.2, -6.077);
    
    \draw (4, -6.3) node [scale=0.8,red,very thick] {$\underline{I}_{\mathrm{2}}$};
    ...
    \draw (2, 0.5) node [red,very thick] {$\underline{I}_{\mathrm{2}}$};
    \draw [->] [dashed,red,very thick] (1.527, 0.654) -- (2, 0);
