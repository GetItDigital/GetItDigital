\begin{tikzpicture}
    ...
    \only<1>{\draw (2.5, 0.3) node {$\underline{U}_\mathrm{L1}=\frac{\underline{U}_{\mathrm{L1L2}}}{\sqrt{3}}$};}
    ...
    \draw (2.5, 0.3) node {$\underline{U}_\mathrm{L1}=\frac{\underline{U}_{\mathrm{L1L2}}}{\sqrt{3}} \cdot e^{-j30°}$};
\end{tikzpicture}%