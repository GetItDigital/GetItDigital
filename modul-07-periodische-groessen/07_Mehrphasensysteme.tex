...
\newvideofile{Mehrphasensysteme1}{Mehrphasensysteme 1}

\begin{frame}
    \fta{Mehrphasensysteme - Mitsystem, Gegensystem und Nullsystem}

    \s{\index{Mehrphasensysteme}
...
\begin{frame}
    ...
    \s{\index{Mitsystem}\index{Gegensystem}\index{Nullsystem}
...
\s{
    ...
    \fu{\resizebox{0.6\textwidth}{!}{%
        \input{Tikz/src/Mehrphasensysteme/Zeigerdiagramme_unsymmetrisches_System}\alttext{Das Bild zeigt Zeigerdiagramme eines Drehstromsystems im Originalsystem sowie im Null-, Mit- und Gegensystem. Im oberen Teil sind die Leiterströme L₁, L₂ und L₃ mit ihren Beträgen und Phasenlagen dargestellt. Darunter werden die gleichen Ströme in symmetrische Komponenten zerlegt. Die Grafik veranschaulicht die Methode der symmetrischen Komponenten in der Drehstromtechnik.}
    }
...
\newvideofile{Mehrphasensysteme2}{Mehrphasensysteme 2}

\v{
\begin{frame}
	\ftx{Mehrphasensysteme 2}

    \begin{Lernziele}{Mehrphasensysteme 2}
        Die Studierenden
        \begin{itemize}
            \item verstehen die Funktionen von Mit-, Gegen- und Nullsystem.
            \item können die Drehstromleistung der verschiedenen Systeme berechnen.
    ...
    \speech{SystemLrnz2}{1}{Zuvor wurden die Symmetrischen Komponenten mit dem Mitsystem, dem Gegensystem und dem Nullsystem,
    sowie die dazugehörige Drehstromleistung besprochen.
    Hier werden nun die Ersatzschaltbilder für symmetrische Quellen, Lasten und Leitungen erläutert. .}
\end{frame}}
...
\begin{frame}
    ...
    \fu{
        \input{Tikz/src/Mehrphasensysteme/Transformierte_Spannungsquelle_ESB}\alttext{Das Bild zeigt die Zerlegung eines Drehstromsystems in drei symmetrische Komponenten. Oben ist das Mitsystem mit der Spannung U₁ dargestellt, darunter das Gegensystem mit U₂ und unten das Nullsystem mit U₀. Links ist eine gemeinsame Spannungsquelle U Stern im Mitsystem eingezeichnet. Die Grafik veranschaulicht die Darstellung eines Systems als Überlagerung von Mit-, Gegen- und Nullsystem.}
...
\begin{frame}
    ...
    \fu{
       \input{Tikz/src/Mehrphasensysteme/Transformierte_Last_ESB}\alttext{Das Bild zeigt drei getrennte Ersatzschaltungen für die symmetrischen Komponenten eines Drehstromsystems. Oben ist das Mitsystem mit der Spannung U₁ und der Impedanz Z dargestellt, in der Mitte das Gegensystem mit U₂ und Z. Unten ist das Nullsystem mit der Spannung U₀ und einer Impedanz Z sowie einer zusätzlichen Impedanz 3·Z_E eingezeichnet. }
...
\begin{frame}
    ...
    \fu{
        \input{Tikz/src/Mehrphasensysteme/Transformierte_Leitung_ESB}\alttext{Das Bild zeigt eine dreiphasige Leitung mit den Leitern L1, L2 und L3 zwischen zwei Netzknoten A und B. In jedem Leiter sind eine Serienimpedanz Z_S sowie Kopplungsimpedanzen Z_K zwischen den Phasen eingezeichnet. Die Leiterströme I_L1, I_L2 und I_L3 sowie die Leiter¬spannungen an beiden Seiten sind markiert. Eine gestrichelte Verbindung deutet die Sternpunktbehandlung zwischen den Knoten N_Q und N_V an.}
