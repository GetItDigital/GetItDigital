...
\b{%
	\begin{minipage}{\textwidth}% Obere Hälfte
		\begin{minipage}{0.48\textwidth}\centering
			\includegraphics[width=0.9\textwidth, alt={Schaltbild: RC Reihenschaltung mit Schalter. Schaltet vom Kurzschluss zum Anschluss einer Gleichspannungsquelle Uq.}]{Tikz/pdf/circ_switchable_rc_charge_dc.pdf}
		\end{minipage}%
		\begin{minipage}{0.48\textwidth}\centering
