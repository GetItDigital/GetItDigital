...
\fu{\includegraphics[alt={Zeitverläufe von Ausgleichsvorgängen bei Gleich- und bei Wechselspannung im Vergleich. Von stationär über transient bis stationär. Eingeschwungen ist der Verlauf einer Gleichgröße oder einer Wechselgröße zu sehen.}]{Tikz/pdf/plot_transient_persistent.pdf}}%
...
\begin{minipage}{0.38\textwidth}\centering
	\includegraphics[width=\textwidth, alt={Schaltbild eines Tiefsetzstellers: L C Reihenschaltung mit U2 über C. Die L C Reihenschaltung ist bei gezeigter Schalterstellung kurzgeschlossen während U1 an offenen Klemmen anliegt. In der anderen Schalterstellung liegt U1 über der L C Reihenschaltung an.}]{Bilder/Tiefsetzsteller_Schaltung_GET2_J_Böcker_Uni_Paderborn_cut.png}
