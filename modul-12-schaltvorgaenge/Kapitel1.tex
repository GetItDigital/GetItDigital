...
Im weiteren Verlauf werden wir Ursachen, den typischen Ablauf und eine grobe Definition von Schaltvorgängen kennen lernen.
Anhand von Beispielen für Schaltvorgänge, werden Sie Herausforderungen und Möglichkeiten kennen lernen, die sich aus Schaltvorgängen ergeben.
Zudem lernen Sie das Schaltverhalten idealer und realer Schalter zu unterscheiden.
}% Speech Ende
\end{frame}
...
Ideal betrachtet treten keine parasitären Effekte auf.
}% Speech Ende
