...
\b{%
	\begin{minipage}{\textwidth}% Obere Hälfte
		\begin{minipage}{0.48\textwidth}\centering
			\resizebox{0.9\textwidth}{!}{\includegraphics[alt={Schaltbild: R C Reihenschaltung mit Schalter, der von Kurzschluss zum Anschluss einer Gleichspannungsquelle Uq schaltet.}]{Tikz/pdf/circ_switchable_rc_charge_dc.pdf}}
		\end{minipage}%
		\begin{minipage}{0.48\textwidth}\centering
