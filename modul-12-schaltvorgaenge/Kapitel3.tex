...
Die Exponenzialform resultiert aus dem flüchtigen Zustand, das heißt der homogenen Lösung K mal e hoch Lambda T für einfache Nullstellen. 
}% Speech Ende
\end{frame}
...
Die dazugehörige Gleichung ist: U C von Tee ist gleich U q (der Endwert) mal Klammer auf eins minus e hoch minus T durch tau Klammer zu. 
...
Schritt eins ist das Aufstellen der DGL für unsere gesuchte Größe U c von Tee für den Zeitraum T größer gleich null, 
...
Und ersetzen C durch C mal D nach D T von U C. 
...
Die partikuläre Lösung, das heißt den eingeschwungenen Zustand für T gegen unendlich, erhalten wir entweder durch Netzwerkberechnung oder leiten ihn aus der DGL ab.
...
U C von Tee ist gleich U Q mal Klammer auf eins minus e hoch minus T durch Lambda Klammer zu. 
...
Durch kürzen erhalten wir den Stromverlauf I C von Tee ist gleich U Q durch R mal e hoch minus T durch Tau. 
...
Der Strom I von Tee entspricht einer exponentiellen Annäherung an den maximalen Strom U q durch R.
...
Hier ist unser Störterm U Q von Tee gleich dem Scheitelwert U Q Dach mal Kosinus von omega T plus Phi Q.
...
Aufgrund der sinusförmigen Eingangsspannung U Q erhalten wir in unserer linearen zeitinvarianten Schaltung 
auch eine sinusförmige Ausgangsspannung U C P mit gleicher Kreisfrequenz omega wie bei der Anregung U Q im eingeschwungenen Zustand. 
}% Speech Ende
\silence{1}%
\speech{SchaltvorgaengeACbeiRC3}{1}{%
...
Der dreifache Scheitelwert ist möglich, wenn die Anfangsbedingung wäre, dass z.B. U C von Tee null gleich der einfach Scheitelwert ist. 
}% Speech Ende
...
Statt eines komplexen Spannungsteilers, transformieren wir die DGL in den Bildbereich und ersetzen dabei die Differenzialoperatoren d nach d T durch J omega. 
...
Abhängig von den Werten der Bauelemente R, L und C ergeben sich verschiedene Einschwingverhalten bei Anregung mit Gleichspannung U Q.
...
In beiden Fällen ergibt sich der selbe Zusammenhang.
