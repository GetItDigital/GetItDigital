...
Die dazugehörige Gleichung ist: u C von t ist gleich U q (der Endwert) mal Klammer auf eins minus e hoch minus t durch tau Klammer zu. 
...
Alternativ können wir wie hier gezeigt ist die D G L für die partikuläre Lösung herannehmen.
...
Die allgemeine Lösung der inhomogenen D G L erhalten wir durch Überlagerung unserer homogenen und unserer partikulären Lösung.
...
Da der Störterm in der homogenen D G L Null ist, sind beide Lösungen identisch. 
...
Im vierten Schritten erhalten wir die allgemeine Lösung der inhomogenen D G L durch Überlagerung.
...
Das Systemverhalten kann durch eine D G L zweiter Ordnung beschrieben werden.
...
Im ersten Schritt stellen wir die D G L auf, hier für die Kondensatorspannung u C, und bestimmen anhand des charakteristischen Polynoms die Eigenwerte lambda eins und lambda zwei.
...
Die homogene Lösung ergibt sich durch Überlagerung der zwei Ansätze, einmal mit dem Exponentialterm und einmal mit dem Exponentialterm multipliziert mit der Zeit t.
...
Kurz gesagt, entspricht die homogene Lösung bei unterschiedlichen Eigenwerten allgemein der Überlagerung zweier Exponentialfunktionen.
...
Die Abklingkonstante delta bestimmt die Geschwindigkeit des Abklingens der Schwingung und entspricht damit der Zeitkonstante der einhüllenden Exponentialfunktion.
...
Durch Einsetzen der komplex konjugierten Konstanten und Anwendung der Eulerschen Formel lassen sich die Exponentialfunktionen in Sinus- und Kosinusfunktionen umwandeln.
...
Im aperiodischen Fall haben wir zwei reelle, negative Eigenwerte. Dabei dominiert die Nullstelle näher an der Imaginärachse das Einschwingverhalten des Systems, da die zugehörige Exponentialfunktion langsamer abklingt.
