...
Eingesetzt ergibt sich daraus die allgemein Lösung: U c von Tee ist gleich K mal e hoch minus T durch Tau plus U q. 
}% Speech Ende
...
I von null ist gleich K mal e hoch null plus U Kuh durch R ist gleich Null.
Daraus folgt K ist gleich minus U Kuh durch R.
Die eindeutige Lösung ergibt: U Kuh durch R mal Klammer auf eins minus e hoch minus Tee durch Tau Klammer zu.
Die Spannung U L lässt sich über U L gleich L mal der zeitlichen Ableitung von I bestimmen.
...
Der Strom I von Tee entspricht einer exponentiellen Annäherung an den maximalen Strom U Kuh durch R.
Die Spannung fällt exponentiell ab vom Maximalwert U Kuh.
...
Im Vergleich zu den D C Beispielen unterscheiden sich die DGL en hier nur durch einen sinusförmigen Störterm b. 
...
Der erste Schritt, das Aufstellen der DGL ist im Prinzip identisch zu den D C Beispielen. 
...
und durch Winkelbestimmung erhalten wir den Lastphasenwinkel Vieh Zeh P mit der Lösung unten rechts.
...
Der Exponenzialterm reduziert sich zu e hoch null gleich eins und kann somit gekürzt werden. 
...
Der dreifache Scheitelwert ist möglich, wenn die Anfangsbedingung wäre, dass die Spannung während des Schaltzeitpunktes im Scheitelpunkt liegt. 
}% Speech Ende
...
Oben rechts sind die sich Zeitverläufe von der Anregung U q der gesuchten Größe I von Tee und für einen Beispiel Schaltzeitpunkt T Null dargestellt. 
}% Speech Ende
...
Wir sehen das an der Gleichung, dass sich der Exponenzialterm und der sinusförmige Term zum Schaltzeitpunkt nicht direkt aufheben. 
...
Beginnen wir beim aperiodischen Fall, auch Kriechfall genannt, bei positiver Diskriminante D.
...
Hierbei können nur negative Werte auftreten, da der Term vor der Wurzel betragsmäßig immer größer ist als der Wurzelterm.
}% Speech Ende
