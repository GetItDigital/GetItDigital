...
\speech{3Schaltvorgaenge1F01DC1LernzieleTEST}{1}{%
Willkommen zum vierten Video der Videoreihe für das Modul Schaltvorgänge. 
In diesem Video steigen wir ein in das Kapitel 3 Schaltvorgänge im Zeitbereich berechnen
und befassen uns mit den Themen aus Kapitel 3 punkt 1 Schaltvorgänge bei Gleichspannung.
Wir lernen die Zeitkonstante Tau kennen und verstehen und berechnen Lade- und Entladevorgänge bei RC-Gliedern.
...
\b{%
    ...
    \begin{minipage}{0.48\textwidth}\centering
        \pause
        \includegraphics[width=0.8\textwidth]{Tikz/pdf/plot_rc_cycle_seperate_u.pdf}
...
\end{minipage}
\begin{minipage}[t][][t]{0.48\textwidth}\centering\vspace{0cm}% vspace: input empty space before tikzpicture for top alignment
    \includegraphics[width=0.8\textwidth]{Tikz/pdf/plot_rc_charge_uc_i_seperate.pdf}
\end{minipage}
\end{minipage}
% Untere Hälfte
...
\end{minipage}
\begin{minipage}[t][][t]{0.48\textwidth}\centering\vspace{0cm}% vspace: input empty space before tikzpicture for top alignment
    \includegraphics[width=0.8\textwidth]{Tikz/pdf/plot_rc_discharge_uc_i_seperate.pdf}
\end{minipage}
\end{minipage}
% Untere Hälfte
\resizebox{0.9\textwidth}{!}{% to fit on slide
...
\end{minipage}
\begin{minipage}[t][][t]{0.48\textwidth}\centering\vspace{0cm}% vspace: input empty space before tikzpicture for top alignment
    \includegraphics[width=0.6\textwidth]{Tikz/pdf/plot_rc_cycle_seperate_u.pdf}%
\end{minipage}
\end{minipage}\hfill%
% Untere Hälfte
\begin{minipage}{\textwidth}\centering%
...
\end{minipage}
\begin{minipage}[t][][t]{0.48\textwidth}\centering\vspace{0cm}% vspace: input empty space before tikzpicture for top alignment
    \includegraphics[width=0.6\textwidth]{Tikz/pdf/plot_rl_cycle_seperate_i.pdf}%
\end{minipage}
\end{minipage}\hfill%
% Untere Hälfte
\begin{minipage}{\textwidth}%
...
\end{minipage}
\begin{minipage}[t][][t]{0.48\textwidth}\centering\vspace{0cm}% vspace: input empty space before tikzpicture for top alignment
    \includegraphics[width=0.8\textwidth]{Tikz/pdf/plot_rl_charge_ul_i_seperate.pdf}
\end{minipage}
\end{minipage}
% Untere Hälfte
\resizebox{0.9\textwidth}{!}{% to fit on slide
...
\end{minipage}
\begin{minipage}[t][][t]{0.48\textwidth}\centering\vspace{0cm}% vspace: input empty space before tikzpicture for top alignment
    \includegraphics[width=0.8\textwidth]{Tikz/pdf/plot_rl_discharge_ul_i_seperate.pdf}
\end{minipage}
\end{minipage}
% Untere Hälfte
\resizebox{0.9\textwidth}{!}{% to fit on slide
...
\begin{minipage}{0.48\textwidth}\centering
    \pause
    \includegraphics[width=0.8\textwidth]{Tikz/pdf/plot_rc_charge_uc_ac_different_t0.pdf}
...
\end{minipage}\pause%
\begin{minipage}[t][][t]{0.48\textwidth}\centering\vspace{0cm}% vspace: input empty space before tikzpicture for top alignment%
    \includegraphics[width=0.75\textwidth]{Tikz/pdf/plot_rc_charge_uc_ac_different_t0_short.pdf}
\end{minipage}%
...
\begin{frame}\ftx{Schaltvorgänge \subsecname\ \subsubsecname}% Vergleich verschiedene tau und maximale Auslenkung (Überschwinger)
    ...
    \end{minipage}%
    \begin{minipage}{0.48\textwidth}\centering
        \includegraphics[width=0.8\textwidth]{Tikz/pdf/plot_rc_charge_uc_ac_different_tau.pdf}
...
\end{minipage}\pause%
\begin{minipage}[t][][t]{0.48\textwidth}\centering\vspace{0cm}% vspace: input empty space before tikzpicture for top alignment%
    \includegraphics[width=0.75\textwidth]{Tikz/pdf/plot_rl_charge_il_ac_different_t0_short.pdf}%
\end{minipage}%
\end{minipage}\pause\hfill%
% Untere Hälfte
\resizebox{0.95\textwidth}{!}{% to fit on slide
...
\begin{minipage}{\textwidth}\centering
    \begin{minipage}[t][3.5cm][]{0.48\textwidth}\centering
        \includegraphics[width=\textwidth]{Tikz/pdf/circ_switchable_rlc_charge_detail.pdf}%
        \vspace{5pt}

        Wegen $L$ und $C$ $\Rightarrow$ Schwingkreis
    \end{minipage}%
    \begin{minipage}[t][3.5cm][]{0.48\textwidth}\centering
        \includegraphics[width=\textwidth]{Tikz/pdf/plot_rlcs_charge_dc_uc.pdf}%
    \end{minipage}
...
\begin{frame}\ftx{\subsubsecname}% Periodischer Fall: Zweiter Frame
    ...
    \begin{figure}[H]\centering%
        \includegraphics[width=0.7\textwidth]{Tikz/pdf/plot_rlcs_charge_dc_uc_periodisch.pdf}%
