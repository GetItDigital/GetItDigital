...
\speech{SchaltvorgaengeDC1RCLadevorgang2}{4}{%
...
\begin{frame}\ftx{Entladevorgang \subsubsecname}
    \begin{Lernziele}{Video - Schaltvorgänge bei RLC-Serienschwingkreisen [1/2]}
        ...
        \end{itemize}
    \end{Lernziele}
\speech{SchaltvorgaengeRLC1Lernziele}{1}{%
...
\speech{SchaltvorgaengeRLC1Allgemein1}{1}{%
...
\speech{SchaltvorgaengeRLC1Allgemein2}{1}{%
...
\speech{SchaltvorgaengeRLC1Fallunterscheidung}{1}{%
...
\speech{SchaltvorgaengeRLC1Fallunterscheidung}{2}{%
...
\speech{SchaltvorgaengeRLC1Fallunterscheidung}{3}{%
...
%}%
\speech{SchaltvorgaengeRLC1FallunterscheidungAperiodisch1}{1}{%
...
\speech{SchaltvorgaengeRLC1FallunterscheidungAperiodisch1}{2}{%
...
\speech{SchaltvorgaengeRLC1FallunterscheidungAperiodisch2}{1}{%
Die allgemeine Lösung ergibt sich durch Überlagerung von homogener und partikulärer Lösung.
}% Speech Ende
\speech{SchaltvorgaengeRLC1FallunterscheidungAperiodisch2}{2}{%
...
\begin{align*}
    ...
    \\[-15pt] &\hphantom{1rrrrrrrrrrrrrrrr} &   \hphantom{2llllll}&\hphantom{\mathrel{\phantom{=}}2rrrrrrrrrrrrrrrrrrrrrrrrrrr}     &&\hphantom{3rrrrrrrrrrrrrrrrrrrrrrrr} \nonumber
    \end{align*}
\speech{SchaltvorgaengeRLC1FallunterscheidungGrenzfall1}{1}{%
...
\speech{SchaltvorgaengeRLC1FallunterscheidungGrenzfall1}{2}{%
...
\begin{frame}\ftx{\subsubsecname}% Aperiodischer Grenzfall: Zweiter Frame
    ...
    \end{align*}%
\speech{SchaltvorgaengeRLC1FallunterscheidungGrenzfall2}{1}{%
...
\speech{SchaltvorgaengeRLC1FallunterscheidungPeriodisch1}{1}{%
...
\speech{SchaltvorgaengeRLC1FallunterscheidungPeriodisch1}{2}{%
...
\speech{SchaltvorgaengeRLC1FallunterscheidungPeriodisch2}{1}{%
...
\begin{frame}\ftx{Entladevorgang \subsubsecname}
    \begin{Lernziele}{Video - Schaltvorgänge bei RLC-Serienschwingkreisen [2/2]}
        ...
        \end{itemize}
    \end{Lernziele}
\speech{SchaltvorgaengeRLC2ExkurseLernziele}{1}{%
...
\end{align}%
\speech{SchaltvorgaengeRLC2ExkursePeriodisch1}{1}{%
...
\speech{SchaltvorgaengeRLC2ExkursePeriodisch2}{1}{%
...
\speech{SchaltvorgaengeRLC2ExkursePeriodisch3}{1}{%
...
\speech{SchaltvorgaengeRLC2ExkurseOrtskurve}{1}{%
...
\end{align*}%
\speech{SchaltvorgaengeRLC2ExkurseGroessen}{1}{%
