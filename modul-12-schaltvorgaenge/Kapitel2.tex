...
\b{% Folie: Berechnungsmethoden für Schaltvorgänge
    ...
    \begin{center}
        \includegraphics[width=0.75\textwidth]{Tikz/pdf/plot_flussdiagramm_dgl_berechnungsmethoden.pdf}
    \end{center}
...
\b{% Folie: Aufstellungsmethoden für DGL (Zeitbereich, Bildbereich)
    ...
    \includegraphics[width=\textwidth]{Tikz/pdf/plot_flussdiagramm_dgl_aufstellen.pdf}
}
...
\b{%
    \begin{figure}[H]\centering% Bilder horizontal angeordnet
        \begin{subfigure}{0.24\textwidth}\centering
            \includegraphics[width=\textwidth]{Tikz/pdf/circ_example_ordnung_01.pdf}
            \caption*{1 En.sp. $\rightarrow$ 1. Ord.}
        \end{subfigure}
        \begin{subfigure}{0.24\textwidth}\centering
            \includegraphics[width=\textwidth]{Tikz/pdf/circ_example_ordnung_02.pdf}
            \caption*{2 En.sp. $\rightarrow$ 2. Ord.}
        \end{subfigure}
        \begin{subfigure}{0.24\textwidth}\centering
            \includegraphics[width=\textwidth]{Tikz/pdf/circ_example_ordnung_03.pdf}
            \caption*{2 En.sp. $\rightarrow$ 2. Ord.}
        \end{subfigure}
        \begin{subfigure}{0.24\textwidth}\centering
            \includegraphics[width=\textwidth]{Tikz/pdf/circ_example_ordnung_04.pdf}
            \caption*{2 En.sp. $\rightarrow$ 2. Ord.}
        \end{subfigure}
        \label{fig:plot:beispielordnungdgl}
    \end{figure}
