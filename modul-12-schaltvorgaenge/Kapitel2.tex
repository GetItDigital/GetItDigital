...
\s{% Zerlegung: flüchtig, eingeschwungen
    ...
    \begin{figure}[H]\centering
        \includegraphics[alt={Plot: Zeitverlauf einer Größe y(t) zerlegt in ye und yf. Dabei nähert sich y asymptotisch dem konstanten Wert ye an. Die Differenz der beiden ist yf und geht gegen null.}]{Tikz/pdf/plot_example_fluechtig_eingeschwungen.pdf}
        \caption{Ausgleichsvorgang zerlegt in eingeschwungenen und flüchtigen Zustand}
        \label{plot:example:fluechtig_eingeschwungen}
    \end{figure}%
}%
\b{%
    \includegraphics[alt={Plot: Zeitverlauf einer Größe y(t) zerlegt in ye und yf. Dabei nähert sich y asymptotisch dem konstanten Wert ye an. Die Differenz der beiden ist yf und geht gegen null.}]{Tikz/pdf/plot_example_fluechtig_eingeschwungen_def.pdf}%
    \pause%
}%
\s{%
