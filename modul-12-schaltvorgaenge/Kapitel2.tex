...
Die Differenzialgleichung erhalten wir durch Anwendung der Komponentengleichung und der Kirchhoff'schen Regeln, also der Knoten- und Maschenregel. 
}% Speech Ende
\end{frame}
...
Wichtig ist, dass die J Omega Terme im Zähler stehen, damit diese am Ende zu Differntialoperatoren umgewandelt werden können.
...
Daraus lässt sich ableiten, dass die Konstanten A I unserer Differenzialgleichung konstant sind, da diese nur von den Werten für R, L und oder C abhängen. 
}% Speech Ende
\silence{2}%
\speech{Grundlagen1DGLEigenschaften}{1}{%
...
Dieser durch die D C Anregung bedingte konstante Endwert von Ypsilon ist unser eingeschwungener Zustand Ypsilon E. 
...
Hier sind zum Verdeutlichen die Koeffizienten in blau und die Potenzen von Lambda beziehungsweise der Ableitungen von Ypsilon von Tee in rot hervor gehoben. 
...
Der Imaginärteil der komplex konjugierten Nullstellen, hier die in magenta hervorgehobene plus beziehungsweise minus zwei J, 
