...
\begin{frame} \ftx{Lorentzkraft} \index{Lorentzkraft}
	...
	\fo{width=0.65\textwidth, alt={XX}}{height=0.8\textheight}{Lorentzkraft}{
...
\begin{frame} \ftx{Lorentzkraft}
	\s{ % Abbildungen für Skript
		...
		\begin{minipage}{0.25\textwidth}
			\foo{width=0.9\textwidth, alt={XX}}{}{Lorentzkraft_Feldverlaeufe1}{
		...
		\end{minipage}
		\begin{minipage}{0.25\textwidth}
			\foo{width=0.9\textwidth, alt={XX}}{}{Lorentzkraft_Feldverlaeufe2}{
		...
		\end{minipage}
		\begin{minipage}{0.25\textwidth}
			\foo{width=0.9\textwidth, alt={XX}}{}{Lorentzkraft_Feldverlaeufe3}{
				\put(85, 78){\color{magnetfeld}N}
				\put(85, 15){\color{magnetfeld}S}
		...
		\end{minipage}
		\begin{minipage}{0.25\textwidth}
			\foo{width=0.9\textwidth, alt={XX}}{}{Lorentzkraft_Feldverlaeufe4}{
				\put(85, 78){\color{magnetfeld}N}
				\put(85, 15){\color{magnetfeld}S}
...
\begin{frame} \ftx{Lorentzkraft} \index{Lorentzkraft}
	...
	\begin{minipage}{0.35\textwidth}
		\foo{width=\textwidth, alt={XX}}{width=\textwidth}{Lorentzkraft_Berechnung}{
...
\begin{frame} \ftx{Lorentzkraft}
	\s{ % Abbildungen für Skript
		...
		\begin{minipage}{0.25\textwidth}
			\foo{width=0.9\textwidth, alt={XX}}{}{Lorentzkraft_Feldverlaeufe5}{
				\put(85, 78){\color{magnetfeld}N}
				\put(85, 15){\color{magnetfeld}S}
				\put(40, -8){\color{gray}+}
			}{\label{Lorentz4}}
		...
		\end{minipage}
		\begin{minipage}{0.25\textwidth}
			\foo{width=0.9\textwidth, alt={XX}}{}{Lorentzkraft_Feldverlaeufe6}{
		...
		\end{minipage}
		\begin{minipage}{0.25\textwidth}
			\foo{width=0.9\textwidth, alt={XX}}{}{Lorentzkraft_Feldverlaeufe7}{
				\put(85, 78){\color{magnetfeld}N}
				\put(85, 15){\color{magnetfeld}S}
		...
		\end{minipage}
		\begin{minipage}{0.25\textwidth}
			\foo{width=0.9\textwidth, alt={XX}}{}{Lorentzkraft_Feldverlaeufe8}{
				\put(85, 78){\color{magnetfeld}N}
				\put(85, 15){\color{magnetfeld}S}
...
\begin{frame} \ftx{Lorentzkraft}
	\s{Zwei parallele Leiter, die von Strom durchflossen werden, üben ebenfalls eine Lorentzkraft aufeinander aus, da jeder stromdurchflossene Leiter um sich herum ein Magnetfeld aufbaut (siehe Abbildung \ref{Lorentz5}). Ist die Stromrichtung in beiden Leitern gleich, entsteht eine Anziehungskraft, bei umgekehrter Stromrichtung wirkt die Kraft abstoßend. \\
		...
		\fo{width=0.65\textwidth, alt={XX}}{}{Lorentzkraft_parallel}{
