...
\v{
	...
	\begin{frame}{Lernziele}
		\begin{Lernziele}{Lorentzkraft}
			...
			\end{itemize}
		\end{Lernziele}
		\speech{LernzieleLorentzkraft}{1}{In den letzten Videos hast du bereits die magnetischen Größen kennengelernt. Jetzt wollen wir uns genauer mit ihren Wirkungen beschäftigen. Eine der bedeutendsten Wirkung ist die Lorentz-kraft. Sie ist nicht nur ein physikalisches Phänomen, sondern die Grundlage fast aller elektromechanischen Energiewandler – zum Beispiel den elektrischen Maschinen. Immer wenn in einem Motor elektrische Energie in mechanische Bewegung, oder in einem Generator mechanische Bewegung in elektrische Energie, umgewandelt wird, spielt die Lorentz-kraft eine zentrale Rolle. In diesem Video erfährt ihr, auf welchen physikalischen Grundlagen die Lorentz-kraft beruht und wie sie sich auf verschiedene Objekte auswirkt. Außerdem wird euch in diesem Video die Drei-Finger-Regel näher gebracht – Eine Regel, mit der ihr die Richtung der Lorentz-kraft sicher bestimmen könnt. Darauf aufbauend wird die Funktionsweise des Gleichstrommotors erläutert, bei der ihr seht, wie die Lorentz-kraft auf eine stromdurchflossene Leiterschleife wirkt und wie aus diesen Kräften ein Drehmoment entsteht. Anschließend schauen wir uns die mathematische Herleitung zur Bestimmung der Lorentz-kraft an und wenden das Wissen in einem Rechenbeispiel an. Zum Abschluss betrachten wir noch, wie die Lorentz-kraft zwischen zwei parallelen stromdurchflossenen Leitern wirkt und wie man sie berechnet.}
		\silence{2}
	\end{frame}
}
