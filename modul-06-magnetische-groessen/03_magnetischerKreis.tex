...
\begin{frame} \ftx{Beispiel: Magnetische Flussdichte}
	...
	\silence{2}
	\speech{magnetischeFlussdichte}{3}{Nun soll die magnetische Flussdichte B für zwei unterschiedliche Fälle berechnet werden: einmal für eine Luft-Spule mit einer relativen Permeabilität von Eins. Außerdem für eine Spule mit Eisenkern, die eine relative Permeabilität von Zwei-tausend besitzt.}
	\speech{magnetischeFlussdichte}{4}{Zur Berechnung der magnetischen Flussdichte dieser beiden Fälle können wir die Werte in die bekannte Formel einsetzten. Die magnetische Flussdichte ist das Produkt aus der magnetischen Feldkonstante Mü-Null, der relativen Permeabilität Mü-Er sowie der magnetischen Feldstärke H.}
	\silence{4}
...
\begin{frame} \ftx{Magnetischer Widerstand}\index{Magnetischer Widerstand}
	...
	\speech{magnetischerWiderstand}{4}{In solchen einfachen Anordnungen kann der Widerstand unter Vernachlässigung der Ecken mit dieser Gleichung ausgedrückt werden. L-M ist wie bei der magnetischen Feldstärke die mittlere Feldlinienlänge des Widerstandes innerhalb des magnetischen Kreises. Zur Ermittlung der mittleren Feldlinienlänge L-M werden einfach die Längen aller Seiten addiert. A ist die Querschnittsfläche, die vom magnetischen Fluss durchflossen wird. Mü ist die Permeabilität des Materials. Der magnetische Widerstand R-M berechnet sich also aus der aufsummierten Länge der mittleren Feldlinienlänge L-M geteilt durch das Produkt der durchflossenen Querschnittsfläche A und der Permeabilität, bestehend aus Mü-R mal Mü-Null.}
	\silence{4}
