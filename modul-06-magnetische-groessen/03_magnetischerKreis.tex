...
\begin{frame} \ftx{Magnetischer Fluss und Flussdichte}
	...
	\speech{magnetischerFlussFlussdichte}{5}{Um den Stoff wieder komplett zu untmagnetisieren, wird eine umgekehrte magnetische Koerzitiv-feldstärke H C benötigt.}
	\silence{2}
...
\begin{frame} \ftx{Beispiel: Magnetische Flussdichte}
	...
	\speech{magnetischeFlussdichte}{4}{Zur Berechnung der magnetischen Flussdichte dieser beiden Fälle können wir die Werte in die bekannte Formel einsetzten, nach der die magnetische Flussdichte das Produkt aus der magnetischen Feldkonstante Mü-Null, der relativen Permeabilität und der magnetischen Feldstärke ist.}
	\silence{2}
