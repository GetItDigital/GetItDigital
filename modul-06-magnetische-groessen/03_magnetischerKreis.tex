...
\v{
	...
	\begin{frame}{Lernziele}
		\begin{Lernziele}{Magnetischer Fluss und Flussdichte}
			...
			\end{itemize}
		\end{Lernziele}
		\speech{LernzieleMagnetischerFluss}{1}{In diesem Video erhaltet ihr einen Einblick in die Grundgrößen des magnetischen Kreises. Dazu zählen die magnetische Flussdichte, der magnetische Fluss und die Permeabilität, die auch als magnetischer Widerstand bezeichnet wird. Darüber hinaus könnt ihr den Zusammenhang zwischen den jeweiligen Größen beschreiben und Rechenbeispiele zum magnetischen Kreis lösen.}
		\silence{2}
		\speech{LernzieleMagnetischerFluss}{2}{Außerdem machen wir einen Exkurs in die Material-Kunde. Hier lernt ihr die ferromagnetischen Eigenschaften wie die Koerzi-tivfeldstärke, die Rema-nenz-Flussdichte und die Sättigung, anhand der Hysterése-Kurve kennen.}
		\silence{2}
	\end{frame}
}
\v{
	...
	\begin{frame}{Magnetischer Fluss}
		...
		\speech{magnetischerFluss}{2}{Das Formelzeichen des magnetischen Flusses ist Phi und die Einheit dazu ist Weber. Ein Weber entspricht einer Volt-Sekunde.} %### neuer Seed
		\silence{2}
...
\begin{frame} \ftx{Magnetischer Fluss und Flussdichte}
	...
	\speech{magnetischerFlussFlussdichte}{5}{Dieser Vorgang wird Remanenz genannt. Die verbleibende magnetische Flussdichte bei einer magnetischen Feldstärke von Null ist die Remanenz-flussdichte.}
	\speech{magnetischerFlussFlussdichte}{6}{Um den Stoff wieder komplett zu entmagnetisieren, wird eine umgekehrte magnetische Koerzitiv-feldstärke H C benötigt.}
	\silence{2}
...
\begin{frame} \ftx{Beispiel: Magnetische Flussdichte}
	\begin{bsp}{Magnetische Flussdichte}{}
		...
		\end{enumerate}
	\end{bsp}
	\speech{magnetischeFlussdichte}{1}{Betrachten wir in einem Beispiel, wie sich die magnetische Flussdichte berechnen lässt. Gegeben ist die magnetische Feldstärke H mit 100 Ampere pro Meter und der Radius der Ring-Spule von 5 Zentimeter. Dazu soll zunächst die erforderliche Stromstärke berechnet werden.}
	\speech{magnetischeFlussdichte}{2}{Hierzu kann wieder die aus dem vorherigen Beispiel bekannte Formel herangezogen werden, nach der die magnetische Feldstärke H multipliziert mit der mittleren Feldlinienlänge L M gleich der Wicklungszahl N multipliziert mit der Stromstärke I ist. Stellen wir diese Formel nach I um und setzen die gegebenen Werte ein, erhalten wir die erforderliche Stromstärke.}
	\speech{magnetischeFlussdichte}{3}{Nun soll die magnetische Flussdichte B für zwei unterschiedliche Fälle berechnet werden: einmal für eine Luft-Spule mit einer relativen Permeabilität von Eins. Außerdem für eine Spule mit Eisenkern, die eine relative Permeabilität von Zweitausend besitzt.}
	\speech{magnetischeFlussdichte}{4}{Zur Berechnung der magnetischen Flussdichte dieser beiden Fälle können wir die Werte in die bekannte Formel einsetzten. Die magnetische Flussdichte ist das Produkt aus der magnetischen Feldkonstante Mü-Null, der relativen Permeabilität und der magnetischen Feldstärke.}
	\silence{2}
...
\v{
	...
	\begin{frame}{Lernziele}
		\begin{Lernziele}{Magnetischer Widerstand}
			...
			\end{itemize}
		\end{Lernziele}
		\speech{LernzieleMagnetischerWiderstand}{1}{In diesem Video lernst du die Faktoren kennen, die den magnetischen Widerstand beeinflussen und du lernst, wie du den magnetischen Widerstand einer Rinkern-Spule einfach berechnen kannst.}
		\silence{2}
	\end{frame}
}
