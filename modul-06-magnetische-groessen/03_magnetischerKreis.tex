\begin{frame} \ftx{Beispiel: Magnetische Flussdichte}
	\begin{bsp}{Magnetische Flussdichte}{}
		...
		\end{enumerate}
	\end{bsp}
		\speech{magnetischeFlussdichte}{1}{Betrachen wir in einem Beispiel, wie sich die magnetische Flussdicht berechnen lässt. Gegeben ist die magnetische Feldstärke H mit 100 Ampere pro Meter und der Radius der Ringspule von 5 Zentimeter. Dazu soll zunächst die erforderliche Stromstärke I berechnet werden.}
		\speech{magnetischeFlussdichte}{2}{Dazu kann wieder die aus dem vorherigen Beispiel bekannte Formel herangezogen werden, nach der die magnetische Feldstärke H multipliziert mit der mittleren Feldlinienlänge L M gleich der Wicklungszahl N multipliziert mit der Stromstärke I ist. Stellen wir diese Formel nach I um und setzen die gegebenen Werte ein, erhalten wir eine erforderliche Stromstärke von 157,08 mA.}
		\speech{magnetischeFlussdichte}{1}{Nun soll die magnetische Flussdichte B für zwei unterschiedliche Fälle berechnet werden: einemal für eine Luftspule mit einer relativen Permeabilität von 1 und einmal für eine Spule mit Eisenkern mit einer relativen Permeabilität von 2000.}
		\speech{magnetischeFlussdichte}{1}{Zur Berechnung der magnetischen Flussdichte dieser beiden Fälle können wir die Werte in die bekannte Formel einsetzten, nach der die magetische Flussdichte das Produkt aus der magnetischen Feldkonstante Mü Null, der relativen Permeabilität und der magnetischen Feldstärke ist.}
