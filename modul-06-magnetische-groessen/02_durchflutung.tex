...
\begin{frame} \ftx{Elektromagnetismus}
	\s{
		\fo{width=\textwidth, alt={XX}}{width=\textwidth}{Magnetisches_Feld_Leiter_und_Leiterschleife}{
...
\begin{frame} \ftx{Magnetische Durchflutung}
	...
	\s{
		...
		\fo{width=0.5\textwidth, alt={XX}}{}{Magnetisches_Feld_Spule}{
...
\begin{frame} \ftx{Magnetische Feldstärke}
	...
	\s{
		...
		\fo{width=0.45\textwidth, alt={XX}}{width=0.5\textwidth}{Magnetfeldline_Ringspule}{
