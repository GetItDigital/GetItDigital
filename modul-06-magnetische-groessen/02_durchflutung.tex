\newvideofile{02.Durchflutung}{Durchflutung}
...
\silence{2}
\speech{RechnungDurchflutung}{7}{Wir haben einen einzigen geraden Leiter, also wird unser N natürlich 1 sein. Denn wir haben keine Spule mit mehreren Leitern in den wir das Feld messen, sondern wir haben nur einen Leiter. Also ist N gleich 1. Und die gesuchte mittlere Feldlinienlänge ist der Umfang des Kreises mit dem Radius von zwanzig zenti Meter. Den Umfang des Kreises berechnen wir mit 2 Pi mal R. Also setzen wir die Werte ein, N ist gleich 1, der Strom ist 50 Ampere, also haben wir im Zähler ein mal 50 Ampere und im Nenner 2 Pi mal 0,2 meter. Rechnen wir nun alles aus, erhalten wir als Ergebnis 39,79 Ampere pro Meter.}
\end{frame}

\s{\section{Magnetischer Fluss und Flussdichte\label{Flussdichte}}}
\newvideofile{03.MagnetischerKreis}{Magnetischer Kreis}
\v{
	%Videoframe
	\begin{frame}{Lernziele}
