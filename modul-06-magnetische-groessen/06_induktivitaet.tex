...
\silence{2}
\speech{InduktivitaetBeispiel}{2}{Untersucht werden soll nun der Einfluss des Luftspalts mit der Dicke D auf die Induktivität. Hierfür betrachten wir zunächst den Aufbau ohne Luftspalt im Eisenkern.}
\silence{2}
\speech{InduktivitaetBeispiel}{3}{Es bietet sich an, die Induktivität über den magnetischen Widerstand zu berechnen, weil dafür alle Werte bereits vorliegen. Der magnetische Widerstand R-M ergibt sich aus: L-M geteilt durch Mü-Null mal Mü-R mal A. Das A steht für die Querschnittsfläche. Diese Fläche ist bekannt und ebenso die mittlere Feldlinienlänge L-M sowie die relative Permeabilität Mü-R ist gegeben. Somit könnte nun der magnetische Widerstand berechnet werden. Mit dem Widerstand allein sind wir aber noch nicht am Ziel angelangt, denn gesucht ist nich der magnetische Widerstand R-M, sondern die Induktivität L.}
\speech{InduktivitaetBeispiel}{4}{Dafür nutzen wir die Gleichung: L gleich dem Quotienten aus N zum Quadrat und R-M. Die Windungszahl N ist bekannt. Wir können nun die Gleichung zum magnetischen Widerstand an der Stelle von R-M in diese Formel einsetzen.}
\silence{2}
\speech{InduktivitaetBeispiel}{5}{Setzen wir nun alle Werte in die Formel ein. Bei der Umformung rutscht L-M in den Nenner unter den Bruchstrich, da: Wenn ein Wert im Nenner eines Bruchs steht, wird er im Ergebnis als Divisor angezeigt.}
\silence{2}
\speech{InduktivitaetBeispiel}{6}{Kürzen wir den Term weiter, erhalten wir ein Ergebnis von Null Komma Null Fünf Volt-Sekunden pro Ampere, was 50 Milli-Henry entspricht.}
\silence{2}
\speech{InduktivitaetBeispiel}{7}{Schauen wir uns jetzt in einer zweiten Berechnung an was passiert, wenn der Eisenkern einen kleinen Luftspalt von nur einen Millimeter hat. Wie verändert sich also durch diesen kleinen Luftspalt die Induktivität?}
\silence{2}
\speech{InduktivitaetBeispiel}{8}{Das funktioniert wieder mit der selben Formel zur Berechnung des magnetischen Widerstands: R-M ist gleich L-M geteilt durch Mü-Null mal Mü R mal A. Allerdings müssen wir aber den Luftspalt berücksichtigen. Dadurch besteht der magnetische Widerstand aus zwei Teilwiderständen: Zum Einen aus dem magnetischen Widerstand des Eisenkerns, der hier R-M F-E genant wird, und zum Anderen aus dem magnetischen Widerstand des Luftspalts, der hier R-M-L genannt wird.} 
