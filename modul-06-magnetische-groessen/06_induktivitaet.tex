\newvideofile{Induktivitaet}{Induktivität}
...
\begin{frame} \ftx{Induktivität} \index{Induktivität}
	...
	\s{
		...
		\end{eq}
		\f{width=0.5\textwidth, alt={Fotografie einer Ringkernspule. Der ringförmige Eisenkern ist von Kuperdraht umwickelt. Am unteren Ende befinden sich die Anschlüsse des Kupferdrahts.}}{height=0.7\textheight}{Spule_Ringkern1b}{{\bf Foto einer Ringkernspule.} Die ringförmige Bauweise bringt die Besonderheit mit sich, dass sich der magnetische Fluss vor allem innerhalb des Kerns bewegt, wodurch magnetische Störfelder reduziert werden.}
	}
	\s{
